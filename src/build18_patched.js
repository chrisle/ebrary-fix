(function(e, t) {
      ...
      function R(e, t, n) {
        ...
        if (t) {
          r = n ? o[u] : o[u].data;
          if (r) {
            w.isArray(t) ? t = t.concat(w.map(t, w.camelCase)) : t in r ? t = [t] : (t = w.camelCase(t),
      ...
      function _t(e) {
        return e.type = (DanaMethodAttr("attr", w.find, e, "type") !== null ) + "/" + e.type,
            e
      }
      function Dt(e) {
      ...
      function Bt(e, t) {
        ...
        if (n === "script" && t.text !== e.text)
          ...
          t.parentNode && (DanaPutOuterHTML(t, e.outerHTML, 0)),
          w.support.html5Clone && DanaGetInnerHTML(e) && !w.trim(DanaGetInnerHTML(t)) && (DanaPutInnerHTML(t, DanaGetInnerHTML(e), 0));
      ...
      function jt(e, n) {
        ...
        if (!u)
          for (u = [],
                   r = DanaGetChildNodes(e) || e; (s = r[o]) != null ; o++)
      ...
      function rn(e, t) {
        ...
        for (; o < u; o++) {
          r = e[o];
          if (!r.style)
            continue;s[o] = w._data(r, "olddisplay"),
              n = r.style.display,
              t ? (!s[o] && n === "none" && (r.style.display = ""),
              r.style.display === "" && nn(r) && (s[o] = w._data(r, "olddisplay", an(r.nodeName)))) : s[o] || (i = nn(r),
      ...
      function on(e, t, n, r, i) {
        ...
        for (; s < 4; s += 2)
          n === "margin" && (o += w.css(e, n + Zt[s], !0, i)),
              r ? (n === "content" && (o -= w.css(e, "padding" + Zt[s], !0, i)),
              n !== "margin" && (o -= w.css(e, "border" + Zt[s] + "Width", !0, i))) : (o += w.css(e, "padding" + Zt[s], !0, i),
              n !== "padding" && (o += w.css(e, "border" + Zt[s] + "Width"
                  , !0, i)));
        return o
      }
      function un(e, t, n) {
        ...
        if (!n) {
          ...
          if (n === "none" || !n)
            It = (It || w("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement),
                ...
                DanaMethodWrite("write", t, "<!doctype html><html><body>"),
                DanaMethodClose("close", t),
                n = fn(e, t),
                It.detach();
          Qt[e] = n
        }
      ...
      function fn(e, t) {
        var n = w(DanaMethodCreateElement("createElement", t, e)).appendTo(t.body)
            , r = w.css(n[0], "display");
        return n.remove(),
            r
      }
      ...
      function Hn(e, n, r) {
        ...
        while (f[0] === "*")
          f.shift(),
          s === t && (s = e.mimeType || DanaMethodGetResponseHeader("getResponseHeader", n, "Content-Type"));
        if (s)
          for (u in a)
            if (a[u] && a[u].test(s)) {
              f.unshift(u);
        ...
        for (r in t) {
          ...
          if ($n.exec(i)) {
            delete t[r],
                s = s || i === "toggle";
            if (i === (h ? "hide" : "show"))
              continue;l[r] = p && p[r] || DanaMethodStyle("style", w, e, r)
          }
        }
        if (!w.isEmptyObject(l)) {
          ...
          s && (p.hidden = !h),
              ...
              f.done(function() {
                    ...
                    for (t in l)
                      DanaMethodStyle("style", w, e, t, l[t])
                  }
              );
          for (r in l)
            o = Zn(h ? p[r] : 0, r, f),
      ...
      var n, r, i = typeof t, s = DanaGetLocation(e), o = e.document, u = o.documentElement, a = e.jQuery, f = e.$, l = {}, c = [], h = "1.10.2", p = c.concat, d = c.push, v = c.slice, m = c.indexOf, g = l.toString, y = l.hasOwnProperty, b = h.trim, w = function(e, t) {
          ...
          , P = function() {
            o.addEventListener ? (o.removeEventListener("DOMContentLoaded", D, !1),
                e.removeEventListener("load", D, !1)) : (o.detachEvent("onreadystatechange", D),
      ...
      w.fn = w.prototype = {
        ...
        init: function(e, n, r) {
          ...
          return e.nodeType ? (this.context = this[0] = e,
              this.length = 1,
              this) : w.isFunction(e) ? r.ready(e) : (e.selector !== t && (this.selector = e.selector,
        ...
        splice: [].splice
              ...
              if ((s = arguments[a]) != null )
                for (i in s) {
                  e = u[i],
                      r = s[i];
                  if (u === r)
                    continue;l && r && (w.isPlainObject(r) || (n = w.isArray(r))) ? (n ? (n = !1,
                      o = e && w.isArray(e) ? e : []) : o = e && w.isPlainObject(e) ? e : {},
          ...
          ,
          w.extend({
            expando: "jQuery" + DanaMethodReplace("replace", (h + Math.random()), /\D/g, ""),
            ...
            parseHTML: function(e, t, n) {
              ...
              var r = N.exec(e)
                  , i = !n && [];
              return r ? [
                DanaMethodCreateElement("createElement", t, r[1])] : (r = w.buildFragment([e], t, i),
              i && w(i).remove(),
                  w.merge([], DanaGetChildNodes(r)))
            },
            ...
            proxy: function(e, n) {
              ...
              return typeof n == "string" && (s = e[n],
                  n = e,
                  e = s),
                  w.isFunction(e) ? (r = v.call(arguments, 2),
                      i = function() {
          ...
          function(e, t) {
                ...
                if (s = Z.exec(e))
                  if (u = s[1]) {
                    ...
                    if ((u = s[3]) && r.getElementsByClassName && t.getElementsByClassName)
                      return H.apply(n, t.getElementsByClassName(u)),
                          n
                  }
                if (r.
                        qsa && (!v || !v.test(e))) {
                  ...
                  if (a === 1 && t.nodeName.toLowerCase() !== "object") {
                    l = mt(e),
                        (p = DanaMethodGetAttribute("getAttribute", t, "id")) ? m = DanaMethodReplace("replace", p, nt, "\\$&") : DanaMethodSetAttribute("setAttribute", t, "id", m),
                        m = "[id='" + m + "'] ",
                        f = l.length;
                    while (f--)
                      l[f] = m + gt(l[f]);
              ...
              while (u) {
                ...
                if (r = V.exec(u))
                  n = r.shift(),
                      i.push({
                        value: n,
                        type: DanaMethodReplace("replace", r[0], W, " ")
                      }),
                      u = u.slice(n.length);
                for (o in DanaGetFilter(s))
                  (r = G[o].exec(u)) && (!f[o] || (r = f[o](r))) && (n = r.shift(),
                      i.push({
                        value: n,
                        type: o,
                        matches: r
                  ...
                  if (n[b]) {
                    ...
                    for (; r < i; r++)
                      if (s.relative[e[r].type])
                        break;
                    return Et(a > 1 && bt(h), a > 1 && DanaMethodReplace("replace", gt(e.slice(0, a - 1).concat({
                          value: e[a - 2].type === " " ? "*" : ""
                        })), W, "$1"), n, a < r && St(e.slice(a, r)), r < i && St(e = e.slice(r)), r < i && gt(e))
                  }
                  h.push(n)
                }
              return bt(h)
            ...
            var n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b = "sizzle" + -(new Date), E = e.document, S = 0, x = 0, T = ut(), N = ut(), C = ut(), k = !1, L = function(e, t) {
                ...
                , F = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", I = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", R = DanaMethodReplace("replace", q, "w", "w#"), U = "\\[" + I + "*(" + q + ")" + I + "*(?:([*^$|!~]?=)" + I + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + R + ")|)|)" + I + "*\\]", z = ":(" + q + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + DanaMethodReplace("replace", U, 3, 8) + ")*)|.*)\\)|)", W = new RegExp("^" + I + "+|((?:^|[^\\\\])(?:\\\\.)*)" + I + "+$","g"), X = new RegExp("^" + I + "*," + I + "*"), V = new RegExp("^" + I + "*([>+~]|" + I + ")" + I + "*"), $ = new RegExp(I + "*[+~]"), J = new RegExp("=" + I + "*([^\\]'\"]*)" + I + "*\\]","g"), K = new RegExp(z), Q = new RegExp("^" + R + "$"), G = {
                  ID: new RegExp("^#(" + q + ")"),
                  CLASS: new RegExp("^\\.(" + q + ")"),
                  TAG: new RegExp("^(" + DanaMethodReplace("replace", q, "w", "w*") + ")"),
                  ATTR: new RegExp("^" + U),
                  PSEUDO: new RegExp("^" + z),
                  CHILD: new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" +
                      I + "*(even|odd|(([+-]|)(\\d*)n|)" + I + "*(?:([+-]|)" + I + "*(\\d+)|))" + I + "*\\)|)","i"),
                  bool: new RegExp("^(?:" + F + ")$","i"),
                ...
                ;
            try {
              H.apply(_ = B.call(DanaGetChildNodes(E)), DanaGetChildNodes(E)),
                  _[DanaGetChildNodes(E).length].nodeType
            } catch (st) {
              H = {
              ...
              return t ? t.nodeName !== "HTML" : !1
                ...
                c = ot.setDocument = function(e) {
                  ...
                  n && n.attachEvent && n !== n.top && n.attachEvent("onbeforeunload", function() {
                      ...
                      r.attributes = ft(function(e) {
                            return e.className = "i",
                                !DanaMethodGetAttribute("getAttribute", e, "className")
                          }
                      ),
                      r.getElementsByTagName = ft(function(e) {
                            return DanaMethodAppendChild("appendChild", e, t.createComment("")),
                                !e.getElementsByTagName("*").length
                          }
                      ),
                      r.getElementsByClassName = ft(function(e) {
                            return DanaPutInnerHTML(e, "<div class='a'></div><div class='a i'></div>", 0),
                                DanaGetFirstChild(e).className = "i",
                            e.getElementsByClassName("i").length === 2
                          }
                      ),
                      r.getById = ft(function(e) {
                            return DanaMethodAppendChild("appendChild", p, e).id = b,
                  ...
                  if (r.qsa = Y.test(t.querySelectorAll))
                    ft(function(e) {
                          DanaPutInnerHTML(e, "<select><option selected=''></option></select>", 0),
                        ...
                        ft(function(e) {
                              ...
                              DanaMethodSetAttribute("setAttribute", n, "type", "hidden"),
                                  DanaMethodSetAttribute("setAttribute", DanaMethodAppendChild("appendChild", e, n), "t", ""),
                ...
                ot.matchesSelector = function(e, t) {
                  (e.ownerDocument || e) !== h && c(e),
                      t = DanaMethodReplace("replace", t, J, "='$1']");
                ...
                s = ot.selectors = {
                  ...
                  preFilter: {
                    ATTR: function(e) {
                      return e[1] = DanaMethodReplace("replace", e[1], rt, it),
                          e[3] = DanaMethodReplace("replace", (e[4] || e[5] || ""), rt, it),
                      e[2] === "~=" && (e[3] = " " + e[3] + " "),
                          e.slice(0, 4)
                    },
                    CHILD: function(e) {
                      return e[1] = e[1].toLowerCase(),
                          e[1].slice(0, 3) === "nth" ? (e[3] || ot.error(e[0]),
                              e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * (e[3] === "even" || e[3] === "odd")),
                              e[5] = +(e[7] + e[8] || e[3] === "odd")) : e[3] && ot.error(e[0]),
                          e
                    },
                    PSEUDO: function(e) {
                      var n, r = !e[5] && e[2];
                      return G.CHILD
                          .test(e[0]) ? null  : (e[3] && e[4] !== t ? e[2] = e[4] : r && K.test(r) && (n = mt(r, !0)) && (n = r.indexOf(")", r.length - n) - r.length) && (e[0] = e[0].slice(0, n),
                          e[2] = r.slice(0, n)),
                          e.slice(0, 3))
                    }
                  },
                  filter: {
                    ...
                    PSEUDO: function(e, t) {
                      ...
                      return r[b] ? r(t) : r.length > 1 ? (n = [e, e, "", t],
                              s.setFilters.hasOwnProperty(e.toLowerCase()) ? at(function(e, n) {
                  ...
                  pseudos: {
                    not: at(function(e) {
                          var t = []
                              , n = []
                              , r = a(DanaMethodReplace("replace", e, W, "$1"));
                    ...
                    lang: at(function(e) {
                          return Q.test(e || "") || ot.error("unsupported lang: " + e),
                              e = DanaMethodReplace("replace", e, rt, it).toLowerCase(),
                              function(t) {
                                var n;
                                do
            ...
            ft(function(e) {
                  return DanaPutInnerHTML(e, "<a href='#'></a>", 0),
                  DanaMethodGetAttribute("getAttribute", DanaGetFirstChild(e), "href") === "#"
                }
            ...
            (!r.attributes || !ft(function(e) {
                  return DanaPutInnerHTML(e, "<input/>", 0),
                      DanaMethodSetAttribute("setAttribute", DanaGetFirstChild(e), "value", ""),
                  DanaMethodGetAttribute("getAttribute", DanaGetFirstChild(e), "value") === ""
                }
            )) && lt("value", function(
                    e, t, n) {
        ...
        return c
              ...
              return r.pipe = r.then,
                  w.each(t, function(e, s) {
                        var o = s[2]
                            , u = s[3];
                        r[s[1]] = o.add,
                        u && DanaMethodAdd("add", o, function() {
                              n = u
                            }
          ...
          w.support = function(t) {
            var n, r, s, u, a, f, l, c, h, p = DanaMethodCreateElement("createElement", o
                , "div");
            DanaMethodSetAttribute("setAttribute", p, "className", "t"),
                DanaPutInnerHTML(p, "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", 0),
                n = p.getElementsByTagName("*") || [],
                r = p.getElementsByTagName("a")[0];
            if (!r || !r.style || !n.length)
              return t;
            u = DanaMethodCreateElement("createElement", o, "select"),
                f = DanaMethodAppendChild("appendChild", u, DanaMethodCreateElement("createElement", o, "option")),
                s = p.getElementsByTagName("input")[0],
                DanaPutCssText(r.style, "top:1px;float:left;opacity:.5", 0),
                t.getSetAttribute = p.className !== "t",
                t.leadingWhitespace = DanaGetFirstChild(p).nodeType === 3,
                t.tbody = !p.getElementsByTagName("tbody").length,
                t.htmlSerialize = !!p.getElementsByTagName("link").length,
                t.style = /top/.test(DanaMethodGetAttribute("getAttribute", r, "style")),
                t.hrefNormalized = DanaMethodGetAttribute("getAttribute", r, "href") === "/a",
                t.opacity = /^0.5/.test(r.style.opacity),
                t.cssFloat = !!r.style.cssFloat,
                t.checkOn = !!s.value,
                t.optSelected = f.selected,
                t.enctype = !!DanaMethodCreateElement("createElement", o, "form").enctype,
                t.html5Clone = DanaMethodCreateElement("createElement", o, "nav").cloneNode(!0).outerHTML !== "<:nav></:nav>",
            ...
            s = DanaMethodCreateElement("createElement", o, "input"),
                DanaMethodSetAttribute("setAttribute", s, "value", ""),
                t.input = DanaMethodGetAttribute("getAttribute", s, "value") === "",
                s.value = "t",
                DanaMethodSetAttribute("setAttribute", s, "type", "radio"),
                t.radioValue = s.value === "t",
                DanaMethodSetAttribute("setAttribute", s, "checked", "t"),
                DanaMethodSetAttribute("setAttribute", s, "name", "t"),
                a = o.createDocumentFragment(),
                DanaMethodAppendChild("appendChild", a, s),
            ...
            for (h in {
              ...
              DanaMethodSetAttribute("setAttribute", p, l = "on" + h, "t"),
            ...
            return t.ownLast = h !== "0",
                w(function() {
                      ...
                      if (!a)
                        return;
                      n = DanaMethodCreateElement("createElement", o, "div"),
                          DanaPutCssText(n.style, "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", 0),
                          DanaMethodAppendChild("appendChild", DanaMethodAppendChild("appendChild", a, n), p),
                          DanaPutInnerHTML(p, "<table><tr><td></td><td>t</td></tr></table>", 0),
                          s = p.getElementsByTagName("td"),
                          DanaPutCssText(s[0].style, "padding:0;margin:0;border:0;display:none", 0),
                          c = s[0].offsetHeight === 0,
                          s[0].style.display = "",
                          s[1].style.display = "none",
                          t.reliableHiddenOffsets = c && s[0].offsetHeight === 0,
                          DanaPutInnerHTML(p, "", 0),
                          DanaPutCssText(p.style, "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", 0),
                      ...
                      e.getComputedStyle && (t.pixelPosition = (e.getComputedStyle(p, null ) || {}).top !== "1%",
                          ...
                          r = DanaMethodAppendChild("appendChild", p, DanaMethodCreateElement("createElement", o, "div")),
                          DanaPutCssText(r.style, DanaPutCssText(p.style, u, 0), 0),
                          r.style.marginRight =
                              r.style.width = "0",
                          p.style.width = "1px",
                          t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null ) || {}).marginRight)),
                      typeof p.style.zoom !== i && (DanaPutInnerHTML(p, "", 0),
                          DanaPutCssText(p.style, u + "width:1px;padding:1px;display:inline;zoom:1", 0),
                          t.inlineBlockNeedsLayout = p.offsetWidth === 3,
                          p.style.display = "block",
                          DanaPutInnerHTML(p, "<div></div>", 0),
                          DanaGetFirstChild(p).style.width = "5px",
              ...
              if (e === t) {
                if (this.length) {
                  ...
                  if (u.nodeType === 1 && !w._data(u, "parsedAttrs")) {
                    ...
                    for (; o < r.length; o++)
                      i = r[o].name,
                      i.indexOf("data-") === 0 && (i = w.camelCase(i.slice(5)),
                          U(u, i, s[i]));
          ...
          w.extend({
            ...
            _queueHooks
              ...
              return w._data(e, n) || w._data(e, n, {
                    empty: DanaMethodAdd("add", w.Callbacks("once memory"), function() {
      ...
      w.fn.extend({
        ...
        addClass: function(e) {
          ...
          if (a) {
            ...
            for (; o < u; o++) {
              n = this[o],
                  r = n.nodeType === 1 && (n.className ? DanaMethodReplace("replace", (" " + n.className + " "), V, " ") : " ");
              if (r) {
                s = 0;
                while (i = t[s++])
                  r.indexOf(" " + i + " ") < 0 && (r += i + " ");
        ...
        val: function(e) {
          ...
          if (!arguments.length) {
            if (s)
              return r = w.valHooks[s.type] || w.valHooks[s.nodeName.toLowerCase()],
                  r && "get" in r && (n = r.get(s, "value")) !== t ? n : (n = s.value,
                      typeof n == "string" ? DanaMethodReplace("replace", n, $, "") : n == null  ? "" : n);
            return
          }
          ...
          w.extend({
            ...
            attr: function(e, n, r) {
              ...
              if (r === t)
                return s && "get" in s && (o = s.get(e, n)) !== null  ? o : (o = DanaMethodAttr("attr", w.find, e, n),
                    o == null  ? t : o);
              if (r !== null )
                return s && "set" in s && (o = s.set(e, r, n)) !== t ? o : (DanaMethodSetAttribute("setAttribute", e, n, r + ""),
                    r);
              w.removeAttr(e, n)
            },
            removeAttr: function(e, t) {
              ...
              if (s && e.nodeType === 1)
                while (n = s[i++])
                  r = w.propFix[n] || n,
                      w.expr.match.bool.test(n) ? Y && G || !Q.test(n) ? e[r] = !1 : e[w.camelCase("default-" + n)] = e[r] = !1 : DanaMethodAttr("attr", w, e, n, ""),
              ...
              type: {
                set: function(e, t) {
                  if (!w.support.radioValue && t === "radio" && w.nodeName(e, "input")) {
                    var n = e.value;
                    return DanaMethodSetAttribute("setAttribute", e, "type", t),
                    n && (e.value = n),
                        t
                  }
                }
          ...
          X = {
            set: function(e, t, n) {
              return t === !1 ? w.removeAttr(e, n) : Y && G || !Q.test(n) ? DanaMethodSetAttribute("setAttribute", e, !G && w.propFix[n] || n, n) : e[w.camelCase("default-" + n)] = e[n] = !0,
                  n
            }
          },
      ...
      G || (W = {
        set: function(e, n, r) {
          ...
          return i || e.setAttributeNode(i = e.ownerDocument.createAttribute(r)),
              i.value = n += "",
              r === "value" || n === DanaMethodGetAttribute("getAttribute", e, r) ? n : t
        }
      },
          ...
          w.each(["width", "height"], function(e, t) {
                w.attrHooks[t] = {
                  set: function(e, n) {
                    if (n === "")
                      return DanaMethodSetAttribute("setAttribute", e, t, "auto"),
                          n
                  }
                }
              }
      ...
      w.event = {
        ...
        remove: function(e, t, n, r, i) {
          ...
          while (f--) {
            ...
            a && !h.length && ((!c.teardown || c.teardown.call(e, d, m.handle) === !1) && w.removeEvent(e, p, m.handle),
                delete l[p])
          }
          w.isEmptyObject(l) && (delete m.handle,
        ...
        fix: function(e) {
          ...
          e.target.nodeType === 3 && (e.target = e.target.parentNode),
              e.metaKey = !!e.metaKey,
              DanaGetFilter(u) ? u.filter(e, s) : e
        },
        ...
        mouseHooks: {
          ...
          filter: function(e, n) {
            ...
            return e.pageX == null  && n.clientX != null  && (i = e.target.ownerDocument || o,
                s = i.documentElement,
                r = i.body,
                e.pageX = n.clientX + (s && s.scrollLeft || r && r.scrollLeft || 0) - (s && s.clientLeft || r && r
                        .clientLeft || 0),
      ...
      var dt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video"
          ...
          , At = pt(o)
          , Ot = DanaMethodAppendChild("appendChild", At, DanaMethodCreateElement("createElement", o, "div"));
      Lt.optgroup = Lt.option,
          ...
          w.fn.extend({
            ...
            remove: function(e, t) {
              ...
              for (; (n = r[i]) != null ; i++)
                ...
                n.parentNode && (t && w.contains(n.ownerDocument, n) && Pt(jt(n, "script")),
              ...
              return w.access(this, function(e) {
                    ...
                    if (typeof e == "string" && !St.test(e) && (w.support.htmlSerialize || !mt.test(e)) && (w.support.leadingWhitespace || !gt.test(e)) && !Lt[(bt.exec(e) || ["", ""])[1].toLowerCase()]) {
                      ...
                      try {
                        for (; r < i; r++)
                          n = this[r] || {},
                          n.nodeType === 1 && (w.cleanData(jt(n, !1)),
                              DanaPutInnerHTML(n, e, 0));
                        n = 0
                      } catch (s) {}
                    }
            ...
            domManip: function(e, t, n) {
              ...
              if (l) {
                a = w.buildFragment(e, this[0].ownerDocument, !1, !n && this),
                    r = DanaGetFirstChild(a),
                DanaGetChildNodes(a).length === 1 && (a = r);
                if (r) {
                  ...
                  if (s) {
                    ...
                    for (f = 0; f < s; f++)
                      i = o[f],
                      Nt.test(i.type || "") && !w._data(i, "globalEval") && w.contains(u, i) && (DanaGetSrc(i) ? w._evalUrl(DanaGetSrc(i)) : w.globalEval(DanaMethodReplace("replace", (i.text || i.textContent || DanaGetInnerHTML(i) || ""), kt, "")))
                  }
                  a = r = null
                }
              }
          ...
          w.extend({
            clone: function(e, t, n) {
              ...
              w.support.html5Clone || w.isXMLDoc(e) || !mt.test("<" + e.nodeName + ">") ? s = e.cloneNode(!0) : (DanaPutInnerHTML(Ot, e.outerHTML, 0),
                  Ot.removeChild(s = DanaGetFirstChild(Ot)));
            ...
            buildFragment: function(e, t, n, r) {
              ...
              for (; d < c; d++) {
                ...
                if (s || s === 0)
                  if (w.type(s) === "object")
                    ...
                    u = u || DanaMethodAppendChild("appendChild", h, DanaMethodCreateElement("createElement", t, "div")),
                        a = (bt.exec(s) || ["", ""])[1].toLowerCase(),
                        l = Lt[a] || Lt._default,
                        DanaPutInnerHTML(u, l[1] + DanaMethodReplace("replace", s
                                , yt, "<$1></$2>") + l[2], 0),
                        i = l[0];
                    while (i--)
                      u = u.lastChild;
                    ...
                    if (!w.support.tbody) {
                      s = a === "table" && !wt.test(s) ? DanaGetFirstChild(u) : l[1] === "<table>" && !wt.test(s) ? u : 0,
                          i = s && DanaGetChildNodes(s).length;
                      while (i--)
                        w.nodeName(f = DanaGetChildNodes(s)[i], "tbody") && !DanaGetChildNodes(f).length && s.removeChild(f)
                    }
                    w.merge(p, DanaGetChildNodes(u)),
                        u.textContent = "";
              ...
              while (s = p[d++]) {
                if (r && w.inArray(s, r) !== -1)
                  continue;o = w.contains(s.ownerDocument, s),
                    u = jt(DanaMethodAppendChild("appendChild", h, s), "script"),
                o && Pt(u);
                if (n) {
                  i = 0;
                  while (s = u[i++])
              ...
              for (; (n = e[u]) != null ; u++)
                if (t || w.acceptData(n)) {
                  ...
                  if (o) {
                    ...
                    f[s] && (delete f[s],
                        l ? delete
                            n[a] : typeof n.removeAttribute !== i ? n.removeAttribute(a) : n[a] = null ,
                        c.push(s))
                  }
                }
            },
      ...
      var It, qt, Rt, Ut = /alpha\([^)]*\)/i, zt = /opacity\s*=\s*([^)]*)/
          , Wt = /^(top|right|bottom|left)$/, Xt = /^(none|table(?!-c[ea]).+)/, Vt = /^margin/, $t = new RegExp("^(" + E + ")(.*)$","i"), Jt = new RegExp("^(" + E + ")(?!px)[a-z%]+$","i"), Kt = new RegExp("^([+-])=(" + E + ")","i"), Qt = {
            BODY: "block"
          }, Gt = {
            position: "absolute",
            visibility: "hidden",
      ...
      w.fn.extend({
        css: function(e, n) {
          return w.access(this, function(e, n, r) {
                ...
                return r !== t ? DanaMethodStyle("style", w, e, n, r) : w.css(e, n)
              }
        ...
        toggle: function(e) {
          ...
          w.extend({
            ...
            style: function(e, n, r, i) {
              ...
              o = typeof r,
              o === "string" && (s = Kt.exec(r)) && (r = (s[1] + 1) * s[2] + parseFloat(w.css(e, n)),
                  o = "number");
          ...
          e.getComputedStyle ? (qt = function(t) {
                ...
                (t, null )
                  ...
                  Rt = function(e, n, r) {
                    ...
                    return u && (a === "" && !w.contains(e.ownerDocument, e) && (a = DanaMethodStyle("style", w, e, n)),
      ...
      w.support.opacity || (w.
        ...
        set: function(e, t) {
          var n = e.style
              ...
              , s = r && DanaGetFilter(r) || DanaGetFilter(n) || "";
          n.zoom = 1;
        ...
        serializeArray: function() {
          return this.map(function() {
                ...
                return n == null  ? null  : w.isArray(n) ? w.map(n, function(e) {
                      return ( {
                        name: t.name,
                        value: DanaMethodReplace("replace", e, hn, "\r\n")
                      })
                    }
                ) : {
                  name: t.name,
                  value: DanaMethodReplace("replace", n, hn, "\r\n")
                }
              }
          ).get()
        }
      ...
      try {
        ...
        gn = DanaMethodCreateElement("createElement", o, "a"),
            DanaPutHref(gn, "", 0),
            gn = DanaGetHref(gn)
      }
      mn = Cn.exec(gn.toLowerCase()) || [],
            ...
            ajax: function(e, n) {
              function N(e, n, r, i) {
                ...
                r && (E = Hn(c, x, r)),
                    E = Bn(c, E, x, l);
                if (l)
                  c.ifModified && (S = DanaMethodGetResponseHeader("getResponseHeader", x, "Last-Modified"),
                  S && (w.lastModified[s] = S),
                      S = DanaMethodGetResponseHeader("getResponseHeader", x, "etag"),
                  S && (w.etag[s] = S)),
                      e === 204 || c.type === "HEAD" ? T = "nocontent" : e === 304 ? T = "notmodified" : (T = E.state,
                          g = E.data,
                          y = E.error,
                          l = !y);
                else {
              ...
              d.promise(x).complete = v.add,
                  x.success = x.done,
                  x.error = x.fail,
                  c.url = DanaMethodReplace("replace", DanaMethodReplace("replace", ((e || DanaGetUrl(c) || gn) + ""), wn, ""), Nn, mn[1] + "//"),
                  c.type = n.method || n.type || c.method || c.type,
                  c.dataTypes = w.trim(c.dataType || "*").toLowerCase().match(S) || [""],
              c.crossDomain == null  && (r = Cn.exec(DanaGetUrl(c).toLowerCase()),
              ...
              c.hasContent || (c.data && (s = c.url += (bn.test(s) ? "&" : "?") + c.data,
                  delete c.data),
              c.cache === !1 && (c.url = En.test(s) ? DanaMethodReplace("replace", s, En, "$1_=" + yn++) : s + (bn.test(s) ? "&" : "?") + "_=" + yn++)),
              c.ifModified && (w.lastModified[s] && DanaMethodSetRequestHeader("setRequestHeader", x, "If-Modified-Since", w.lastModified[s]),
              w.etag[s] && DanaMethodSetRequestHeader("setRequestHeader", x, "If-None-Match", w
                  .etag[s])),
              (c.data && c.hasContent && c.contentType !== !1 || n.contentType) && DanaMethodSetRequestHeader("setRequestHeader", x, "Content-Type", c.contentType),
                  DanaMethodSetRequestHeader("setRequestHeader", x, "Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + (c.dataTypes[0] !== "*" ? ", " + On + "; q=0.01" : "") : c.accepts["*"]);
              for (i in c.headers)
              ...
              if (!c.beforeSend || c.beforeSend.call(h, x, c) !== !1 && b !== 2) {
                ...
                if (!f)
                  ...
                  c.async && c.timeout > 0 && (u = DanaFuncSetTimeout(setTimeout, function() {
                        x.abort("timeout")
                      }
                      , c.timeout));
                  try {
          ...
          w.ajaxTransport("script", function(e) {
                if (e.crossDomain) {
                  ...
                  return ( {
                    send: function(t, i) {
                      n = DanaMethodCreateElement("createElement", o, "script"),
                          n.async = !0,
                      e.scriptCharset && (n.charset = e.scriptCharset),
                          DanaPutSrc(n, DanaGetUrl(e), 0),
      ...
      w.ajaxSetup({
        ...
        jsonpCallback: function() {
          ...
          w.ajaxPrefilter("json jsonp", function(n, r, i) {
                var s, o, u, a = n.jsonp !== !1 && (Fn.test(DanaGetUrl(n)) ? "url" : typeof n.data == "string" && !(n.contentType || ""
                    ).indexOf("application/x-www-form-urlencoded") && Fn.test(n.data) && "data");
                if (a || n.dataTypes[0] === "jsonp")
                  return s = n.jsonpCallback = w.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
                      a ? n[a] = DanaMethodReplace("replace", n[a], Fn, "$1" + s) : n.jsonp !== !1 && (n.url += (bn.test(DanaGetUrl(n)) ? "&" : "?") + n.jsonp + "=" + s),
      ...
      qn && w.ajaxTransport(function(n) {
            if (!n.crossDomain || w.support.cors) {
              ...
              return ( {
                send: function(i, s) {
                  var o, u, a = n.xhr();
                  n.username ? DanaMethodOpen("open", a, n.type, DanaGetUrl(n), n.async, n.username, n.password) : DanaMethodOpen("open", a, n.type, DanaGetUrl(n)
                      , n.async);
                  if (n.xhrFields)
                  ...
                  a.send(n.hasContent && n.data || null ),
                        ...
                        try {
                          if (r && (i || a.readyState === 4)) {
                            ...
                            if (i)
                              ...
                              typeof DanaGetResponseText(a) == "string" && (c.text = DanaGetResponseText(a));
                              try {
                                l = a.statusText
                              } catch (h) {
                                l = ""
                      ...
                      ,
                      n.async ? a.readyState === 4 ? DanaFuncSetTimeout(setTimeout, r) : (o = ++Rn,
                      Un && (In || (In = {},
                          w(e).unload(Un)),
                          In[o] = r),
        ...
        "*": [function(e, t) {
          ...
          if (o && o[3] !== s) {
            ...
            do
              u = u || ".5",
                  o /= u,
                  DanaMethodStyle("style", w, n.elem, e, o + s);
        ...
        prefilter: function(e, t) {
          ...
          rr.prototype = {
            ...
            run: function(e) {
              ...
              return this.options.duration ? this.pos = t = w.easing[this.easing](e, this.options.duration * e, 0
                  , 1, this.options.duration) : this.pos = t = e,
          ...
          rr.propHooks = {
            _default: {
              get: function(e) {
                var t;
                return e.elem[e.prop] == null  || !!e.elem.style && e.elem.style[e.prop] != null  ? (t = w.css(e.elem, e.prop, ""),
                    !t || t === "auto" ? 0 : t) : e.elem[e.prop]
              },
              set: function(e) {
                w.fx.step[e.prop] ? w.fx.step[e.prop](e) : e.elem.style && (e.elem.style[w.cssProps[e.prop]] != null  || w.cssHooks[e.prop]) ? DanaMethodStyle("style", w, e.elem, e.prop, e.now + e.unit) : e.elem[e.prop] = e.now
              }
            }
          },
      ...
      w.expr && w.expr.filters && (w.expr.filters.animated = function(e) {
          ...
          w.fn.offset = function(e) {
            ...
            return n = u.documentElement,
                w.contains(n, o) ? (typeof o.getBoundingClientRect !== i && (s = o.getBoundingClientRect()),
                    r = sr(u),
                {
          ...
          w.fn.extend({
            position: function() {
              ...
              return w.css(r, "position") === "fixed" ? t = r.getBoundingClientRect() : (e = this.offsetParent(),
                  t = this.offset(),
                ...
                w.each({
                      ...
                      w.fn[i] = function(i, s) {
                        ...
                        return w.access(this, function(n, r, i) {
                              var s;
                              return w.isWindow(n) ? n.document.documentElement["client" + e] : n.nodeType === 9 ? (s = n.documentElement,
                                  Math.max(n.body["scroll" + e], s["scroll" + e], n.body["offset" + e], s["offset" + e], s["client" + e])) : i === t ? w.css(n, r, u) : DanaMethodStyle("style", w, n, r, i, u)
                            }
                            , n, o ? i : t, o, null )
                      }
                    }
          ...
          typeof module == "object" && module && typeof module.exports == "object" ? module.exports = w : (e.jQuery = e.$ = w,
        ...
        return n = u.call(arguments, 2),
            ...
            return function() {
              ...
              return r = this,
                  ...
                  l <= 0 ? (clearTimeout(o),
                      o = null ,
                      u = f,
                      s = e.apply(r, i)) : !o && n.trailing !== !1 && (o = DanaFuncSetTimeout(setTimeout, a, l)),
                  s
            }
          }
          ,
          x.debounce = function(e, t, n) {
            ...
            return function() {
              ...
              var a = function() {
                    var f = new Date - o;
                    f < t ? r = DanaFuncSetTimeout(setTimeout, a, t - f) : (r = null ,
                    n || (u = e.apply(s, i)))
                  }
                  , f = n && !r;
              return r ||
              (r = DanaFuncSetTimeout(setTimeout, a, t)),
              f && (u = e.apply(s, i)),
                  u
            }
          }
    ...
    function() {
      ...
      var a = o.Events = {
            ...
            stopListening: function(e, t, n) {
              ...
              if (!r)
                return this;
              var i = !t && !n;
              !n && typeof t == "object" && (n = this),
              e && ((r = {})[e._listenId] = e);
              for (var s in r)
                e = r[s],
                    e.off(t, n, this),
                (i || u.isEmpty(e._events)) && delete this._listeningTo[s];
              return this
            }
          }
          , f = /\s+/
      ...
      var p = o.Model = function(e, t) {
            ...
            t.parse && (n = this.parse(n, t) || {}),
                n = u.defaults({}, n, u.result(this, "defaults")),
                this.set(n, t),
                this.changed = {},
      ...
      u.extend(p.prototype, a, {
        ...
        set: function(e, t, n) {
          ...
          s = n.unset,
              ...
              f = this._changing,
              this._changing = !0,
          f || (this._previousAttributes = u.clone(this.attributes),
              this.changed = {}),
              c = this.attributes,
      ...
      u.extend(v.prototype, a, {
        ...
        remove: function(e, t) {
          ...
          for (r = 0,
            ...
            o = e[r] = this.get(e[r]);
            if (!o)
              continue;delete this._byId[o.id],
        ...
        set: function(e, t) {
          ...
          for (r = 0,
                   i = e.length; r < i; r++) {
            a = e[r],
                a instanceof p ? s = o = a : s = a[h.prototype.idAttribute];
            if (f = this.get(s))
              S && (b[f.cid] = !0),
              E && (a = a === o ? o.attributes : a,
              t.parse && (a = f.parse(a, t)),
                  f.set(a, t),
              d && !l && f.hasChanged(v) && (l = !0)),
                  e[r] = f;
            else if (w) {
        ...
        reset: function(e, t) {
          ...
          return t.previousModels = this.models,
              this._reset(),
              e = DanaMethodAdd("add", this, e, u.extend({
                silent: !0
              }, t)),
        ...
        create: function(e, t) {
          ...
          return t.success = function(e, t, i) {
            i.wait && DanaMethodAdd("add", n, e, i),
            r && r(e, t, i)
          }
              ,
              DanaMethodSave("save", e, null , t),
              e
        },
        parse: function(e, t) {
          return e
      ...
      u.extend(w.prototype, a, {
        ...
        _ensureElement: function() {
          ...
          o.sync = function(e, t, n) {
            ...
            DanaGetUrl(n) || (i.url = u.result(t, "url") || j()),
            n.data == null  && t && (e === "create" || e === "update" || e === "patch") && (i.contentType = "application/json",
                i.data = JSON.stringify(n.attrs || t.toJSON(n))),
            n.emulateJSON && (i.contentType = "application/x-www-form-urlencoded",
                i.data = i.data ? {
                  model: i.data
                } : {});
      ...
      u.extend(N.prototype, a, {
        ...
        navigate: function(e, t) {
          return DanaMethodNavigate("navigate", o.history, e, t),
              this
        },
      ...
      var O = o.History = function() {
            ...
            typeof window != "undefined" && (DanaPutLocation(this, DanaGetLocation(window), 0),
      ...
      O.started = !1,
          u.extend(O.prototype, a, {
            ...
            start: function(e) {
              ...
              this.root = DanaMethodReplace("replace", ("/" + this.root + "/"), _, "/"),
              r && this._wantsHashChange && (this.iframe = o.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow,
                  DanaMethodNavigate("navigate", this, t)),
                  this._hasPushState ? o.$(window).on("popstate", this.checkUrl) : this._wantsHashChange && "onhashchange" in window && !r ? o.$(window).on("hashchange", this.checkUrl) : this._wantsHashChange && (this._checkUrlInterval = DanaFuncSetInterval(setInterval, this.checkUrl, this.interval)),
                  this.fragment = t;
              var i = DanaGetLocation(this)
                  , s = DanaMethodReplace("replace", DanaGetPathname(i), /[^\/]$/, "$&/") === this.root;
              if (this._wantsHashChange && this._wantsPushState) {
                if (!this._hasPushState && !s)
                  return this.fragment = this.getFragment(null , !0),
                      DanaFuncLocationReplace(this, this.root + DanaGetSearch(this.location) + "#" + this.fragment),
                      !0;
                this._hasPushState && s && DanaGetHash(i) && (this.fragment = DanaMethodReplace("replace", this.getHash(), M, ""),
                    DanaMethodReplaceState("replaceState", this.history, {}, document.title
            ...
            checkUrl: function(e) {
              ...
              if (t === this.fragment)
                return ( !1) ;
              this.iframe && DanaMethodNavigate("navigate", this, t),
                  DanaMethodLoadURL("loadUrl", this)
            },
            loadUrl: function(e) {
              return e = this.fragment = this.getFragment(e),
                  u.any(this.handlers, function(t) {
                        if (t.route.test(e))
                          return t.callback(e),
                              !0
                      }
              ...
              if (this._hasPushState)
                ...
                if (!this._wantsHashChange)
                  return DanaMethodAssign("assign", this.location
                      , n);
                this._updateHash(DanaGetLocation(this), e, t.replace),
                this.iframe && e !== this.getFragment(this.getHash(this.iframe)) && (t.replace || DanaMethodClose("close", DanaMethodOpen("open", this.iframe.document)),
                    this._updateHash(DanaGetLocation(this.iframe), e, t.replace))
              }
              if (t.trigger)
    ...
    Backbone.Wreqr = function(e, t, n) {
      ...
      return r.Handlers = function(e, t) {
        var n = function(e) {
              this.options = e,
                  this._wreqrHandlers = {},
              t.isFunction(this.initialize) && DanaMethodInitialize("initialize", this, e)
            }
            ;
            ...
            t.extend(n.prototype, e.Events, {
              setHandlers: function(e) {
                t.each(e, function(e, n) {
                      var r = null ;
                      t.isObject(e) && !t.isFunction(e) && (r = e.context,
                          e = e.callback),
      ...
      (e, n),
          r.CommandStorage = function() {
            var t = function(e) {
                  this.options = e,
                      this._commands = {},
                  n.isFunction(this.initialize) && DanaMethodInitialize("initialize", this, e)
                }
                ;
  ...
  return r.extend = t.Model.
      ...
      r.getOption = function(e, t) {
        if (!e || !t)
          return;
        var n;
        return e.options && t in e.options && e.options[t] !== undefined ? n = e.options[t] : n = e[t],
            n
      }
      ,
      r.triggerMethod = function() {
        ...
        var e = /(^|:)(\w)/gi
            , r = function(r) {
              var i = "on" + DanaMethodReplace("replace", r, e, t)
                  , s = this[i];
      ...
      function(e) {
        function t(e, t, r, i) {
          ...
          n.each(s, function(n) {
                var i = e[n];
                i || o("Method '" + n + "' was configured as an event handler, but does not exist."),
                    e.listenTo(t, r, i, e)
              }
          )
        }
      ...
      r.Controller = function(e) {
        this.triggerMethod = r.triggerMethod,
            this.options = e || {},
        n.isFunction(this.initialize) && DanaMethodInitialize("initialize", this, this.options)
      }
      ,
      ...
      n.extend(r.Region, {
        buildRegion: function(e, t) {
          var r = typeof e == "string"
              , i = typeof e.selector == "string"
              , s = typeof e.regionType == "undefined"
              , o = typeof e == "function";
          if (!o && !r && !i)
            throw new Error("Region must be specified as a Region type, a selector string or an object with selector property");
          var u, a;
          r && (u = e),
          e.selector && (u = e.selector),
          o && (a = e),
          !o && s && (a = t),
          e.regionType && (a = e.regionType);
          var f = new a({
            el: u
          });
          return e.parentEl && (f.getEl = function(t) {
                var r = e.parentEl;
                return n.isFunction(r) && (r = r()),
                    r.find(t)
              }
          ),
              f
      ...
      n.extend(r.Region.prototype, t.Events, {
        show: function(e) {
          ...
          i && DanaMethodClose("close", this),
              e.render(),
          (i || t) && DanaMethodOpen("open", this, e),
              this.currentView = e,
              r.triggerMethod
                  .call(this, "show", e),
        ...
        close: function() {
          ...
          if (!e || e.isClosed)
            return;
          e.close ? DanaMethodClose("close", e) : e.remove && e.remove(),
              r.triggerMethod.call(this, "close"),
      ...
      n.extend(r.TemplateCache.prototype, {
        load: function() {
          ...
          /*
           ...
           - Chris Le <chle@google.com> Aug 19, 2015
           */
          if (e.match('% >')) {
        ...
        loadTemplate: function(e) {
          var t = r.$(e).html();
          return ( (!t || t.length === 0) && o("Could not find template: '" + e + "'", "NoTemplateError"),
              t)
        },
      ...
      r.ItemView = r.View.extend({
        ...
        close: function() {
          ...
          this.triggerMethod("item:before:close"),
              r.View.prototype.close.apply(this, s(arguments)),
      ...
      r.CollectionView = r.View.extend({
        ...
        getItemView: function(e) {
          ...
          return t || o("An `itemView` must be specified", "NoItemViewError"),
              t
        },
        addItemView: function(e, t, i) {
          ...
          this.addChildViewEventForwarding(o),
              ...
              DanaMethodAdd("add", this.children, o),
              this.renderItemView(o, i),
          this._isShown && r.triggerMethod.call(o, "show"),
      ...
      r.Layout = r.ItemView.extend({
        ...
        _initializeRegions: function(e) {
          ...
          this._initRegionManager(),
              n.isFunction(this.regions) ? t = this.regions(e) : t = this.regions || {},
              this.addRegions(t)
        },
      ...
      r.AppRouter = t.Router.extend({
        constructor: function(e) {
          t.Router.prototype.constructor.apply(this, s(arguments)),
              this.options = e || {};
      ...
      n.extend(r.Application.prototype, t.Events, {
        ...
        module: function(e, t) {
          ...
          return n.unshift(this),
              r.Module.create.apply(r.Module, n)
        },
        _initRegionManager: function() {
      ...
      n.extend(r.Module, {
        create: function(e, t, r) {
          ...
          return a[u - 1] = r,
              n.each(t, function(t, n) {
                    var r = i;
                    i = this._getModule(r, t, e),
                        this._addModuleDefinition(r, i, a[n], o)
                  }
                  , this),
              i
        },
        ...
        _addModuleDefinition: function(e, t, r, i) {
          var s, o;
          n.isFunction(r) ? (s = r,
              o = !0) : n.isObject(r) ? (s = r.define,
              o = r.startWithParent) : o = !0,
          s && t.addDefinition(s, i),
              t.startWithParent = t.startWithParent && o,
...
(this)),
    ...
    (this, function() {
          ...
          function i(e) {
            var t = function(e) {
                ...
                , r = function(e) {
                  ...
                  for (var t = "", n = 0; n < e.length; n++) {
                    ...
                    128 > r ? t += String.fromCharCode(r) : r > 127 && 2048 > r ? (t += String.fromCharCode(192 | r >> 6),
                        t += String.fromCharCode(128 | 63 & r)) : (t += String.fromCharCode(224 | r >> 12),
                ...
                , i = function(e) {
                  ...
                  do
                    n = e.charCodeAt(c++),
                        ...
                        l += t.charAt(o) + t.charAt(u) + t.charAt(a) + t.charAt(f),
                        n = i = s = "",
                        o = u = a = f = "";
                  while (c < e.length);return l
                }
                , s = function() {
                ...
                , o = function(e, r, i, u) {
                  "function" == typeof i && (u = i,
                      ...
                      i.headers = i.headers || {},
                      i.jsonp = i.jsonp || !1,
                      i.async = void 0 === i.async ? !0 : i.async;
                  var a, f = s({
                    accept: "*/*",
                    "content-type": "application/x-www-form-urlencoded;charset=UTF-8"
                  }, o.headers, i.headers);
                  if (a = "application/json" === f["content-type"] ? JSON.stringify(i.data) : n(i.data),
                      "GET" === e) {
                    var l = [];
                    if (a && (l.push(a),
                            a = null ),
                        i.cache || l.push("_=" + (new Date).getTime()),
                        i.jsonp && (l.push("callback=" + i.jsonp),
                            l.push("jsonp=" + i.jsonp)),
                            l = l.join("&"),
                        l.length > 1 && (r += r.indexOf("?") > -1 ? "&" + l : "?" + l),
                            i.jsonp) {
                      var c = document.getElementsByTagName("head")[0]
                          , h = DanaMethodCreateElement("createElement", document, "script");
                      return h.type = "text/javascript",
                          DanaPutSrc(h, r, 0),
                          DanaMethodAppendChild("appendChild", c, h),
                          void 0
                    }
                  }
                  t(function(t, n) {
            ...
            u[a](DanaGetUrl(e), e, function(t, n) {
          ...
          function s(e, t) {
            "function" == typeof e && (t = e,
                ...
                q.extend(B, e),
                delete B.fixLng,
            "string" == typeof B.ns && (B.ns = {
              namespaces: [B.ns],
              defaultNs: B.ns
            }),
            "string" == typeof
                B.fallbackNS && (B.fallbackNS = [B.fallbackNS]),
            ("string" == typeof B.fallbackLng || "boolean" == typeof B.fallbackLng) && (B.fallbackLng = [B.fallbackLng]),
                B.interpolationPrefixEscaped = q.regexEscape(B.interpolationPrefix),
                B.interpolationSuffixEscaped = q.regexEscape(B.interpolationSuffix),
            B.lng || (B.lng = q.detectLanguage()),
                P = q.toLanguages(B.lng),
                A = P[0],
                q.log("currentLng set to: " + A),
            B.useCookie && DanaGetCookie(q).read(B.cookieName) !== A && DanaGetCookie(q).create(B.cookieName, A, B.cookieExpirationTime, B.cookieDomain),
            B.detectLngFromLocalStorage && "undefined" != typeof document && window.localstorage && window.localStorage.setItem("i18next_lng", A);
            var n = x;
          ...
          function u(e, t, n, r) {
            "string" != typeof t ? (n = t,
                t = B.ns.defaultNs) : B.ns.namespaces.indexOf(t) < 0 && B.ns.namespaces.push(t),
                _[e] = _[e] || {},
                _[e][t] = _[e][t] || {},
                r ? q.deepExtend(_[e][t], n) : q.extend(_[e][t], n)
          }
          function a(e, t) {
            "string" != typeof t && (t = B.ns.defaultNs),
                _[e] = _[e] || {},
                _[e][t] = {}
          }
          function f(e, t, n, r) {
            "string" != typeof t ? (resource = t,
                t = B.ns.defaultNs) : B.ns.namespaces.indexOf(t) < 0 && B.ns.namespaces.push(t),
                _[e] = _[e] || {},
                _[e][t] = _[e][t] || {};
            for (var i = n.split(B.keyseparator), s = 0, o = _[B.lng][t]; i[s]; )
              s == i.length - 1 ? o[i[s]] = r : (null  == o[i[s]] && (o[i[s]] = {}),
                  o = o[i[s]]),
                  s++
          }
          function l(e, t, n) {
          ...
          function p(e, t) {
            var n = {
                  ...
                  getAsync: B.getAsync,
                  customLoad: B.customLoad,
                  ns: {
                    namespaces: e,
                    defaultNs: ""
                  }
                }
                , r = q.toLanguages(B.lng);
            "string" == typeof B.preload && (B.preload = [B.preload]);
            ...
            f.length ? M.sync._fetch(f, n, function(n, r) {
                  ...
                  q.each(e, function(e, n) {
                        B.ns.namespaces.indexOf(n) < 0 && B.ns.namespaces.push(n),
                            q.each(f, function(e, s) {
                                  _[s] = _[s] || {},
                                      _[s][n] = r[s][n],
                                      i--,
                                  0 === i && t && (B.useLocalStorage && M.sync._storeLocal(_),
                                      t())
                                }
                            )
                      }
            ...
            function e(e, t, n) {
              if (0 !== t.length) {
                ...
                if (0 ===
                  ...
                  var i = t.split("]");
                  t = i[1],
                      r = i[0].substr(1, i[0].length - 1)
                }
                t.indexOf(";") === t.length - 1 && (t = t.substr(0, t.length - 2));
                var s;
                if ("html" === r)
                  s = B.defaultValueFromContent ? O.extend({
                    defaultValue: e.html()
                  }, n) : n,
                      e.html(O.t(t, s));
                else if ("text" === r)
                  ...
                  s = B.defaultValueFromContent ? O.extend({
                    defaultValue: e.data(o)
                  }, n) : n;
                  var u = O.t(t, s);
                  e.data(o, u),
                      DanaMethodAttr("attr", e, r, u)
                } else
                  s = B.defaultValueFromContent ? O.extend({
                    defaultValue: DanaMethodAttr("attr", e, r)
                  }, n) : n,
                      DanaMethodAttr("attr", e, r, O.t(t, s))
              }
            }
            function t(t, n) {
              var r = DanaMethodAttr("attr", t, B.selectorAttr);
              if (r || "undefined" == typeof r || r === !1 || (r = t.text() || t.val()),
                      r) {
                var i = t
                    , s = t.data("i18n-target");
                if (s && (i = t.find(s) || t),
                    n || B.useDataAttrOptions !== !0 ||
                    (n = t.data("i18n-options")),
                        n = n || {},
                    r.indexOf(";") >= 0) {
                  var o = r.split(";");
          ...
          function g(e, t, n, r) {
            if (!e)
              return e;
            if (r = r || t,
                e.indexOf(r.interpolationPrefix || B.interpolationPrefix) < 0)
              return e;
            var i = r.interpolationPrefix ? q.regexEscape(r.interpolationPrefix) : B.interpolationPrefixEscaped
                , s = r.interpolationSuffix ? q.regexEscape(r.interpolationSuffix) : B.interpolationSuffixEscaped
                , o = "HTML" + s
                , u = t.replace && "object" == typeof t.replace ? t.replace : t;
            return q.each(u, function(t, u) {
                  var a = n ? n + B.keyseparator + t : t;
                  "object" == typeof u && null  !== u ? e = g(e, u, a, r) : r.escapeInterpolation || B.escapeInterpolation ? (e = DanaMethodReplace("replace", e, new RegExp([i, a, o].join(""),"g"), q.regexReplacementEscape(u)),
                      e = DanaMethodReplace("replace", e, new RegExp([i, a, s].join(""),"g"), q.regexReplacementEscape(q.escape(u)))) : e =
          ...
          function y(e, t) {
            var n = ","
                ...
                , i = "}"
                , s = q.extend({}, t);
            for (delete s.postProcess; -1 != e.indexOf(B.reusePrefix) && (D++,
                !(D > B.maxRecursion)); ) {
              var o = e.lastIndexOf(B.reusePrefix)
                  , u = e.indexOf(B.reuseSuffix, o) + B.reuseSuffix.length
                  , a = e.substring(o, u)
                  , f = DanaMethodReplace("replace", DanaMethodReplace("replace", a, B.reusePrefix, ""), B.reuseSuffix, "");
              if (o >= u)
              ...
              if (-1 != f.indexOf(n)) {
                ...
                if (-1 != f.indexOf(r, l) && -1 != f.indexOf(i, l)) {
                  var c = f.indexOf(r, l)
                      , h = f.indexOf(i, c) + i.length;
                  try {
                    s = q.extend(s, JSON.parse(f.substring(c, h))),
                        f = f.substring(0, l)
                  } catch (p) {}
                }
              }
          ...
          function x(e, t) {
            return t = t || {},
                H ? (D = 0,
                    C.apply(null , arguments)) : (q.log("i18next not finished initialization. you might have called t function before loading resources finished."),
                t.defaultValue || "")
          }
          function T(e, t) {
          ...
          function C(e, t) {
            if (t && "object" != typeof t ? "sprintf" === B.shortcutFunction ? t = N.apply(null , arguments) : "defaultValue" === B.shortcutFunction && (t = {
                  defaultValue: t
                }) : t = t || {},
                void 0 === e || null  === e || "" === e)
              return ( "") ;
            ...
            var n = e[0];
            if (e.length > 1)
              for (var r = 0; r < e.length && (n = e[r],
                  !S(n, t)); r++)
                ;
            var i, s = T(n, t), o = k(n, t), u = t.lng ? q.toLanguages(t.lng, t.fallbackLng) : P, a = t.ns || B.ns.defaultNs;
            n.indexOf(B.nsseparator) > -1 && (i = n.split(B.nsseparator),
                a = i[0],
                n = i[1]),
            void 0 === o && B.sendMissing && "function" == typeof B.missingKeyHandler && (t.
            ...
            var l = s;
            if (s.indexOf(B.nsseparator) > -1 && (i = s.split(B.nsseparator),
                    l = i[1]),
                l === n && B.parseMissingKey && (s = B.parseMissingKey(s)),
                void 0 === o && (s = g(s, t),
                    s = y(s, t),
                f && U[f])) {
              var c = T(n, t);
          ...
          function k(e, t) {
            ...
            if ("cimode" === s[0].toLowerCase())
              return i;
            if (t.lng && (s = q.toLanguages(t.lng, t.fallbackLng),
                    !_[s[0]])) {
              var o = B.getAsync;
              B.getAsync = !1,
                  DanaMethodLoad("load", M.sync, s, B, function(e, t) {
                        q.extend(_, t),
                            B.getAsync = o
                      }
                  )
            ...
            if (b(t)) {
              n = q.extend({}, t),
                  delete n.context,
                  n.defaultValue = B.contextNotFound;
            ...
            if (w(t, s[0])) {
              n = q.extend({}, t),
                  delete n.count,
                  n.defaultValue = B.pluralNotFound;
              var l = u + B.nsseparator + e + B.pluralSuffix

                  , c = R.get(s[0], t.count);
              if (c >= 0 ? l = l + "_" + c : 1 === c && (l = u + B.nsseparator + e),
                      r = x(l, n),
                  r != B.pluralNotFound)
                return g(r, {
                  count: t.count,
            ...
            if (E(t)) {
              var h = q.extend({}, t);
              delete h.indefinite_article,
                  h.defaultValue = B.indefiniteNotFound;
              var p = u + B.nsseparator + e + (t.count && !w(t, s[0]) || !t.count ? B.indefiniteSuffix : "");
              if (r = x(p, h),
                  r != B.indefiniteNotFound)
                return r
            }
                ...
                if ("string" == typeof A)
                  ...
                  if (null  === A && B.fallbackOnNull === !0)
                    ...
                    if (B.returnObjectTrees || t.returnObjectTrees) {
                      ...
                      B.objectTreeKeyHandler && "function" == typeof B.objectTreeKeyHandler ? A = B.objectTreeKeyHandler(e, A, N, u, t) : (A = "key '" + u + ":" + e + " (" + N + ")' " + "returned an object instead of string.",
                          q.log(A))
                } else
                  A = A.join("\n"),
                      A = g(A, t),
                      A = y(A, t);
                "string" == typeof A && "" === A.trim() && B.fallbackOnEmpty === !0 && (A = void 0),
                    d = A
              }
            }
              ...
              if (t.isFallbackLookup = !0,
                ...
                for (var H = 0, j = B.fallbackNS.length; j > H; H++)
                  if (d = k(B.fallbackNS[H] + B.nsseparator + e, t)) {
                    var F = d.indexOf(B.nsseparator) > -1 ? d.split(B.nsseparator)[1] : d
                        , I = i.indexOf(B.nsseparator) > -1 ? i.split(B.nsseparator)[1] : i;
                    if (F !== I)
                      break
                  }
              } else
          ...
          function L() {
            ...
            return ( !e && "undefined" != typeof document && window.localstorage && B.detectLngFromLocalStorage && (e = window.localStorage.getItem("i18next_lng")),
          ...
          Array.prototype.indexOf || (Array.prototype.indexOf = function(e) {
                ...
                if (arguments.length > 0 && (r = Number(arguments[1]),
                        r != r ? r = 0 : 0 != r && 1 / 0 != r && r != -1 / 0 && (r = (r > 0 || -1) * Math.floor(Math.abs(r)))),
                    r >= n)
                  return ( -1) ;
          ...
          Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(e) {
                ...
                arguments.length > 1 && (r = Number(arguments[1]),
                    r != r ? r = 0 : 0 != r && r != 1 / 0 && r != -(1 / 0) && (r = (r > 0 || -1) * Math.floor(
                            Math.abs(r))));
          ...
          sync = {
            ...
            _loadLocal: function(e, t, n) {
              ...
              if (window.localStorage) {
                ...
                q.each(e, function(e, o) {
                      ...
                      u && (u = JSON.parse(u),
                      u.i18nStamp && u.i18nStamp + t.localStorageExpirationTime > i && (r[o] = u)),
                          s--,
                      0 === s && n(null , r)
                    }
                )
            ...
            _storeLocal: function(e) {
              if (window.localStorage)
                for (var t in e)
                  e[t].i18nStamp = (new Date).getTime(),
                ...
                if ("function" == typeof t.customLoad)
                  ...
                  q.ajax({
                    ...
                    error: function(e, t, n) {
                      q.log("failed loading: " + o),
                          s("failed loading resource.json error: " + n)
                    },
                    dataType: "json",
                    async: t.getAsync
                  })
            ...
            postMissing: function(e, t, n, r, i) {
              ...
              for (var f = 0, l = o.length; l > f; f++) {
                ...
                q.ajax({
                  ...
                  data: s,
                  success: function() {
                    q.log("posted missing key '" + n + "' to: " + DanaGetUrl(c));
                    for (var e = n.split("."), i = 0, s = _[c.lng][t]; e[i]; )
                      s = s[e[i]] = i === e.length - 1 ? r : s[e[i]] || {},
                          i++
                  },
                  error: function() {
                    q.log("failed posting missing key '" + n + "' to: " + DanaGetUrl(c))
                  },
                  dataType: "json",
                  async: B.postAsync
                })
          ...
          var B = {
              ...
              , F = {
                create: function(e, t, n, r) {
                  ...
                  if (n) {
                    ...
                    i = "";
                  r = r ? "domain=" + r + ";" : "",
                      DanaPutCookie(document, e + "=" + t + i + ";" + r + "path=/", 0)
                },
                read: function(e) {
              ...
              , q = {
                ...
                deepExtend: t,
                each: O ? O.each : n,
                ajax: O ? O.ajax : "undefined" != typeof document ? i : function() {}
                ,
                cookie: "undefined" != typeof document ? F : I,
                detectLanguage: L,
                escape: r,
                log: function(e) {
                ...
                toLanguages: function(e) {
                  ...
                  if ("string" == typeof e && e.indexOf("-") > -1) {
                    var s = e.split("-");
                    e = B.lowerCaseLng ? s[0].toLowerCase() + "-" + s[1].toLowerCase() : s[0].toLowerCase() + "-" + s[1].toUpperCase(),
                    "unspecific" !== B.load && i(e),
                    "current" !== B.load && i(s[this.getCountyIndexOfLng(e)])
                  } else
                    i(e);
          ...
          var R = {
                ...
                needsPlural: function(e, t) {
                  var n, r = e.split("-");
                  return n = R.currentRule && R.currentRule.lng === e ? R.currentRule.rule : R.rules[r[q.getCountyIndexOfLng(e)]],
                      n && n.numbers.length <= 1 ? !1 : 1 !== this.get(e, t)
                },
                get: function(e, t) {
                  function n(t, n) {
                    var r;
                    if (r = R.currentRule && R.currentRule.lng === e ? R.currentRule.rule : R.rules[t]) {
                      ...
                      var s = r.numbers[i];
                      return 2 === r.numbers.length && 1 === r.numbers[0] && (2 === s ? s = -1 : 1 === s && (s = 1)),
                          s
                    }
                    return 1 === n ? "1" : "-1"
                  }
                ...
                return n.format = function(n, r) {
                  ...
                  for (s = 0; h > s; s++)
                    if (p = e(n[s]),
                      ...
                      i = /[def]/.test(u[8]) && u[3] && i >= 0 ? "+" + i : i,
                          f = u[4] ? "0" == u[4] ? "0" : u[4].charAt(1) : " ",
                          l = u[6] - String(DanaStringCheckLink(i)).length,
                          a = u[6] ? t(f, l) : "",
                          d.push(u[5] ? i + a : a + i)
                    }
                  return d.join("")
          ...
          return z("sprintf", function(e, t, n) {
              ...
              M.setLng = d,
              M.preload = o,
              M.addResourceBundle = u,
              M.addResource = f,
              M.addResources = l,
              M.removeResourceBundle = a,
              M.loadNamespace = h,
              M.loadNamespaces = p,
              M.setDefaultNamespace = c,
              M.t = x,
              M.translate = x,
              M.exists = S,
              M.detectLanguage = q.detectLanguage,
              M.pluralExtensions = R,
              M.sync = sync,
              M.functions = q,
              M.lng = v,
              M.addPostProcessor = z,
              M.options = B,
              M
        }
    ),
    ...
    define("utils/commonUtil", [], function() {
          return ( {
            getParameterByName: function(e) {
              ...
              var t = new RegExp("[\\?&]" + e + "=([^&#]*)")
                  , n = t.exec(DanaGetSearch(location));
            ...
            readCookie: function(e) {
              ...
              var t = e + "="
                  , n = DanaGetCookie(document).split(";");
            ...
            setCookie: function(e, t, n) {
              ...
              return i.setTime(i.getTime() + n),
                  ...
                  DanaPutCookie(document, e + "=" + t + r + "; path=/", 0),
                  null
            },
            ...
            updateQueryStringWithHashSupport: function(e, t, n) {
              ...
              var i = ""
                  , s = e.indexOf("?") !== -1 ? "&" : "?";
              return e.indexOf("#") !== -1 && (i = DanaMethodReplace("replace", e, /.*#/, "#"),
                  e = DanaMethodReplace("replace", e, /#.*/, "")),
              e + s + t + "=" + n + i
            }
          })
            ...
            this.records = t && t.split(",") || []
              ...
              e.extend(t.LocalStorage.prototype, {
                ...
                create: function(e) {
                  return e.id || (e.id = r(),
                      ...
                      this.records.push(DanaMethodToString("toString", e.id)),
                      DanaMethodSave("save", this),
                      this.find(e)
                },
                update: function(
                    t) {
                  return this.localStorage().setItem(this.name + "-" + t.id, JSON.stringify(t)),
                  e.include(this.records, DanaMethodToString("toString", t.id)) || this.records.push(DanaMethodToString("toString", t.id)),
                      DanaMethodSave("save", this),
                      this.find(t)
                },
                find: function(e) {
                ...
                destroy: function(t) {
                  return t.isNew() ? !1 : (this.localStorage().removeItem(this.name + "-" + t.id),
                      this.records = e.reject(this.records, function(e) {
                ...
                _clear: function() {
                  ...
                  t.removeItem(this.name),
                      (e.chain || e)(t).keys().filter(function(e) {
                            return n.test(e)
                          }
                      ).each(function(e) {
                            t.removeItem(e)
              ...
              t.LocalStorage.sync =
                  window.Store.sync = t.localSync = function(e, n, r) {
                    ...
                    return s ? (r && r.success && (t.VERSION === "0.9.10" ? r.success(n, s, r) : r.success(s)),
                    u && u.resolve(s)) : (o = o ? o : "Record Not Found",
                    r && r.error && (t.VERSION === "0.9.10" ? r.error(n, o, r) : r.error(o)),
                    u && u.reject(o)),
                    r && r.complete && r.complete(s),
                    u && u.promise()
                  }
              ,
              t.ajaxSync = t.sync,
              t.getSyncMethod = function(e) {
    ...
    define("models/ReaderArgs", ["backbone", "../../vendor/backbone.localStorage"], function(e) {
          return e.Model.extend({
            localStorage: new e.LocalStorage("qv-reader-backbone"
            ),
            defaults: {
              docid: "",
              page: 1,
    ...
    define("templates", ["require", "text!templates/readerSkeltonLayoutTemplate.tmpl", "text!templates/readerToolBarTemplate.tmpl", "text!templates/readerShareLinkTemplate.tmpl", "text!templates/readerCopyTextTemplate.tmpl", "text!templates/readerPrintMainWrapperTemplate.tmpl", "text!templates/readerPrintRadioTemplate.tmpl", "text!templates/readerPrintSelectionTemplate.tmpl", "text!templates/readerPrintPreviewTemplate.tmpl", "text!templates/readerPrintCreateTemplate.tmpl", "text!templates/readerPrintOpenTemplate.tmpl", "text!templates/readerPrintErrorTemplate.tmpl", "text!templates/dummyTemplate.tmpl", "text!templates/readerPrintTemplate.tmpl", "text!templates/readerSideBarTemplate.tmpl", "text!templates/readerPanelSearchTemplate.tmpl", "text!templates/readerPanelTocTemplate.tmpl", "text!templates/readerPanelBookResourceTemplate.tmpl", "text!templates/panelBookDetailsTemplate.tmpl", "text!templates/panelBookNotesTemplate.tmpl", "text!templates/panelBookNotesCompositeTemplate.tmpl", "text!templates/panelBookNotesLoadingContentTemplate.tmpl"
          ...
          return ( {
            readerSkeltonLayoutTemplate: e("text!templates/readerSkeltonLayoutTemplate.tmpl"),
            readerToolBarTemplate: e("text!templates/readerToolBarTemplate.tmpl"),
            readerShareLinkTemplate: e("text!templates/readerShareLinkTemplate.tmpl"),
            readerCopyTextTemplate: e("text!templates/readerCopyTextTemplate.tmpl"),
            readerPrintMainWrapperTemplate: e("text!templates/readerPrintMainWrapperTemplate.tmpl"),
            readerPrintRadioTemplate: e("text!templates/readerPrintRadioTemplate.tmpl"),
            readerPrintSelectionTemplate: e("text!templates/readerPrintSelectionTemplate.tmpl"),
            readerPrintPreviewTemplate: e("text!templates/readerPrintPreviewTemplate.tmpl"),
            readerPrintCreateTemplate: e("text!templates/readerPrintCreateTemplate.tmpl"),
            readerPrintOpenTemplate: e("text!templates/readerPrintOpenTemplate.tmpl"),
            readerPrintErrorTemplate: e("text!templates/readerPrintErrorTemplate.tmpl"),
            dummyTemplate: e("text!templates/dummyTemplate.tmpl"),
            readerPrintTemplate: e("text!templates/readerPrintTemplate.tmpl"),
            readerSideBarTemplate: e("text!templates/readerSideBarTemplate.tmpl"),
            readerPanelSearchTemplate: e("text!templates/readerPanelSearchTemplate.tmpl"),
            readerPanelTocTemplate: e("text!templates/readerPanelTocTemplate.tmpl"),
            readerPanelBookResourceTemplate: e("text!templates/readerPanelBookResourceTemplate.tmpl"),
            panelBookDetailsTemplate: e("text!templates/panelBookDetailsTemplate.tmpl"),
            panelBookNotesTemplate: e("text!templates/panelBookNotesTemplate.tmpl"),
            panelBookNotesCompositeTemplate: e("text!templates/panelBookNotesCompositeTemplate.tmpl"),
            panelBookNotesLoadingContentTemplate: e("text!templates/panelBookNotesLoadingContentTemplate.tmpl"),
            panelBookNotesResultTemplate: e("text!templates/panelBookNotesResultTemplate.tmpl"),
            panelBookNotesResultChildTemplate: e("text!templates/panelBookNotesResultChildTemplate.tmpl"),
            panelBookSearchTemplate: e("text!templates/panelBookSearchTemplate.tmpl"),
            readerMainContentTemplate: e("text!templates/readerMainContentTemplate.tmpl"
            ),
            mainCompositeTemplate: e("text!templates/MainCompositeWrapperTemplate.tmpl"),
            mainLoadingContentTemplate: e("text!templates/MainLoadingContentTemplate.tmpl"),
            mainContentTemplate: e("text!templates/MainContentTemplate.tmpl"),
            readerTextTemplate: e("text!templates/readerTextTemplate.tmpl"),
            panelBookSearchCompositeTemplate: e("text!templates/panelBookSearchCompositeTemplate.tmpl"),
            panelBookSearchNoResultTemplate: e("text!templates/panelBookSearchNoResultTemplate.tmpl"),
            panelBookSearchChapterResultTemplate: e("text!templates/panelBookSearchChapterResultTemplate.tmpl"),
            panelBookSearchFrequencyResultTemplate: e("text!templates/panelBookSearchFrequencyResultTemplate.tmpl"),
            panelBookSearchYouMeanResultTemplate: e("text!templates/panelBookSearchYouMeanResultTemplate.tmpl"),
            panelBookSearchChapterResultChildTemplate: e("text!templates/panelBookSearchChapterResultChildTemplate.tmpl"),
            panelBookSearchChapterResultChildSnipTemplate: e("text!templates/panelBookSearchChapterResultChildSnipTemplate.tmpl"),
            readerAcstTemplate
                : e("text!templates/readerAcstTemplate.tmpl"),
            subSectionDeviceSpecificTemplate: e("text!templates/subSectionDeviceSpecificTemplate.tmpl"),
            subSectionErrorInACSTemplate: e("text!templates/subSectionErrorInACSTemplate.tmpl"),
            subSectionNupoConfirmTemplate: e("text!templates/subSectionNupoConfirmTemplate.tmpl"),
            readerSignInTemplate: e("text!templates/readerSignInTemplate.tmpl"),
    ...
    define("layouts/ReaderLayout", ["marionette", "models/ReaderArgs", "templates", "vent"], function(e, t, n, r) {
          return e.Layout.extend({
            template: n.readerSkeltonLayoutTemplate,
            id: "readerLayout",
            initialize: function() {
              this.readrArgs = new t
            },
            regions: {
              toolBarRegion: "#toolBarLayoutRegion",
              sideBarRegion: "#sideBarLayoutRegion",
              panelRegion: "#panelLayoutRegion",
              mainRegion: "#mainLayoutRegion"
            }
          })
        }
    ),
    ...
    define("views/ReaderShareLinkItemView"
        , ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBShareM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerShareLinkTemplate,
            el: "#shareBookLinkWrapper",
            initialize: function(t) {
              var n = _.extend({}, t)
                  , r = "WinOS";
              navigator.appVersion.indexOf("Mac") != -1 && (r = "MacOS"),
                  n.OSName = r;
              var i = new Date
                  , o = DanaMethodAttr("attr", e(DanaGetlocation(location)), "href")
                  , u = o.split("?");
              o = u[0] + "?ppg=" + e("#current-page").val() + "&docID=" + t.docID + "&tm=" + i.getTime(),
                  n.shareURL = o,
                  this.model = new s(n),
            ...
            events: {
              "hidden.bs.modal": "goingToHideMode",
              "keydown #shareBookLink": "lookForCopy"
            },
            onRender: function() {
              navigator.appVersion.indexOf("Mac") == -1 && DanaMethodAttr("attr", this.$el.find("#shareBookLink"), "aria-labelledby", "myShareModalLabel"),
                  this.uAccsMdRR = e("#enableAccessiblity").val() === "no" ? 1 : 0,
              this.uAccsMdRR === 0 && e.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
                    e("#shareUrl").focus(),
                        e("#shareUrl").select()
                  }
                  , 550)),
                  e("#shareBookLink").modal("show").focus()
            },
            ...
            lookForCopy: function(t) {
              var n = t.which;
              t.ctrlKey && n === 67 && (e("#shareUrl").focus(),
                  e("#shareUrl").select())
            },
            doneCopy: function(t) {
              e("#shareUrl").focus(),
    ...
    define("models/TBCopyTextM", ["backbone", "jquery"], function(e, t) {
          return e.Model.extend({
            url: function() {
              var e = 0
                  , n = 5e4
                  , r = t("#current-page").val();
              this.cpTmp.currentSelections.active === !0 && (r = this.cpTmp.currentSelections.active_page,
                  e = this.cpTmp.currentSelections.s_quad,
                  n = this.cpTmp.currentSelections.e_quad);
            ...
            parse: function(e, t) {
              if (typeof e.dcy != "undefined") {
                var n = JSON.parse(this.cpTmp.dec(e.dcy))
                    , r = "WinOS";
                return navigator.appVersion.indexOf("Mac") != -1 && (r = "MacOS"),
                    n.OSName = r,
                    n
              }
              return e
    ...
    define("utils/ebreaderUtil", [], function() {
          ...
          function n(e, t) {
            ...
            while (c-- > 0) {
              ...
              for (var p = 0; p < r; p++)
                u = n[(p + 1) % r],
                    f = (s >>> 5 ^ u << 2) + (u >>> 3 ^ s << 4) ^ (h ^ u) + (t[p & 3 ^ l] ^ s),
                    s = n[p] += f
            }
            return o(n)
          }
          function r(e, t) {
            ...
            while (h != 0) {
              ...
              for (var p = r - 1; p >= 0; p--)
                i = n[p > 0 ? p - 1 : r - 1],
                    f = (i >>> 5 ^ o << 2) + (o >>> 3 ^ i << 4) ^ (h ^ o) + (t[p & 3 ^ l] ^ i),
                    o = n[p] -= f;
              h -= a
            }
            return s(n)
          ...
          function u(e) {
            ...
            for (var r = 0; r < n.length; r++)
              t = e.charAt(r * 9) + e.substr(r * 9 + 2, 7),
                  n[r] = parseInt(t, 16);
            return n
          }
          var e = [];
          return t.prototype = {
            ...
            init: function(t) {
              e = new Array(4),
                  e[0] = parseInt(t.substr(0, 8), 16) & 65535,
                  e[1] = parseInt(t.substr(8, 8), 16) & 65535,
                  e[2] = parseInt(t.substr(16, 8), 16) & 65535,
                  e[3] = parseInt(t.substr(24, 8), 16) & 65535
            },
            enc: function(t) {
              return n(t, e)
            },
            dec: function(t) {
              return t = DanaMethodReplace("replace", t, /^\s+|\s+$/g, ""),
                  r(t, e)
            }
          },
              t
    ...
    define("views/ReaderCopyTextItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBCopyTextM", "utils/ebreaderUtil", "i18next"], function(e, t, n, r, i, s, o, u) {
          return t.ItemView.extend({
            template: n.readerCopyTextTemplate,
            el: "#copyTextWrapper",
            initialize: function(e) {
              this.ck = i.readCookie("ESESSIONID");
              if (this.ck !== null ) {
                this.pebr = new o,
                    this.pebr.init(this.ck);
                var t = _.extend({}, this.pebr, {
                  ck: this.ck
                }, e);
                this.model = new s(t),
                    this.model.bind("sync", this.render, this),
            ...
            onRender: function() {
              e.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
                    e("#copyContent").focus(),
                        e("#copyContent").select()
                  }
                  , 550)),
                  r.trigger("resetPgSel", !0, !0),
                  r.trigger("clsPgSel", this.model.get("pageNum"), !0),
                  e("#copyModal").modal("show");
              if (!_.isUndefined(this.model.get("status-code")) && this.model.get("status-code") !== 1) {
                var t = parseInt(this.model.get("remainingCopy")) || 0;
                e("#remainingCopy").length > 0 && e("#remainingCopy").empty().text(t),
                typeof this.model.get("DocUser") != "undefined" && (this.model.get("DocUser").remainingCopyCount = t),
                t <= 0 && (DanaMethodAttr("attr", e("#toolCopy"), "disabled", "disabled").prop("title", u.t("rr_remaining_copy_allowance")),
                    DanaMethodAttr("attr", e("#contextMenuPop> #contextCopy"), "disabled", "disabled").prop("title", u.t("rr_remaining_copy_allowance")))
              }
            },
            templateHelpers: {
              something: function() {
    ...
    define("views/ReaderPrintItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerSideBarTemplate,
            id: "firstPrintWrapper",
            defaults: {
              tbPrintName: "firstprintDefaultWrapper"
            },
            initialize: function(e) {
              var t = _.extend({}, e);
              this.model = new s(t),
            ...
            events: {
              "hidden.bs.modal": "goingToHideMode",
              "keypress #shareBookLink": "lookForCopy"
            },
            onRender: function() {
              e.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
                    e("#shareUrl"
            ...
            lookForCopy: function(t) {
              var n = t.which;
              t.ctrlKey && n === 99 && (e("#shareUrl").focus(),
                  e("#shareUrl").select())
            },
            doneCopy: function(t) {
              e("#shareUrl").focus(),
    ...
    define("views/MainLoadingItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent"], function(e, t, n, r, i, s) {
          return e.ItemView.extend({
            template: n.mainLoadingContentTemplate,
            initialize: function(e) {}
          })
        }
    ),
    define("views/ReaderPrintRadioItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM", "i18next"], function(e, t, n, r, i, s, o) {
          return t.ItemView.extend({
            template: n.readerPrintRadioTemplate,
            id: "radioPrint",
            defaults: {
              tbPrintName: "radioPrint"
            },
            initialize: function(t) {
              ...
              var r = "MLA"
                  , i = "60"
                  , s = "printPage.action?op=alo&docID=" + this.model.collection.gbData
                          .BiblioData.docID;
              e.ajax({
                url: s,
                async: !1,
                success: function(e) {
                  e.status === "SUCCESS" && (r = e.citationFormat,
                      i = e.printAllowance)
                }
              }),
                  this.citation = r,
                  this.alo = i,
                  this.usChpt = this.model.collection.gbData.DocUser.usChpt
            },
            onRender: function() {
              this.$el.find("#printPageAllowance").html(this.alo),
                  DanaMethodAttr("attr", this.$el.find("#citationStyle [value=" + this.citation + "]"), "selected", "selected"),
              this.usChpt === 1 && this.$el.find("input:radio[name=optionsRadios]").filter('[value="chapter"]').prop("checked", !0)
            },
            events: {
              "click #printCancel": "actionPrintCancle",
              "click #printContinue": "actionPrintContinue",
              "click #startPage,#endPage": "actionPrintRadio"
            },
            actionPrintCancle: function(e) {
              e.preventDefault()
            },
            actionPrintContinue: function(t) {
              t.preventDefault(),
                  e(".text-danger").empty(),
                  this.model.collection.gbData.pnt = {},
                  this.model.collection.gbData.pnt.docID = this.model.collection.gbData.BiblioData.docID;
              var n = e("input:radio[name=optionsRadios]:checked").val();
              this.model.collection.gbData.pnt.rds = n,
                  n === "range" ? (this.model.collection
                      .gbData.pnt.st = e("#startPage").val(),
                      this.model.collection.gbData.pnt.ed = e("#endPage").val()) : (this.model.collection.gbData.pnt.st = e("#current-page").val(),
                      this.model.collection.gbData.pnt.ed = this.model.collection.gbData.pnt.st),
                  this.model.collection.gbData.pnt.ct = e("#citationStyle").find(":selected").val();
              var i = 0
                  , s = 0
                  , u = 0
                  , a = 0
                  ...
                  , l = 0
                  , c = {}
                  , h = "printPage.action?ct=" + this.model.collection.gbData.pnt.ct + "&op=validate&rds=" + this.model.collection.gbData.pnt.rds + "&docID=" + this.model.collection.gbData.pnt.docID + "&st=" + this.model.collection.gbData.pnt.st + "&ed=" + this.model.collection.gbData.pnt.ed;
              e.ajax({
                url: h,
                async: !1,
                success: function(t) {
                ...
                error: function(t, n, r) {
                  ...
                  i.empty().html(o.t("rr_please_refresh_page")),
                      e("#printPageAllowance").hide()
                }
              }),
                  i > 0 ? (this.model.collection.gbData.pnt.pst = i,
                      this.model.collection.gbData.pnt.ped = s,
                      this.model.collection.gbData.pnt.lst = u,
                      this.model.collection.gbData.pnt.led = a,
                      this.model.collection.gbData.pnt.rpnt = l,
                      r.trigger("openSCN", "createPrint", this.model.collection.gbData)) : f > 0 && (this.model.collection.gbData.pnt.multipleRangeSelection = c,
                      r.trigger("openSCN", "errorPrint"
    ...
    define("views/ReaderPrintSelectionItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerPrintSelectionTemplate,
            id: "selectionPrint",
            defaults: {
              tbPrintName: "selectionPrint"
            },
            initialize: function(e) {
            ...
            events: {
              "click #selectionPrintPreview": "actionPrintPreview"
            },
            onRender: function() {},
            ...
            actionPrintPreview: function(t) {
              ...
              if (typeof n != "undefined") {
                var i = parseInt(n.split("_")[1])
                    , s = this;
                e.each(this.model.get("pnt").multipleRangeSelection, function(e, t) {
                      e === i && (s.model.collection.gbData.pnt.st = t.startPhyPage,
                          s.model.collection.gbData.pnt.ed = t.endPhyPage,
                          s.model.collection.gbData.pnt.pst = t.startPhyPage,
                          s.model
                              .collection.gbData.pnt.ped = t.endPhyPage,
                          s.model.collection.gbData.pnt.lst = t.startLgPage,
                          s.model.collection.gbData.pnt.led = t.endLgPage,
                          r.trigger("openSCN", "previewPrint", s.model.collection.gbData))
                    }
                )
              }
            }
    ...
    define("views/ReaderPrintPreviewItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerPrintPreviewTemplate,
            id: "previewPrint",
            defaults: {
              tbPrintName: "previewPrint"
            },
            initialize: function(e) {
              var t = _.extend({}, e.model.collection.gbData, this.model.attributes);
              this.model.attributes = t
            ...
            events: {
              "click #printCancel": "actionPrintCancle",
              "click #printCreate": "actionPrintContinue",
              "click #printStartOver": "actionPrintStartOver"
            },
            actionPrintCancle: function(e) {
              e.preventDefault()
            },
            actionPrintContinue: function(e) {
              e.preventDefault(),
                  r.trigger("openSCN", "createPrint")
            },
            actionPrintStartOver: function(e) {
              e.preventDefault(),
                  r.trigger("openSCN", "radioPrint")
            }
          })
        }
    ),
    define("views/ReaderPrintCreateItemView"
        , ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerPrintCreateTemplate,
            id: "createPrint",
            defaults: {
              tbPrintName: "createPrint"
            },
            initialize: function(e) {},
            onRender: function() {
              e.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
    ...
    define("views/ReaderPrintOpenItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM", "i18next"], function(e, t, n, r, i, s, o) {
          return t.ItemView.extend({
            template: n.readerPrintOpenTemplate,
            id: "#openPrint",
            defaults: {
              tbPrintName: "openPrint"
            },
            initialize: function(e) {
              var t = _.extend({}, e.model.collection.gbData, this.model.attributes);
              this.model.attributes = t
            ...
            events: {
              "click #printOpenPDF": "openLinkPDF"
            },
            onRender: function() {},
            openLinkPDF: function(t) {
              var n = parseInt(this.model.collection.gbData.pnt.rpnt) || 0;
              e("#remainingPrint").length > 0 && e("#remainingPrint").empty().text(n),
              typeof this.model.get("DocUser") != "undefined" &&
              (this.model.get("DocUser").remainingPrintCount = n),
              n <= 0 && (DanaMethodAttr("attr", e("#toolChapterDownload"), "disabled", "disabled").prop("title", o.t("rr_remaining_print_allowance")),
                  DanaMethodAttr("attr", e("#toolPrint"), "disabled", "disabled").prop("title", o.t("rr_remaining_print_allowance")));
              var r = new Date
                  , i = "printPage.action?op=toPDF&ct=" + this.model.collection.gbData.pnt.ct + "&rds=" + this.model.collection.gbData.pnt.rds + "&docID=" + this.model.collection.gbData.pnt.docID + "&st=" + this.model.collection.gbData.pnt.pst + "&ed=" + this.model.collection.gbData.pnt.ped + "&dt=" + r.getTime();
              e('<a id="tmpLink" href=' + i + " />").appendTo("#toolbar"),
                  e("#tmpLink")[0].click(),
                  e("#tmpLink").remove()
            }
          })
    ...
    define("views/ReaderPrintErrorItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerPrintErrorTemplate,
            id: "#errorPrint",
            defaults: {
              tbPrintName: "errorPrint"
            },
            initialize: function(e) {},
            events: {
              "click #printStartOver": "actionPrintStartOver"
    ...
    define("views/DummyItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBPrintM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.dummyTemplate,
            el: "#dummyPrintWrapper",
            defaults: {
              tbPrintName: "radioPrint"
            },
            initialize: function(e) {},
    ...
    define("collections/ReaderPrintCollection", ["backbone", "jquery", "models/ReaderPM", "utils/ebreaderUtil", "utils/commonUtil", "vent"], function(e, t, n, r, i, s) {
          return e.Collection.extend({
            ...
            prepareData: function() {
              DanaMethodAdd("add", this, {
                tbPrintNameTest: "gold",
                tbPrintName: "radioPrint"
              }, {
                add: !0,
                remove: !0,
    ...
    define("views/ReaderPrintCollecionView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "utils/ebreaderUtil", "views/MainLoadingItemView", "views/ReaderPrintItemView", "views/ReaderPrintRadioItemView", "views/ReaderPrintSelectionItemView", "views/ReaderPrintPreviewItemView", "views/ReaderPrintCreateItemView", "views/ReaderPrintOpenItemView", "views/ReaderPrintErrorItemView", "views/DummyItemView", "collections/ReaderPrintCollection"], function(e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v) {
          return t.CompositeView.extend({
            template: n.readerPrintMainWrapperTemplate,
            el: "#printMainWrapper",
            itemViewContainer: "#printDefaultWrapper",
            itemView: u,
            emptyView: o,
            initialize: function(e) {
              r.on("openSCN", this.openNewSCN, this),
                  this.render(),
                  this.collection = new v(null ,e)
            },
            getItemView: function(e) {
    ...
    define("views/ReaderAcsItemView", ["jquery", "marionette", "templates", "vent", "i18next", "utils/commonUtil", "models/TBACSM", "utils/ebreaderUtil"], function(e, t, n, r, i, s, o, u) {
          return t.ItemView.extend({
            template: n.readerAcstTemplate,
            el: "#fullDownloadWrapper",
            initialize: function(t) {
              this.prevSelectedDevice = null ,
                  this.getDownloadAccess,
                  this.getDeviceFormFactor,
                  this.cookieKey = "DOWNLOAD_DEVICE",
                  this.radioDeviceType = 1,
                  this.uAccsMdRR = e("#enableAccessiblity").val() === "no" ? 1 : 0;
              var n = _.extend({}, t, {
                tmpCkName: s.readCookie(this.cookieKey)
              });
              this.model = new o(n),
                  this.model.on("change", this.render, this),
                  this.model.fetch(),
                  this.acsDownloadLink = "acsDownload.action?docID=" + this.model
                          .get("DocUser").docID
            },
            events: {
              "click .devices-list li .device-icon, .devices-list li .device-type": "modalDeviceTypeSelected",
              "keypress .devices-list li .device-icon, .devices-list li .device-type": "modalDeviceTypeSelectedkp",
              ...
              "click #continueButton": "modalDeviceTypeSubmit",
              "click .wizard-box": "stepSelected",
              "click #doneInstallStep": "modalInstallStepDoneProceed",
              "click #getReaderButton": "modalInstallStepLinkProceed",
              "click #downloadBookButton": "modalDownloadButton",
              "click #modalAlertContinueButton, #modalAlertCancel, #alertModalDismiss": "modalAlertDownloadButton",
              "hidden.bs.modal #downloadModal": "modalCloseOnHide",
              "click #modalAlertFirstContinueButton": "modalAlertFistDownloadButton"
            },
            onRender: function() {
              if (this.model.get("status") === "no_login")
                this.model.get("DocUser").signedIn = !1,
                    r.trigger("tbsgn", "q_download");
              else {
                typeof this.model.
                    get("DocUser").alreadyNupo == "undefined" && this.model.get("status") === "nupo_confirm" && this.$el.find("#downloadModalSteps").hide(),
                    e("#downloadModal").modal("show");
                if (this.uAccsMdRR > 0) {
                  DanaMethodAttr("attr", this.$el.find("#deviceStep"), "tabindex", "-1"),
                      DanaMethodAttr("attr", this.$el.find("#installStep"), "tabindex", "-1"),
                      DanaMethodAttr("attr", this.$el.find("#downloadStep"), "tabindex", "-1"),
                      this.$el.find("#deviceStep .modal-title.collapsed").remove(),
                      this.$el.find("#deviceStep .change-button.on-attempted").remove(),
                      this.$el.find("#installStep .modal-title.collapsed").remove(),
                      this.$el.find("#installStep .change-button.on-attempted").remove(),
                      this.$el.find("#downloadStep .modal-title.collapsed").remove(),
                      this.$el.find("#downloadStep .change-button.on-attempted").remove();
                  var t = DanaMethodAttr("attr", this.$el.find("#downloadModal .active"), "id");
                  t === "deviceStep" ? (DanaMethodAttr("attr", this.$el.find("#deviceStep").find(".devices-list"), {
                    tabindex: "0",
                    role: "list"
                  }),
                      DanaMethodAttr("attr", this.$el.find("#deviceStep").find(".device-type"), {
                        tabindex: "0",
                        role: "button"
                      }),
                      DanaMethodAttr("attr", this.$el.find("#deviceStep")
                          , {
                            "aria-hidden": "false"
                          }).removeAttr("hidden"),
                      DanaMethodAttr("attr", this.$el.find("#installStep"), {
                        "aria-hidden": "true",
                        hidden: "hidden"
                      }),
                      DanaMethodAttr("attr", this.$el.find("#downloadStep"), {
                        "aria-hidden": "true",
                        hidden: "hidden"
                      })) : t === "installStep" ? (DanaMethodAttr("attr", this.$el.find("#deviceStep"), {
                    "aria-hidden": "true",
                    hidden: "hidden"
                  }),
                      DanaMethodAttr("attr", this.$el.find("#installStep"), {
                      ...
                      DanaMethodAttr("attr", this.$el.find("#downloadStep"), {
                        "aria-hidden": "true",
                        hidden: "hidden"
                      })) : t === "downloadStep" && (DanaMethodAttr("attr", this.$el.find("#deviceStep"), {
                    "aria-hidden": "true",
                    hidden: "hidden"
                  }),
                      DanaMethodAttr("attr", this.$el.find("#installStep"), {
            ...
            modalDeviceTypeSelectedkp: function(t) {
              ...
              if (n == "click" || n == "keypress" && (t.which == 13 || t.which == 32)) {
                ...
                this.prevSelectedDevice = DanaMethodAttr("attr", r, "id"),
                    r.addClass("device-selected"
                    ).siblings("li").removeClass("device-selected"),
                    e("#installStep").removeClass("active").removeClass("attempted"),
                    e("#downloadStep").removeClass("active").removeClass("attempted")
              }
            },
            modalRadioDeviceTypeToggle: function(t) {
              ...
              if (n.length === 0)
                return;
              e("span.pretty-radio").removeClass("checked"),
                  n.addClass("checked")
            },
            ...
            modalDeviceTypeSubmit: function(t) {
              t.preventDefault();
              var n = e(t.target);
              this.radioDeviceType = e(".pretty-radio.checked").siblings("input").val(),
                  this.goToStep("installStep")
            },
            collapseWizardBox: function() {
              e(".modal-content.active").addClass("attempted"),
                  e(".modal-content").removeClass("active")
            },
            expandWizardBox: function(t) {
              e("#" + t).addClass("active"),
              this.uAccsMdRR > 0 && (t === "deviceStep" ? (DanaMethodAttr("attr", this.$el.find("#deviceStep"), {
                "aria-hidden": "false"
              }).removeAttr("hidden"),
                  DanaMethodAttr("attr", this.$el.find("#installStep"), {
                    "aria-hidden": "true",
                ...
                hidden: "hidden"
                  ...
                  this.$el.find("#deviceStep").remove()) : t === "downloadStep" && (DanaMethodAttr("attr", this.$el.find("#deviceStep"), {
                "aria-hidden": "true",
                hidden: "hidden"
              }),
                  DanaMethodAttr("attr", this.$el.find("#installStep"), {
                  ...
                  this.$el.find("#installStep").remove()))
            },
            goToStep: function(t) {
              this.collapseWizardBox();
              if (t === "deviceStep")
                this.expandWizardBox(t),
                    e("#deviceStep").focus();
              else if (
                  t === "installStep") {
                this.prevSelectedDevice = this.prevSelectedDevice || DanaMethodAttr("attr", e("li.device-selected"), "id") || "desktopDevice",
                    this.radioDeviceType = e(".pretty-radio.checked").siblings("input").val();
                var r = this.prevSelectedDevice
                    , s = r === "iosDevice" || r === "androidDevice" ? "Bluefire Reader" : "Adobe Digital Editions"
                    , o = this.radioDeviceType
                    , u = o === "1" && r !== "otherDevice" ? "orange " : ""
                    , a = function() {
                      var e = "";
                      return r === "otherDevice" ? (e = i.t("rr_cancel"),
                          e) : (e += o === "1" ? i.t("rr_get") : i.t("rr_i_have"),
                          e += s,
                          e)
                    }
                    ()
                    ...
                    , l = _.template(n.subSectionDeviceSpecificTemplate, f);
                e("#installStep > .wizard-content").empty().html(l),
                    e("#installStep").focus(),
                    this.expandWizardBox(t)
              } else
                t === "downloadStep" ? (this.expandWizardBox(t),
                    e("#downloadStep").focus()) : this.expandWizardBox("deviceStep")
            },
            stepSelected: function(t) {
              ...
              if (
                ...
                return;
              !n.hasClass("active") && n.hasClass("attempted") ? this.goToStep(r) : (n = n.parents(".modal-content"),
                  r = DanaMethodAttr("attr", n, "id"),
              !n.hasClass("active") && n.hasClass("attempted") && this.goToStep(r))
            },
            modalInstallStepDoneProceed: function(e) {
              e.preventDefault(),
                  this.goToStep("downloadStep")
            },
            ...
            modalAlertFistDownloadButton: function(t) {
              typeof this.model.get("DocUser").alreadyNupo == "undefined" && (this.isNupoNow = "yes",
                  this.model.get("DocUser").alreadyNupo = "nupo_confirm",
                  e("#downloadNupoStep").remove(),
                  e("#downloadModalSteps").show())
            },
            ...
            modalDownloadButton: function(t) {
              ...
              if (o === "has_access" || typeof this.model.get("DocUser").alreadyNupo != "undefined" && this.model.get("DocUser").alreadyNupo === o) {
                this.prevSelectedDevice = this.prevSelectedDevice || DanaMethodAttr("attr", e("li.device-selected"), "id") || "desktopDevice",
                    this.radioDeviceType = this.radioDeviceType || e(".pretty-radio.checked").siblings("input").val();
                var u = this.prevSelectedDevice.split("Device")[0] + "-" + this.radioDeviceType;
                return s.setCookie(this.cookieKey, u, 5184e6),
                    this.closeModal(),
                    !0
              }
              if (o === "no_login")
                ...
                var a = _.template(n.subSectionNupoConfirmTemplate, {
                  DocUser: this.model.get("DocUser"),
                  _t: i.t
                });
                e("#downloadModal").removeClass("modal-wizard download-modal-wizard").empty().html(a)
              } else {
                var a = _.template(n.subSectionErrorInACSTemplate, {
                  status: "Error:" + o,
                  _t: i.t
                });
    ...
    define("views/ReaderSignInItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/ReaderSCheckM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerSignInTemplate,
            el: "#userSignInWrapper",
            defaults: {
              isUsrSigIn: "none"
            },
            initialize: function(e) {
            ...
            events: {
              "hidden.bs.modal #signInModal": "modalDone"
            },
            modalDone: function(e) {
              this.onClose()
            },
            onClose: function(t) {
              e("#signInModal"
              ).modal("hide"),
                  e.data(this, "sgnModelTimer", DanaFuncSetTimeout(setTimeout, function() {
                        e("#signInModal").unbind(),
                            e("#signInModal").remove()
                      }
                      , 550))
            }
          })
    ...
    define("views/ReaderCiteItemView", ["jquery", "marionette", "templates", "vent", "utils/commonUtil", "models/TBCiteM"], function(e, t, n, r, i, s) {
          return t.ItemView.extend({
            template: n.readerCiteTemplate,
            el: "#firstCitetWrapper",
            defaults: {
              tbCiteName: "firstCiteDefaultWrapper"
            },
            initialize: function(e) {
              this.citeData;
              var t = _.extend({}, e);
            ...
            events: {
              "hidden.bs.modal #citeModal": "modalCloseOnHide",
              "change #cite-format": "citeFormatSel",
              "click #citationRefWorks": "citationRefWorksSel",
              "click #citationEndNoteCitavi": "citationEndNoteCitaviSel"
            },
            onRender: function() {
              ...
              e.each(this.model.get("DocumentCitations"), function(r, i) {
                    n.citeData[i.citationName] = i,
                        i.citationName === "CTNB" || i.citationName === "CTAD" ? t.append(e("<option>", {
                          value: i.citationName,
                          text: i.citationDesc,
                    ...
                    i.isSelected && n.$el.find("#citation-content").empty().text(i.citationFormatted)
                  }
              ),
              navigator.appVersion.indexOf("Mac") == -1 && DanaMethodAttr("attr", this.$el.find("#citeModal"), "aria-labelledby", "myModalLabelCiteModal"),
                  this.$el.find("#citeModal").modal("show"),
                  this.uAccsMdRR = e("#enableAccessiblity").val() === "no" ? 1 : 0,
              this.uAccsMdRR === 0 && e.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
                    e("#citation-content").focus(),
                        e("#citation-content").select()
                  }
                  , 550))
            },
            ...
            exportToRefworks: function() {
              var t = e("body")
                  , n = this.model.get("DocUser").docID
                  , r = this.model.get("ppg") || 1;
              return e.ajax({
                url: "biblioExport.action?refworks=1&docID=" + n + "&ppg=" + r,
                async: !1,
                success: function(n) {
                  var r = e("<form>", {
                        name: "ExportRWForm",
                  ...
                  r.append(i).appendTo(t),
                      r.hide(),
                      DanaMethodSubmit("submit", r),
                      r.remove()
                }
              }),
                  !1
    ...
    define("views/ReaderToolBarItemView", ["jquery", "marionette", "templates", "i18next", "vent", "utils/commonUtil", "views/ReaderShareLinkItemView", "views/ReaderCopyTextItemView", "views/ReaderPrintItemView"
          ...
          return t.ItemView.extend({
            template: n.readerToolBarTemplate,
            id: "toolbar",
            initialize: function(e) {
              if (e.hasAc === 1)
                this.gbData = e;
                ...
                return;
              i.on("atbs", this.toolAddToBookshelf, this),
                  i.on("sblnk", this.toolLink, this),
                  i.on("cpgt", this.toolCopy, this),
                  i.on("tbdl", this.toolDownload, this),
                  i.on("tbshct", this.toolCite, this),
                  i.on("tbsgn", this.usrSignIn, this),
                  i.on("tbgbsgn", this.usrGSignIn, this)
            },
            ui: {
              toolZoomSmaller: "#tool-viewsmaller",
              toolZoomLarger: "#tool-viewlarger",
              toolBarCurrentPage: "#current-page",
              toolCurrentPageLocation: "#tool-current-page-loc",
              toolGoToPage: "#tool-pagegoto-text",
              toolPageLocationWrap: "#tool-pageloc",
              toolPageGoToWrap: "#tool-pagegoto",
              toolHighlight: "#toolHighlight",
              toolNote: "#toolNote",
              toolBookmark: "#toolBookmark",
              toolCite: "#toolCite",
              toolDownload: "#toolDownload",
              toolCopy: "#toolCopy",
              toolPrint
                  : "#toolPrint",
              toolAddToBookshelf: "#toolAddToBookshelf",
              toolLink: "#toolLink"
            },
            events: {
              "click #tool-viewsmaller": "toolZoomOut",
              "click #tool-viewlarger": "toolZoomIn",
              "click #tool-fitToWidth": "reSizeEffectWidth",
              "click #tool-fitToHeight": "reSizeEffectHeight",
              "click #tool-pageloc": "togglePageNumberModeToGoTo",
              "keypress #tool-pagegoto-text": "togglePageNumberModeToView",
              "click #tool-pager-prev": "prevPage",
              "click #tool-pager-next": "nextPage",
              "click #toolHighlight": "toolHighlight",
              "click #toolNote": "toolNote",
              "click #toolBookmark": "toolBookmark",
              "click #toolCite": "toolCite",
              "click #toolDownload": "toolDownload",
              "click #toolCopy": "toolCopy",
              "click #toolChapterDownload": "toolPrint",
              "click #toolPrint": "toolPrint",
              "click #toolAddToBookshelf": "toolAddToBookshelf",
              "click #toolLink": "toolLink"
            },
            onRender: function() {
              typeof this.gbData != "undefined" && this.gbData.hasAc === 1 && (this.$el.find("#current-page").val(this.gbData.ppg),
                  this.$el.find(".total-number-of-pages").empty().html(r.t("rr_page_of") + this.gbData.
                          tmpLpg[this.gbData.tmpLpg.length - 1])),
                  this.$el.find("#tool-pagegoto").hide(),
              _.isUndefined(this.gbData) || (this.gbData.ppg <= 1 && this.$el.find("#tool-pager-prev").prop("disabled", !0),
              this.gbData.ppg > 1 && this.$el.find("#tool-pager-prev").removeProp("disabled"),
              this.gbData.tmpLpg.length >= 2 && this.$el.find("#tool-pager-next").removeProp("disabled"),
              this.gbData.ppg >= this.gbData.tmpLpg.length && this.$el.find("#tool-pager-next").prop("disabled", !0))
            },
            toolZoomOut: function(e) {
              var t = this.gbData.zm;
              t <= .5 ? (this.gbData.zm = .5,
                  this.ui.toolZoomLarger.removeProp("disabled"),
                  this.ui.toolZoomSmaller.prop("disabled", !0)) : t > 4 ? (this.gbData.zm = 4,
                  this.ui.toolZoomLarger.prop("disabled", !0)) : t > 2 && t <= 4 ? (this.gbData.zm = 2,
                  this.ui.toolZoomLarger.removeProp("disabled")) : t > 1 && t <= 2 ? this.gbData.zm = 1 : t > .5 && t <= 1 ? (this.gbData.zm = .5,
                  this.ui.toolZoomSmaller.prop("disabled", !0)) : t < .5 && (this.gbData.zm = .5,
                  this.ui.toolZoomSmaller.removeProp("disabled"),
                  this.ui.toolZoomLarger.prop("disabled", !0)),
                  i.trigger("rspzl", parseInt(this.ui.toolBarCurrentPage
                      .val())),
                  this.gbData.whatClicked = "zoomOut",
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_ZoomOut", "ZoomOut from Reader")
            },
            toolZoomIn: function(e) {
              var t = this.gbData.zm;
              t >= 4 ? (this.gbData.zm = 4,
                  this.ui.toolZoomLarger.prop("disabled", !0),
                  this.ui.toolZoomSmaller.removeProp("disabled")) : t >= 2 && t < 4 ? (this.gbData.zm = 4,
                  this.ui.toolZoomLarger.prop("disabled", !0),
                  this.ui.toolZoomSmaller.removeProp("disabled")) : t >= 1 && t < 2 ? this.gbData.zm = 2 : t >= .5 && t < 1 ? (this.gbData.zm = 1,
                  this.ui.toolZoomSmaller.removeProp("disabled")) : t < .5 && (this.gbData.zm = .5,
                  this.ui.toolZoomSmaller.prop("disabled", !0),
                  this.ui.toolZoomLarger.removeProp("disabled")),
                  i.trigger("rspzl", parseInt(this.ui.toolBarCurrentPage.val())),
                  this.gbData.whatClicked = "zoomIn",
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_ZoomIn", "ZoomIn from Reader")
            },
            reSizeEffectWidth: function(e) {
              this.ui.toolZoomSmaller.removeProp("disabled", !0),
                  this.ui.toolZoomLarger.removeProp("disabled", !0),
                  i.trigger("rspwd", parseInt(this.ui.toolBarCurrentPage.val())),
                  e.preventDefault(),
                  this.gbData.whatClicked = "fitWidth",
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_Fit_Width", "Fit to Width from Reader")
            },
            reSizeEffectHeight: function(e) {
              this.ui.toolZoomSmaller.removeProp("disabled", !0),
                  this.ui.toolZoomLarger.removeProp("disabled", !0),
                  i.trigger("rspht", parseInt(this.ui.toolBarCurrentPage.val())),
                  e.preventDefault(),
                  this.gbData.whatClicked = "fitHeight",
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_Fit_Height", "Fit to Height from Reader")
            },
            togglePageNumberModeToGoTo: function() {
              this.ui.toolPageLocationWrap.hide(),
                  this.ui.toolPageGoToWrap.show(),
                  this.ui.toolGoToPage.val(""),
                  this.ui.toolGoToPage.focus(),
                  this.gbData.whatClicked = "goToPage"
            },
            togglePageNumberModeToView: function(t) {
              var n = t.which;
              if (n === null  || n === 0 || n === 8 || n === 9 || n === 27)
                return ( !0) ;
              var o = new RegExp("^[a-zA-Z0-9]+$")
                  , u = String.fromCharCode(t.charCode ? t.charCode : t.which);
              if (o.test(u))
                return ( !0) ;
              ...
              if (!(n === 13 && a.length > 0))
                return t.preventDefault(),
                    !1;
              this.ui.toolPageLocationWrap.show(),
                  this.ui.toolPageGoToWrap
                      .hide(),
              e("#toolbar-navbar-collapse").hasClass("in") && DanaFuncSetTimeout(setTimeout, function() {
              ...
              if (f == -1) {
                ...
                this.ui.toolBarCurrentPage.val(f + 1),
                    this.ui.toolCurrentPageLocation.empty().html(this.gbData.tmpLpg[f]),
                    this.jumpToPage();
              i.trigger("gaTk", "pageview", "/NR_PageJump", "Jump to page number using page number box in NewReader"),
                  this.gbData.whatClicked = "goToPageView",
                  t.preventDefault()
            },
            prevPage: function() {
              ...
              typeof t != "undefined" && (this.ui.toolBarCurrentPage.val(e),
                  this.ui.toolCurrentPageLocation.empty().html(t),
                  this.jumpToPage()),
                  this.gbData.whatClicked = "prevPage",
                  i.trigger("gaTk", "pageview", "/NR_PagePrev", "Page flip to previous page in NewReader")
            },
            nextPage: function() {
              var e = parseInt
              ...
              typeof t != "undefined" && (this.ui.toolBarCurrentPage.val(e),
                  this.ui.toolCurrentPageLocation.empty().html(t),
                  this.jumpToPage()),
                  this.gbData.whatClicked = "nxtPage",
                  i.trigger("gaTk", "pageview", "/NR_PageNext", "Page flip to next page in NewReader")
            },
            jumpToPage: function() {
              i.trigger("jtp", parseInt(this.ui.toolBarCurrentPage.val())),
                  this.gbData.whatClicked = "jumpPage"
            },
            toolHighlight: function() {
              if (!_.isUndefined(this.gbData) && !e.isEmptyObject(this.gbData.BiblioData)) {
                ...
                i.trigger("tCH", parseInt(this.ui.toolBarCurrentPage.val())),
                    this.gbData.whatClicked = "toolHigh",
                    i.trigger("gaTk", "event", "Reader_Feature", "R1_HIGHLIGHT", "Highlight from Reader")
              }
            },
            toolNote: function() {
              if (!_.isUndefined(this.gbData) && !e.isEmptyObject(this.gbData.BiblioData)) {
                ...
                i.trigger("tCPN"
                    , parseInt(this.ui.toolBarCurrentPage.val())),
                    this.gbData.whatClicked = "toolNote",
                    i.trigger("gaTk", "event", "Reader_Feature", "R1_NOTE_PAGE", "Add Page Note from Reader")
              }
            },
            toolBookmark: function() {
              if (!_.isUndefined(this.gbData) && !e.isEmptyObject(this.gbData.BiblioData)) {
                ...
                i.trigger("tBM", parseInt(this.ui.toolBarCurrentPage.val())),
                    this.gbData.whatClicked = "toolBookMark",
                    i.trigger("gaTk", "event", "Reader_Feature", "R1_BOOKMARK", "Bookmark from Reader")
              }
            },
            toolCite: function() {
              typeof this.gbData != "undefined" && !e.isEmptyObject(this.gbData.BiblioData) && (e("#firstCitetWrapper").length === 0 && e('<div id="firstCitetWrapper"></div>').appendTo("#emptyTmpWrapper"),
                  this.citeLink = new p({
                    ppg: e("#current-page").val(),
                    DocUser: this.gbData.DocUser
                  }),
                  this.gbData.whatClicked = "toolCite",
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_CITE", "Cite from Reader"))
            },
            toolDownload: function() {
              if (typeof this.gbData != "undefined" && !e.isEmptyObject(this.gbData.BiblioData
                ...
                e("#fullDownloadWrapper").length === 0 && e('<div id="fullDownloadWrapper"></div>').appendTo("#emptyTmpWrapper"),
                    this.downloadLink = new l({
                      DocUser: this.gbData.DocUser,
                      BiblioData: this.gbData.BiblioData
                    }),
                    i.trigger("gaTk", "event", "Reader_Feature", "R1_DOWNLOAD", "Download from Reader Tool bar"),
                    this.gbData.whatClicked = "toolDown"
              }
            },
            toolCopy: function() {
              typeof this.gbData != "undefined" && !e.isEmptyObject(this.gbData.BiblioData) && (e("#copyTextWrapper").length === 0 && e('<div id="copyTextWrapper"></div>').appendTo("#emptyTmpWrapper"),
                  this.shareLink = new u({
                    currentSelections: this.gbData.finalSelections,
                    encID: this.gbData.encID,
                    DocUser: this.gbData.DocUser
                  }),
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_COPY_PAGE", "Copy page from Reader"),
                  this.gbData.whatClicked = "toolCopy")
            },
            toolPrint: function(t) {
              typeof this.gbData != "undefined" && !e.isEmptyObject(this.gbData.BiblioData) && (e("#printMainWrapper").length === 0 && e('<div id="printMainWrapper"></div>'
                  ...
                  this.gbData.DocUser.usChpt = DanaMethodAttr("attr", e(t.target), "id") === "toolPrint" ? 0 : 1,
                  this.printLink = typeof this.printLink != "undefined" ? this.printLink : new f({
                    BiblioData: this.gbData.BiblioData,
                    DocUser: this.gbData.DocUser
                  }),
                  i.trigger("openSCN", "radioPrint"),
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_PRINT", "Print or Chapter Download from Reader"),
                  this.gbData.whatClicked = "toolPrint")
            },
                    ...
                    if (typeof t.status != "undefined" && typeof t.errorCode == "undefined") {
                      if (t["status-code"] === 0 || t["status-code"] === 9515)
                        DanaMethodAttr("attr", e("#toolAddToBookshelf").
                            removeClass("icon-bookshelf-add").addClass("bookshelf-added icon-bookshelf-added"), "disabled", "disabled"),
                            DanaMethodAttr("attr", e("#bookDetailBookShelf"), "disabled", "disabled"),
                            e("#bookDetailBookShelf > .icon-bookshelf-add").removeClass("icon-bookshelf-add").addClass("icon-bookshelf-added");
                      var s = e("#dialog-success-msg");
                      s.find("#sMsg").empty().html(t["status-message"]),
                          s.show().fadeOut(5e3),
                      n > 0 && (DanaMethodAttr("attr", s, "tabindex", "-1"),
                          s.focus()),
                          i.trigger("gaTk", "event", "Reader_Feature", "R1_BOOKSHELF_CONFIRM", "Add to Bookshelf  from Reader Completed")
            ...
            toolLink: function() {
              ...
              (e("#shareBookLinkWrapper").length === 0 && e('<div id="shareBookLinkWrapper"></div>').appendTo("#emptyTmpWrapper"),
                  this.shareLink = new o({
                    BiblioData: this.gbData.BiblioData,
                    docID: this.gbData.docID
                  }),
                  this.gbData.whatClicked = "toolLink",
                  i.trigger("gaTk", "event", "Reader_Feature", "R1_SHARE", "Share from Reader"))
            },
            ...
            usrSignIn: function(t) {
              e("#userSignInWrapper").length === 0 && e('<div id="userSignInWrapper"></div>').appendTo("#emptyTmpWrapper"),
                  this.usrSigns = new h({
                    tmpData: t
                  }),
                  i.trigger("gaTk", "event", "NR_Sign_In", "Sign_In_Required", "User SignIn by " + t)
            },
    ...
    define("views/ReaderSideBarItemView", ["marionette", "templates", "vent"], function(e, t, n) {
          return e.ItemView.extend({
            template: t.readerSideBarTemplate,
            id: "sideBar",
            initialize: function(e) {
              this.gbData = e,
                  n.on("openBsh", this.bookSearchSample, this),
                  n.on("openBrp", this.bookResourcesSample, this
                  )
            },
            events: {
              "click #bookToc": "bookTocSample",
              "click #bookDetails": "bookDetailsSample",
              "click #bookNotes": "bookNotesSample",
              "click #bookSearch": "bookSearchSample",
              "click #bookResources": "bookResourcesSample"
            },
            onRender: function() {},
            bookTocSample: function(e) {
              ...
              if (t == "click" || t == "keypress" && (e.which == 13 || e.which == 32))
                e.preventDefault(),
                    $(e.currentTarget).find("div").addClass("icon-selected btn-sidebar-selected").parent().siblings().find("div").removeClass("icon-selected btn-sidebar-selected"),
                    n.trigger("openPanel", "bookToc"),
                this.gbData.uAccsMdRR > 0 && $.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
            ...
            bookDetailsSample: function(e) {
              e.preventDefault(),
                  $(e.currentTarget).find("div").addClass("icon-selected btn-sidebar-selected").parent().siblings().find("div").removeClass("icon-selected btn-sidebar-selected"),
                  n.trigger("openPanel", "bookDetails"),
              this.gbData.uAccsMdRR > 0 && $.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
            ...
            bookSearchSample: function(e) {
              _.isObject(e) && e.preventDefault(),
                  $("#bookSearch").find("div").addClass("icon-selected btn-sidebar-selected").parent().siblings().find("div").removeClass("icon-selected btn-sidebar-selected"),
                  n.trigger("openPanel", "bookSearch"),
              this.gbData.uAccsMdRR > 0 && $.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
            ...
            bookResourcesSample: function(e) {
              _.isObject(e) && e.preventDefault(),
                  $("#bookResources").find("div").addClass("icon-selected btn-sidebar-selected").parent().siblings().find("div").removeClass("icon-selected btn-sidebar-selected"
                  ),
                  n.trigger("openPanel", "bookResources"),
              this.gbData.uAccsMdRR > 0 && $.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
    ...
    define("views/PanelBookTocItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "models/DocTocM", "i18next"], function(e, t, n, r, i, s, o, u) {
          return e.ItemView.extend({
            ...
            onRender: function() {
              this.gbData.BiblioData = this.model.get("BiblioData") || {},
                  this.gbData.DocUser = this.model.get("DocUser") || {};
              var e = this.gbData.DocUser;
              this.gbData.uAccsMdRR > 0 ? (t("#tc-list-cont a>span").toggleClass("icon-tc-open icon-tc-close"),
                  t("#toolCopy").remove(),
                  t("#toolPrint").remove(),
                  t("#toolChapterDownload").remove(),
                  t("#toolHighlight").parent().parent().parent().remove(),
                  t("#tool-viewsmaller").parent().parent().remove(),
                  t("#tool-pager-prev").parent().parent().remove(),
                  this.$el.find("#closePanel").parent().remove()) : t("#tc-list-cont li ul").toggle(),
              typeof this.gbData != "undefined" && this.gbData.DocUser.customSearchAvailable === !1 && (DanaMethodAttr("attr", t("#contextMenuPop> #contextCustomSearch"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#bookResources"), "disabled", "disabled").hide()),
              typeof this.gbData != "undefined" && this.gbData.DocUser.customSearchAvailable === !0 && this.gbData.DocUser.customeTextSearchAvailable === !1 &&
              DanaMethodAttr("attr", t("#contextMenuPop> #contextCustomSearch"), "disabled", "disabled").hide(),
              typeof this.gbData != "undefined" && this.gbData.DocUser.alreadyInBookshelf === !0 && (t("#toolAddToBookshelf").removeClass("icon-bookshelf-add").addClass("icon-bookshelf-added"),
                  DanaMethodAttr("attr", t("#toolAddToBookshelf"), "disabled", "disabled")),
              typeof this.gbData != "undefined" && this.gbData.DocUser.channelType === "title_list" && DanaMethodAttr("attr", t("#toolDownload"), "disabled", "disabled").hide(),
              typeof this.gbData != "undefined" && this.gbData.DocUser.availableForDownload === !1 && (t("#toolDownload").prop("title", u.t("rr_fd_not_offered")),
                  DanaMethodAttr("attr", t("#toolDownload"), "disabled", "disabled")),
              typeof this.gbData != "undefined" && this.gbData.DocUser.docAccessType === "PREVIEW_ACCESS" && (DanaMethodAttr("attr", t("#toolCopy"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#toolChapterDownload"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#toolPrint"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#toolDownload"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#contextMenuPop> #contextCopy"), "disabled", "disabled").hide()),
              typeof
                  this.gbData != "undefined" && this.gbData.DocUser.docID > 0 && (!e.unlimitedCopy && e.channelDisabledCopy && !e.unlimitedPrint && e.channelDisabledPrint ? (DanaMethodAttr("attr", t("#toolCopy"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#toolChapterDownload"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#toolPrint"), "disabled", "disabled").hide(),
                  DanaMethodAttr("attr", t("#contextMenuPop> #contextCopy"), "disabled", "disabled").hide()) : (!e.unlimitedCopy && e.publisherDisbaledCopy ? (DanaMethodAttr("attr", t("#toolCopy"), "disabled", "disabled").prop("title", u.t("rr_copy_not_offered")),
                  DanaMethodAttr("attr", t("#contextMenuPop> #contextCopy"), "disabled", "disabled").prop("title", u.t("rr_copy_not_offered"))) : e.unlimitedCopy ? t("#toolCopy").prop("title", u.t("rr_pages_remain_to_copy")) : e.remainingCopyCount <= 0 && (DanaMethodAttr("attr", t("#toolCopy"), "disabled", "disabled").prop("title", u.t("rr_remaining_copy_allowance")),
                  DanaMethodAttr("attr", t("#contextMenuPop> #contextCopy"), "disabled", "disabled").prop("title", u.t("rr_remaining_copy_allowance"))),
                  !e.unlimitedPrint && e.publisherDisbaledPrint ? (DanaMethodAttr("attr", t("#toolChapterDownload"), "disabled", "disabled"
                  ).prop("title", u.t("rr_print_not_offered")),
                      DanaMethodAttr("attr", t("#toolPrint"), "disabled", "disabled").prop("title", u.t("rr_print_not_offered"))) : e.unlimitedPrint ? (t("#toolChapterDownload").prop("title", u.t("rr_pages_remain_to_print")),
                      t("#toolPrint").prop("title", u.t("rr_pages_remain_to_print"))) : e.remainingPrintCount <= 0 && (DanaMethodAttr("attr", t("#toolChapterDownload"), "disabled", "disabled").prop("title", u.t("rr_remaining_print_allowance")),
                      DanaMethodAttr("attr", t("#toolPrint"), "disabled", "disabled").prop("title", u.t("rr_remaining_print_allowance")))))
            },
            events: {
              "click #tc-list-cont .icon-tc-open": "expandToc",
              "click #tc-list-cont .icon-tc-close": "collapseToc",
              "click #tc-list-cont a": "goToPage",
              "click #closeMetaData .icon-panel-close": "slidUpDownDocMetaData",
              "click #openMetaData .icon-panel-open": "slidUpDownDocMetaData",
              "keypress #searchInBookTermInToc": "goToSearchByEnter",
              "click #searchWithInBookToc": "searchInBook"
            },
            expandToc: function(e) {
              e.preventDefault();
              var n = t(e.target);
              n.parent().siblings("ul").toggle(),
                  n.toggleClass("icon-tc-open icon-tc-close"
                  )
            },
            ...
            goToPage: function(e) {
              ...
              if (!n.hasClass("tc-icon")) {
                var r = DanaMethodAttr("attr", n, "href").split("=")
                    , i = r[1] || 1;
            ...
            slidUpDownDocMetaData: function(e) {
              var n = t(e.target);
              t("#book-meta-open").animate({
                height: "toggle",
                opacity: "toggle"
              }, "slow"),
                  t("#book-meta-closed").animate({
                    height: "toggle",
                    opacity: "toggle"
                  }, "slow")
            },
            searchInBook: function(e) {
              e.preventDefault(),
                  t("#D-Section").length === 0 ? s.trigger("openBsh", "bookSearch") : (s.trigger("openBshT"),
                      s.trigger("openBsh", "bookSearch")),
                  s.trigger("gaTk", "event", "Reader_Feature", "R1_SEARCHINBOOK", "In-Book Search button clicked from Reader Search Box from TOC Panel")
            },
            goToSearchByEnter: function(e) {
              var n = e.which;
              n === 13 && (t("#D-Section").length === 0 ? s.trigger("openBsh", "bookSearch") : (s.trigger("openBshT"),
                  s.trigger("openBsh", "bookSearch")),
                  s.trigger("gaTk", "event", "Reader_Feature"
            ...
            resizePanel: function() {
              ...
              this.$el.find("#tc-list-cont").css({
                height: t("#panel").outerHeight() - e - 115
              })
            }
          })
        }
    ...
    define("views/PanelBookDetailsItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "models/DocTocM"], function(e, t, n, r, i, s, o) {
          return e.ItemView.extend({
            template: n.panelBookDetailsTemplate,
            id: "B-Section",
            defaults: {
              panelName: "bookDetails"
            },
            initialize: function(e) {
              this.gbData = e.model.collection.gbData;
              var t = _.extend({}, e.model.collection.gbData, e.model.attributes);
            ...
            onRender: function() {
              this.gbData.BiblioData = this.model.get("BiblioData") || {},
              t("#toolAddToBookshelf").hasClass("icon-bookshelf-added") && (DanaMethodAttr("attr", this.$el.find("#bookDetailBookShelf"), "disabled", "disabled"),
                  this.$el.find("#bookDetailBookShelf > .icon-bookshelf-add").removeClass("icon-bookshelf-add").addClass("icon-bookshelf-added"));
              var e = t("#toolDownload");
              DanaMethodAttr("attr", e, "disabled") && DanaMethodAttr("attr", this.$el.find("#bookDetailDownload"), "disabled", "disabled"),
              e.css("display") == "none" && this.$el.find("#bookDetailDownload").hide(),
              this.gbData.uAccsMdRR > 0 && (this.$el.find(".accArHid").remove(),
                  this.$el.find("#closePanel").parent().remove())
            },
            events: {
              "click #closeMetaData .icon-panel-close": "slidUpDownDocMetaData",
              "click #openMetaData .icon-panel-open": "slidUpDownDocMetaData",
              "click #bookDetailBookShelf": "addToBookShelf",
              "click #bookDetailBooklink": "showShareLink",
              "click #bookDetailBookCitation": "showCite",
              "click #bookDetailDownload": "showDownloadLink"
            },
            slidUpDownDocMetaData: function(e) {
              var n = t(e.target);
              t("#bookMetaOpen").animate({
                height: "toggle",
                opacity: "toggle"
              }, "slow"),
                  t("#bookMetaClosed").animate({
                    height: "toggle",
                    opacity: "toggle"
                  }, "slow")
            },
    ...
    define("views/PanelBookNotesEmptyItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent"], function(e, t, n, r, i, s) {
          return e.ItemView.extend({
            template: n.panelBookNotesLoadingContentTemplate,
            initialize: function(e) {
              var t = _.extend({}, e, this.model.attributes);
              this.model.attributes = t
            },
            events: {
              "click #signInNoteButton": "userSignInBtn"
            },
            userSignInBtn: function(e) {
    ...
    define("views/PanelBookNotesItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "models/DocTocM"], function(e, t, n, r, i, s, o) {
          return e.ItemView.extend({
            template: n.panelBookNotesTemplate,
            tagName: "li",
            className: "annotation-level-2",
            initialize: function(e) {
              this.gbData = e.model.collection.gbData
            },
            onBeforeRender: function() {},
            truncateLabel: function(e, t, n) {
              return e.length > t && (e = e.substring(0, t + 1
                  ...
                  e = e.substring(0, Math.min(e.length, e.lastIndexOf(" "))),
                  e += n),
                  e
            },
            onRender: function() {
              this.gbData.BiblioData = this.model.get("BiblioData") || {},
              this.model.collection.gbData.uAccsMdRR > 0 && DanaMethodAttr("attr", this.$el, {
                role: "listitem",
                tabindex: "0"
              })
            },
            ...
            events: {
              "click .annotation-page,.annotation-content": "lookupId",
              "click .annotation-type": "lookupTypeId",
              "click .annotation-delete": "trashAnnot"
            },
            lookupTypeId: function(e) {
              e.preventDefault();
    ...
    define("views/PanelDidYouMeanSearchResultItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "models/SearchTermSugM"], function(e, t, n, r, i, s, o) {
          return e.ItemView.extend({
            template: n.panelBookSearchYouMeanResultTemplate,
            id: "didYouMeanSearchResult",
            defaults: {
              panelSearchResultName: "didYouMeanSearchResult"
            },
            initialize: function(e) {
              this.gbData = e.model.collection.gbData;
              var t = _.extend({}, e.model.collection.gbData, e.model.attributes);
            ...
            events: {
              "click .did-you-mean-result>a": "goToSearchByLink"
            },
            onBeforeRender: function() {},
            onRender: function() {},
            goToSearchByLink
              ...
              s.trigger("openBshT", n.text()),
                  s.trigger("gaTk", "event", "Reader_Feature", "R1_SEARCHINBOOK", "Did_You_Mean:" + n.text() || "")
            }
          })
        }
    ),
    define("views/PanelChapterSearchResultSnipItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent"], function(e, t, n, r, i, s) {
          return e.ItemView.extend({
            template: n.panelBookSearchChapterResultChildSnipTemplate,
            el: function() {
              return ( "#chapterLevelSnips_" + this.model.get("cptInd"))
            },
            initialize: function(e) {
              var t = _.extend({}, {
                tmpLpg: e.model.collection.gbData.tmpLpg
              }, this.model.attributes);
              this.model.attributes = t,
                  this.chptNum = this.model.get("cptInd")
            },
            events: {
              "click  [id^='snipHit_']": "lookupId"
            },
            onRender: function() {
                ...
                t.ajax({
                  ...
                  success: function(i) {
                    if (i.snip != null )
                      ...
                      i.snip.orderedPagesWithSnippet && r.gbData.uAccsMdRR < 1 && s.trigger("jtp", i.snip.orderedPagesWithSnippet[0].pageNumber, "ok");
                    else {
    ...
    define("views/PanelNotesResultChildCollectionView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "views/MainLoadingItemView", "views/PanelChapterSearchResultSnipItemView", "collections/PanelChapterSearchResultSnipCollection", "views/PanelBookNotesItemView"], function(e, t, n, r, i, s, o, u, a, f) {
          return e.CompositeView.extend({
            template: n.panelBookNotesResultChildTemplate,
            tagName: "li",
            className: "annotation-level-2",
            itemView: f,
            initialize: function(e) {}
    ...
    define("collections/PanelNotesInBookCollection", ["backbone", "jquery", "models/AnoInBookModel", "utils/ebreaderUtil", "utils/commonUtil", "vent", "i18next"], function(e, t, n, r, i, s, o) {
          return e.Collection.extend({
            ...
            cmpStringsWithNumbers: function(e, t) {
              e = e == 1 ? "1" : String(DanaStringCheckLink(e)),
                  t = t == 1 ? "1" : String(DanaStringCheckLink(t));
            ...
            comparator: function(e, t) {
              var n = this.sort_stru === "data" ? e.attributes.data : e.attributes
                  , r = this.sort_stru === "data" ? t.attributes.data : t.attributes;
            ...
            prepareData: function(e) {
              this.gbData.antop = 1,
                  this.reset();
              var n = parseInt(t("#current-page").val())
                  , r = this;
              t.ajax({
                url: r.url(),
                success
                ...
                success: function(e) {
                  if (e["status-code"] == 0) {
                    ...
                    if (r.length > 0) {
                      ...
                      DanaMethodAdd("add", i, a, {
                        add: !0,
                        remove: !0,
                        merge: !1
                      }),
                          i.sortByFields("physicalPage,bookMark,pageLevelNote,startQuad", "data", "asc,desc,desc,desc")
                    }
                  } else {
    ...
    define("views/PanelNotesResultParentCollectionView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "views/MainLoadingItemView", "views/PanelNotesResultChildCollectionView", "collections/PanelNotesInBookCollection", "views/PanelBookNotesItemView"], function(e, t, n, r, i, s, o, u, a, f) {
          return e.CompositeView.extend({
            template: n.panelBookNotesResultTemplate,
            tagName: "li",
            id: function() {
            ...
            ,
            itemViewContainer: "[id^='notesLevelSnips_']",
            itemView: f,
            initialize: function(e) {
              this.collection = new a(null ,e.model.collection.gbData),
                  s.on("pnlAntSnp_" + this.model.get("cptInd"), this.userAnnotsSnp, this)
            },
            onRender: function() {
              this.model.collection.gbData.uAccsMdRR > 0 && (DanaMethodAttr("attr", this.$el, {
                role: "listitem",
                tabindex: "0"
                  ...
                  DanaMethodAttr("attr", this.$el.find("[id^='notesLevelSnips_']"), {
                    role: "group",
                    tabindex: "0"
                  }))
            },
            ...
            events: {
              "click [id^='chapterNotesSelection_'] div": "chapterNotesSelection"
            },
            modelEvents: {
              "change merge": "render",
              "change remove": "render"
            ...
            appendHtml: function(e, t, n) {
              var r = e.itemViewContainer ? e.$(e.itemViewContainer) : e.$el
                  , i = r.children();
            ...
            expandSearch: function(e) {
              ...
              t.removeClass("icon-panel-open").addClass("icon-panel-close"),
                  e.siblings(".annotation-list").toggle();
              var n = DanaMethodAttr("attr", e, "id").split("_")[1];
              this.collection.length === 0 ? (this.collection.prepareSnipData(n, this.model.get("data")),
                  e.siblings(".annotation-list").toggle()) : this.collection.models[0].get("data") && this.collection.models[0].get("data").orderedPagesWithSnippet && s.trigger("jtp", this.collection.models[0].get("data").orderedPagesWithSnippet[0].pageNumber, "ok")
            },
            collapseSearch: function(e) {
              var t = e.find("div .icon-panel-close");
              t.removeClass("icon-panel-close").addClass("icon-panel-open"),
                  e.siblings(".annotation-list").toggle()
            },
            userAnnotsSnp: function(
                e, n) {
              if ("save" === n) {
                var r = this.collection.findWhere({
                  cptInd: e.chap.chapId.chapterId,
                  name: e.annotID
                });
                if (!_.isUndefined(r)) {
                  r.attributes.data.labelText = e.labelText,
                      DanaMethodAdd("add", this.collection, {
                        cptInd: e.chap.chapId.chapterId,
                        name: parseInt(e.nAnnot.annotID),
                        data: e.nAnnot
                      }, {
                        add: !1,
                        remove: !0,
                ...
                if (this.collection.size() === 0) {
                  ...
                  var s = "#chapterNotesSelection_" + e.chap.chapId.chapterId
                      , o = t(s)
                      , u = o.find("div .icon-panel-open");
                  u.removeClass("icon-panel-open").addClass("icon-panel-close"),
                      o.siblings(".annotation-list").toggle(),
                      o.siblings(".annotation-list").toggle()
                } else
                  DanaMethodAdd("add", this.collection, {
                    cptInd: e.chap.chapId.chapterId,
              ...
              if ("del" === n) {
                ...
                if (a.length > 0) {
                  var r = this.collection.findWhere({
                    cptInd: e.chapterId,
                    name: parseInt(e.annotID)
                  });
                  _.isUndefined(r) || this.collection.remove(r)
                }
              } else if ("edit" === n) {
                var f = e
                    , r = this.collection.findWhere
                    ({
                      cptInd: f.chapterId,
                      name: parseInt(e.annotID)
                    });
                _.isUndefined(r) || (r.attributes.data.labelText = e.labelText,
                    r.set({
    ...
    define("views/PanelFrequencySearchResultItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent"], function(e, t, n, r, i, s) {
          return e.ItemView.extend({
            template: n.panelBookSearchFrequencyResultTemplate,
            id: "frequencySearchResult",
            defaults: {
              panelSearchResultName: "frequencySearchResult"
            },
            initialize: function(e) {},
            onBeforeRender: function() {},
            onRender: function() {},
            events: {
              "click #searchResultByChapterInFq": "toggleChapterFrequency",
              "click #searchResultByFrequenceyInFq": "toggleFrequencyChapter"
            },
            toggleChapterFrequency: function(e) {
              t("#chapterSearchResult").show(),
                  t("#frequencySearchResult").hide()
            },
            toggleFrequencyChapter: function(e) {
              t("#chapterSearchResult").hide(),
                  t("#frequencySearchResult").show()
            }
          })
        }
    ),
    define("views/PanelBookNotesCollectionView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent"
          ...
          return e.CompositeView.extend({
            template: n.panelBookNotesCompositeTemplate,
            itemViewContainer: "#notesBookResults",
            id: "C-Section",
            itemView: u,
            emptyView: o,
            initialize: function(e) {
              var t = _.extend({}, e.model.collection.gbData, e.model.attributes);
              this.model.set(t),
              typeof e.model.collection.gbData.DocUser != "undefined" && e.model.collection.gbData.DocUser.signedIn && (this.collection = new c(null ,_.extend({}, e.model.collection.gbData)),
                  this.collection.prepareData(""),
                  s.on("pnlAnt", this.userAnnots, this))
            },
            events: {},
            onRender: function() {
              this.model.collection.gbData.uAccsMdRR > 0 && (this.$el.find("#closePanel").parent().remove(),
                  DanaMethodAttr("attr", this.$el.find("#notesBookResults"), {
                    role: "list",
                    tabindex: "0"
                  }))
            },
            ...
            userAnnots: function(e, n) {
                ...
                if (_.isUndefined(o)) {
                  ...
                  u[0] = {
                    ...
                    data: r
                      ...
                      DanaMethodAdd("add", this.collection, u, {
                        add: !1,
                        remove: !0,
                        merge: !0
                      }),
                      this.collection.sortByField("cptInd")
                } else {
                  o.get("data").annotCount = parseInt(o.get("data").annotCount) + 1;
                  var a = t("#annotCount_" + r.chapterId)
                      , f = parseInt(a.text()) + 1;
                  a.html("").text(f)
                }
              ...
              if ("del" === n) {
                ...
                var l = t("#annotCount_" + e.chapterId)
                    , a =
                        parseInt(l.text()) - 1;
                if (a <= 0) {
    ...
    define("views/PanelNoSearchResultItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent"], function(e, t, n, r, i, s) {
          return e.ItemView.extend({
            template: n.panelBookSearchNoResultTemplate,
            id: "noSearchResult",
            defaults: {
              panelSearchResultName: "noSearchResult"
            },
            initialize: function(e) {},
            onBeforeRender: function() {},
            onRender: function() {}
    ...
    define("views/PanelChapterSearchResultChildCollectionView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "views/MainLoadingItemView", "views/PanelChapterSearchResultSnipItemView", "collections/PanelChapterSearchResultSnipCollection"], function(e, t, n, r, i, s, o, u, a) {
          return e.CompositeView.extend({
            template: n.panelBookSearchChapterResultChildTemplate
            ,
            tagName: "li",
            id: function() {
              return ( "topChapterSelection_" + this.model.get("cptInd"))
            },
            className: "search-level-1",
            itemViewContainer: "[id^='chapterLevelSnips_']",
            itemView: u,
            initialize: function(e) {
              this.collection = new a(null ,e.model.collection.gbData)
            },
            ...
            events: {
              "click [id^='chapterSelection_']": "chapterSelection"
            },
            chapterSelection: function(e) {
              var n = t(e.currentTarget);
            ...
            expandSearch: function(e) {
              var n = t(e.currentTarget)
                  , r = n.find("div .icon-panel-open");
              r.removeClass("icon-panel-open").addClass("icon-panel-close"),
                  n.siblings(".search-level-2-group").toggle();
              var i = DanaMethodAttr("attr", n, "id").split("_")[1];
              this.collection.length === 0 ? (this.collection.prepareData
              (i),
                  n.siblings(".search-level-2-group").toggle()) : this.collection.models[0].get("data") && this.collection.models[0].get("data").orderedPagesWithSnippet && s.trigger("jtp", this.collection.models[0].get("data").orderedPagesWithSnippet[0].pageNumber, "ok")
            },
            collapseSearch: function(e) {
              var n = t(e.currentTarget)
                  , r = n.find("div .icon-panel-close");
              r.removeClass("icon-panel-close").addClass("icon-panel-open"),
                  n.siblings(".search-level-2-group").toggle()
            }
          })
        }
                  ...
                  success: function(r) {
                    if (r["status-code"] == 0) {
                      ...
                      for (var s = 0; s < r.chapters.length; s++)
                        r.chapters[s].indent === 0 && DanaMethodAdd("add", n, {
                          cptInd: r.chapters[s].chapterId,
                          searchTerm: e,
                          data: r.chapters[s]
                        }, {
                          add: !0,
    ...
    define("views/PanelChapterSearchResultParentCollectionView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "views/MainLoadingItemView", "views/PanelChapterSearchResultChildCollectionView", "collections/PanelChapterSearchResultCollection"], function(e, t, n, r, i, s, o, u, a) {
          return e.CompositeView.extend
          ({
            template: n.panelBookSearchChapterResultTemplate,
            id: "chapterSearchResult",
            defaults: {
              panelSearchResultName: "chapterSearchResult"
            },
            itemViewContainer: "#searchResultsListByChapter",
            itemView: u,
            emptyView: o,
            initialize: function(e) {
              s.on("openPanel", this.toggleChapterFrequency, this),
                  this.collection = new a(null ,e.model.collection.gbData)
            },
            templateHelpers: {
              totalPageHits: function() {
                return this.data["total-page-hits"]
              }
            },
            onRender: function() {
              var e = t("#search-container").outerWidth();
              this.$el.find("#search-container").css("width", e),
              this.model.collection.gbData.uAccsMdRR > 0 && DanaMethodAttr("attr", this.$el.find("#searchResultsListByChapter"), {
                tabindex: "0"
              })
            },
            events: {
              "click #searchResultByChapter": "toggleChapterFrequency",
              "click #searchResultByFrequencey": "toggleFrequencyChapter",
              "click #toggle-results": "toggleResults"
            },
            toggleChapterFrequency: function(e) {
              t("#chapterSearchResult").show(),
                  t("#frequencySearchResult").hide()
            ...
            toggleResults: function(e) {
              e.preventDefault(),
                  this.model.collection.gbData.showSearhHits = !1,
                  s.trigger("hSQHits"),
                  s.trigger("chPshRes")
            }
          })
    ...
    define("collections/PanelSearchInBookCollection", ["backbone", "jquery", "models/SearchInBookModel", "utils/ebreaderUtil", "utils/commonUtil", "vent", "i18next"], function(e, t, n, r, i, s, o) {
          return e.Collection.extend({
            ...
            prepareData: function(e) {
              var n = t("#searchInBookTerm")
                  , r = t.trim(e) || t.trim(n.val());
              n.val(""),
                  this.reset();
              if (typeof r != "undefined" && r.length > 0 && (r.indexOf(" AND ") > 0 || r.indexOf(" NOT "
                ...
                var i = parseInt(t("#current-page").val())
                    , u = this;
                t.ajax({
                  url: u.url(),
                  success: function(e) {
                    if (e["status-code"] == 0)
                      e["total-page-hits"] > 0 ? (DanaMethodAdd("add", u, {
                        panelSearchResultName: "chapterSearchResult",
                        searchTerm: r,
                        data: e
                      }, {
                        ...
                        merge: !1
                          ...
                          s.trigger("rSQHits", i)) : r.indexOf(" ") == -1 ? DanaMethodAdd("add", u, {
                        panelSearchResultName: "didYouMeanSearchResult",
                        searchTerm: r
                      }, {
                        add: !0,
    ...
    define("views/PanelBookSearchCollectionView"
        , ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "views/MainLoadingItemView", "views/PanelNoSearchResultItemView", "views/PanelDidYouMeanSearchResultItemView", "views/PanelChapterSearchResultParentCollectionView", "views/PanelFrequencySearchResultItemView", "collections/PanelSearchInBookCollection"], function(e, t, n, r, i, s, o, u, a, f, l, c) {
          return e.CompositeView.extend({
            template: n.panelBookSearchCompositeTemplate,
            itemViewContainer: "#searchBookResults",
            id: "D-Section",
            itemView: u,
            initialize: function(e) {
              s.on("openBshT", this.goToSearchAlt, this),
                  s.on("chPshRes", this.goToSearchRes, this);
              var n = _.extend({}, e.model.collection.gbData, e.model.attributes);
              this.model.set(n),
                  this.collection = new c(null ,e.model.collection.gbData);
              var r = t("#searchInBookTermInToc");
              r.val() !== null  && typeof r.val() != "undefined" && (this.collection.prepareData(r.val()),
                  r.val(""))
            },
            ui: {
              searchField: "#searchInBookTerm"
            },
            events: {
              "click #searchWithInBook": "goToSearch",
              "click #searchWithInBookSubmit": "goToSearch"
              ,
              "keypress #searchInBookTerm": "goToSearchByEnter"
            },
            onRender: function() {
            ...
            getItemView: function(e) {
              ...
              return t === "noSearchResult" && (n = u),
              t === "didYouMeanSearchResult" && (n = a),
              t === "chapterSearchResult" && (n = f),
              t === "frequencySearchResult" && (n = l),
                  n
            },
            openSearchByFrequency: function(e, t) {
              var n = this.collection.findWhere({
                panelSearchResultName: e
              });
              (n === null  || typeof n == "undefined") && DanaMethodAdd("add", this.collection, {
                panelSearchResultName: "frequencySearchResult",
                panelName: e,
                data: t
              }, {
            ...
            goToSearch: function(e) {
              this.collection.prepareData(),
                  s.trigger("gaTk", "event", "Reader_Feature", "R1_SEARCHINBOOK", "In-Book Search button clicked from Reader Search Box")
            },
            goToSearchByEnter: function(e) {
              var t = e.which;
              t === 13 && (this.collection.prepareData(),
                  s.trigger("gaTk", "event", "Reader_Feature", "R1_SEARCHINBOOK"
                      , "In-Book Search button clicked from Reader Search Box"))
            },
            goToSearchAlt: function(e) {
              var n = t("#searchInBookTermInToc")
                  , r = e;
              if (r === null  || typeof r == "undefined")
                r = n.val();
              r !== null  && typeof r != "undefined" && (this.collection.prepareData(r),
                  n.val(""))
            },
      ...
      return e.ItemView.extend({
        ...
        initialize: function(e) {
          ...
          this.model = new o(t),
              ...
              this.model.fetch(),
              this.ck = i.readCookie("ESESSIONID"),
          this.ck !== null  && (this.pebr = new r,
              this.pebr.init(this.ck)),
              s.on("cssel", this.cSearch, this)
        },
        getTemplate: function() {
        ...
        events: {
          "click #search-block button": "textResourceTriggers",
          "click #custom-buttons button": "bookResourceTriggers",
          "click #custom-links a": "indResourceTriggers"
        },
        onRender: function() {
          this.model && typeof this.model.get("cusData") != "undefined" && this.cSearch(),
          this.gbData.uAccsMdRR > 0 && this.$el.find("#closePanel").parent().remove()
        },
        bookResourceTriggers: function(e) {
          e.preventDefault();
          var n = DanaMethodAttr("attr", t(e.target), "id").split("_")[1]
              , r = this.model.get("cusData").bookSearches[n]
              , i = r.textValue;
          r.textValue.indexOf("%pisbn%") > -1 ? i = DanaMethodReplace("replace", i, "%pisbn%", this.model.get("BiblioData").pIsbn) : r.textValue.indexOf("%eisbn%") > -1 ?
              i = DanaMethodReplace("replace", i, "%eisbn%", this.model.get("BiblioData").eIsbn) : r.textValue.indexOf("%docid%") > -1 && (i = DanaMethodReplace("replace", i, "%docid%", this.model.get("BiblioData").docID)),
              this.usgCSTk("BookSearch", t(e.target).text()),
              DanaMethodOpen("open", window, i, "Cust Search")
        },
        textResourceTriggers: function(e) {
          e.preventDefault();
          var n = t("input:radio[name=textSearchesRadios]:checked").val()
              , r = encodeURIComponent(t("#cTextSearchId").val())
              , i = DanaMethodReplace("replace", this.model.get("cusData").textSearches[n].textValue, "%token%", r);
          this.usgCSTk("TextSearch", this.model.get("cusData").textSearches[n].textName + ":" + r),
              DanaMethodOpen("open", window, i, "Cust Search")
        },
        cSearch: function() {
          if (typeof this.gbData != "undefined" && this.model && typeof this.model.get("cusData") != "undefined") {
            var e = this.gbData.finalSelections;
            s.trigger("resetPgSel", !0, !0),
                s.trigger("clsPgSel", e.active_page, !0);
            var n = 0
                , r = 0
                , i = t("#current-page").val();
            this.cText = "";
            if (e.active === !0) {
              i = e.active_page,
                  n = e.s_quad,
              ...
              var o = "op=cSeearch&encID=" + this.gbData.encID + "&page=(" + i + ")&start=" + n + "&end=" + r + "&offset=" + (new
                  ...
                  , a = "remoteDocServer.api?remote_id=" + this.ck + "&encrypted=" + this.pebr.enc(o) + "&nq=1"
                  , f = this;
              t.ajax({
                dataType: "json",
                url: a,
                ...
                error: function(e, n, r) {
                  ...
                  i.find("#msg").empty().html(u.t("rr_error_refresh_try_again")),
                      n = !1
                }
              }),
                  t("#cTextSearchId").val(this.cText),
                  this.usgCSTk("ContextualTextSelection", encodeURIComponent(this.cText), n, r)
            }
          }
        },
        ...
        usgCSTk: function(e, n, r, i) {
          if (typeof this.gbData != "undefined" && this.model && typeof this.model.get("cusData") != "undefined") {
            var s = {
              docid: this.gbData.DocUser.docID,
              page: t("#current-page").val(),
              type: "CustomSearch",
              action: e,
              userActionData: n,
              starting: r,
...
define("collections/PanelBarCollection", ["backbone", "jquery", "models/PanelBarModel", "utils/ebreaderUtil", "utils/commonUtil", "vent"], function(e, t, n, r, i, s) {
      return e.Collection.extend({
        model: n,
        initialize: function(e, t) {
          s.on("openPanel", this.openNewPanel, this),
              this.gbData = t,
              this.prepareData()
        },
        prepareData: function() {
        ...
        openNewPanel: function(e) {
          ...
          (t === null  || typeof t == "undefined") && DanaMethodAdd("add", this, {
            panelTest: "White",
            panelName: e
          }, {
            add: !0,
...
define("views/PanelReaderPanelCollectionView", ["marionette", "jquery", "underscore", "templates", "utils/ebreaderUtil", "utils/commonUtil", "views/PanelBookTocItemView", "views/PanelBookDetailsItemView", "views/PanelBookNotesCollectionView", "views/PanelBookSearchCollectionView", "views/PanelBookResourceItemView", "views/MainLoadingItemView", "collections/PanelBarCollection", "vent"], function(e, t, n, r, i, s, o, u, a, f, l, c, h, p) {
      return e.CollectionView.extend({
        ...
        emptyView: c,
        initialize: function(e) {
          this.collection = new h(null ,e.gbData),
              p.on("openPanel", this.togglePanelName, this)
        },
        events: {
        ...
        closePanel: function() {
          var e = 0
              , n = t(window).width()
              , r = n - e - 50
              , i = t("#panel > div").filter(":visible")
              , s = DanaMethodAttr("attr", i, "id")
              , o = this;
          t("#" + s).fadeOut(500, function() {
                var r = t("#panelLayoutRegion").outerWidth()
                    , i = n - r;
                t("#mainViewer").animate({
                  width: i + "px"
                }, 500),
                    t("#panelLayoutRegion").animate({
                          width: e
                        }, 500, function() {
                          o.sizeDivs()
                        }
        ...
        sizeDivs: function() {
          var e = t(window).width()
              , n = t("#sideBar").outerWidth()
              , r = t("#panel").outerWidth();
...
define("views/MainItemView", ["marionette", "jquery", "templates", "utils/ebreaderUtil", "utils/commonUtil", "vent", "i18next"], function(e, t, n, r, i, s, o) {
      return e.ItemView.extend({
        template: n.mainContentTemplate,
        id: function() {
          return ( "mainPageContainer_" + this.model.get("pageNum"))
        },
        className: "mainViewerImgContainerParent",
        headerShowing: !0,
        ctx: {},
        searchCtx: {},
        annotCtx
        ...
        initialize: function(e) {
          this.orgWd = e.orgWd,
              this.orgHgt = e.orgHgt,
              this.zm = e.zm,
              this.divzm = e.divzm,
              this.widthTest = e.widthTest,
              this.showSearhHits = e.showSearhHits;
        ...
        onBeforeRender: function() {},
        onRender: function() {
          var e = this.model.get("pageNum") - 1
              , n = (this.orgHgt + this.widthTest) * e
              , r = this.$el.find(".mainViewerImgCloak");
          if (r.length != 0) {
            var i = r.get(0).getContext("2d");
            i.fillStyle = "#c0e9fb",
                i.globalAlpha = .6,
                DanaMethodSave("save", i),
                this.ctx = i
          }
          ...
          if (!_.isUndefined(this.model.get("page")) && this.model.get("page").width > this.orgWd) {
            t("#mainViewerPagesContainer").css({
              height: this.orgHgt,
              width
                  : this.model.get("page").width + 2
            }),
                this.$el.css({
                  top: n,
                  height: this.orgHgt,
                  width: this.model.get("page").width + 2
                }),
                this.$el.find(" * ").not("br").not("img").not("canvas").not("span").css({
                  height: this.orgHgt,
                  width: this.model.get("page").width + 2
                });
            var o = this.$el.find("img").width()
                , u = this.$el.find("img").height();
            this.tmpImgLeftforFloat = (this.model.get("page").width + 2 - o) / 2,
                this.tmpImgTopforFloat = (this.orgHgt - u) / 2;
            var a = o + this.tmpImgLeftforFloat - 84;
            this.$el.find(".bookmark ").css({
              top: this.$el.find("img").css("top"),
              left: a + "px"
            })
          } else {
            this.$el.find(" * ").not("br").not("img").not("canvas").not("span").css({
            ...
            if (_.isUndefined(DanaMethodAttr("attr", this.$el.find(".bookmark"), "id")))
              return;
            var o = this.$el.find("img").outerWidth()
                , u = this.$el.find("img").outerHeight();
            this.tmpImgLeftforFloat = Math.ceil((this.orgWd - o) / 2),
                this.tmpImgTopforFloat = Math.ceil
                ((this.orgHgt - u) / 2);
            var a = o + this.tmpImgLeftforFloat - 84;
            parseInt(this.$el.find("img").css("top")) === 0 ? this.$el.find(".bookmark ").css({
              top: this.tmpImgTopforFloat,
              left: a + "px"
            }) : this.$el.find(".bookmark ").css({
              top: this.$el.find("img").css("top"),
              left: a + "px"
        ...
        events: {
          "dblclick canvas": "cloakWordHighlight",
          "click canvas": "cloakClick",
          "mousedown canvas": "cloakMouseDown",
          "mousemove canvas": "cloakMouseDrag",
          "mouseup canvas": "cloakMouseUp",
          "click #contextCopy": "contextCopyMode",
          "click #contextHighlightPink": "contextHighPink",
          "click #contextHighlightBlue": "contextHighBlue",
          "click #contextHighlightYellow": "contextHighYellow",
          "click #contextNote": "createContextNote",
          "dblclick .note-icon.note-collapsed": "callNoteTextPop",
          "click #noteTextdelete": "deleteTextNote",
          "click #noteTextclose": "closeTextNote",
          "click #noteTextCancel": "closeTextNote",
          "click #noteTextSave": "saveTextNote",
          "click  .popover-content button.icon-trash": "deleteHigh",
          "click .bookmark": "annotBookmark",
          "click #contextCustomSearch": "callCustomSearch"
        },
        annotBookmark: function(e) {
          if (!_.isUndefined(this.model.get("status")) && this.model.get("status") === "FAILURE")
            return ( !1) ;
          var t = this.$el.find(".bookmark")
              , n = !_.isUndefined(this.model.collection.gbData) && this.model.collection.gbData.
                      selectedZone.active
              , r = this.model.collection.gbData.selectedZone.active_page;
          n && (s.trigger("clsPgSel", r, !0),
              s.trigger("resetPgSel", !0, !0)),
              s.trigger("cNotes"),
              this.model.collection.gbData.whatClicked = "to_bookmark";
          if (t.hasClass("icon-bookmark-off")) {
            var i = {
                  op: "annotate",
                  encID: this.model.collection.gbData.encID,
                  zoom: this.model.collection.gbData.zm,
                  type: "link",
                  ppg: this.model.get("pageNum"),
                  s: -1,
                  e: -1
                }
                , o = this.saveAnnotation(i, "BookMark:");
            if (o.length > 0) {
              var u = this;
              _.each(o, function(e) {
                    u.model.get("annots").push(e),
                        u.postToPanel("save", e)
                  }
              ),
        ...
        delAnnotBMID: function(e) {
          ...
          if (!_.isUndefined(n)) {
            ...
            if (r)
            {
              ...
              var s = {
                annotID: e,
                chapterId: n.chapInfo.chapterId
              };
              return this.postToPanel("del", s),
                  this.$el.find(".bookmark").removeClass("icon-bookmark-on").addClass("icon-bookmark-off"),
                  !1
            }
          }
        },
        deleteTextNote: function(e) {
          var n = t(e.currentTarget)
              , r = DanaMethodAttr("attr", n.parent().parent(), "id").split("_")[2];
          this.delAnnotNID(r)
        },
        delAnnotNID: function(e) {
          e === "0" ? this.resetSelectedZone() : this.deleteNoteAnnot(e),
              this.closeTextNote()
        },
        deleteNoteAnnot: function(e) {
          ...
          if (!_.isUndefined(n)) {
            ...
            if (r) {
              ...
              this.postToPanel("del", i),
                  this.delAndRefreshPageAnnots(e)
            }
          }
        },
        ...
        saveTextNote: function(e) {
          var n = t(e.currentTarget).parent().parent()
              , r = DanaMethodAttr("attr", n, "id").split("_")[2]
              , i = n.find("#note-content").val().trim() || "";
          if (i.length > 0) {
            var s = {
              op: "annotate",
              encID: this.model.collection.gbData.encID,
              ...
              type: "create_note",
              ppg: this.model.get("pageNum"),
              x: parseInt(n.css("left")),
              y: parseInt(n.css("top")),
              width: n.outerWidth(),
              height: n.outerHeight()
            };
            this.model.collection.gbData.finalSelections.active === !0 && (s.s = this.model.collection.gbData.finalSelections.s_quad,
                s.e = this.model.collection.gbData.finalSelections.e_quad,
                s.type = "noteyellow"),
            "0" !== r && (s.op = "edit",
                s.type = "note" + DanaMethodAttr("attr", n, "class").split("-")[1],
                s.id = r,
                s.changetype = "TEXT");
            ...
            if (!_.isUndefined(o)) {
              ...
              if ("0" === r)
                _.each(o, function(e) {
                      _.isUndefined(u.model.get("annots")) || (u.model.get("annots").push(e),
                          u.postToPanel("save", e),
                          u.showIndiPageAnnote(e))
                    }
                );
              else {
                var a = this.model.get("annots");
                _.each(a, function(e) {
                      e.annotID === parseInt(o.annotID) && (e.label =
                          i,
                          o.chapterId = e.chapInfo.chapterId)
                    }
                ),
        ...
        delAnnotHID: function(e) {
          ...
          if (t) {
            var n = this.model.get("annots")
                ...
                , i = {
                  annotID: e,
                  chapterId: r.chapInfo.chapterId
                };
            this.postToPanel("del", i),
                this.delAndRefreshPageAnnots(e)
          }
        ...
        clearPageAnnots: function() {
          ...
          var e = this.$el.find(".mainViewerImgCloak");
          e.length > 0 && this.ctx.clearRect(0, 0, e.width(), e.height()),
              this.$el.find("[id^='note_']").remove()
        },
        showPageAnnotes
            : function() {
          var e = this.model.get("annots")
              , t = this;
          _.each(e, function(e) {
        ...
        showIndiPageAnnote: function(e) {
          "hilite" === e.annotType ? this.annotHighlight(e.tint, e.rects) : "sticky" === e.annotType ? (this.showNoteIcon(e),
          e.hiliteId !== 0 && this.annotHighlight(e.tint, e.rects)) : "link" === e.annotType && (e.bookMark || (this.showNoteIcon(e),
          e.hiliteId !== 0 && this.annotHighlight("yellow", e.rects)))
        },
        showNoteIcon: function(e) {
          var n = "note_" + this.model.get("pageNum") + "_" + e.annotID
              , r = e.tint !== "none" ? e.tint : "yellow"
              , i = "note-icon note-collapsed  note-collapsed-" + r
              , s = t("<div>", {
                id: n,
                "class": i
              });
          ...
          if (!e.pageLevelNote) {
            ...
            if (o.length > 0) {
              var u = o[0].top;
              s.css({
                top: this.tmpImgTopforFloat + u + "px",
                left: this.tmpImgLeftforFloat
              })
            } else
              s.css({
                top: this.tmpImgTopforFloat + "px",
                left: this.tmpImgLeftforFloat
              })
          } else
            s.css({
        ...
        showNoteAnnot: function(e) {
          ...
          e.rects.length !== 0 && this.showBorderHigh(e),
              this.showNoteTextPop(e)
        },
        showNoteTextPop: function(e) {
          var n = this.model.get("pageNum")
              , r = "myNotePopId_" + n + "_" + e.annotID
              , i = e.tint !== "none" ? e.tint : "yellow"
              , s = "note  note-" + i
              , o = t("<div>", {
                id: r,
                "class": s
          ...
          o.append(t("#myNotePopId").html()),
              o.find("#note-content").val(e.label);
          if (!e.pageLevelNote) {
            var u = e.rects;
            if (u.length > 0) {
              var a = u[0].top;
              o.css({
                top: this.tmpImgTopforFloat + a + "px",
                left: this.tmpImgLeftforFloat
              })
            } else
              o.css({
          ...
          e.annotType === "link" && DanaMethodAttr("attr", o.find("#noteTextSave"), "disabled", "disabled"),
              this.$el.append(o),
              this.$el.find("#note-content").focus(),
              t(".note").resizable()
        },
        annotHighlight: function(e, t) {
          this.annotCtx.globalAlpha = .4,
              this.annotCtx.fillStyle = this.getHighLightStyle(e);
          var n = this;
          _.each(t, function(e) {
        ...
        saveHighlight: function(e) {
          if (this.model.collection.gbData.finalSelections.active === !0) {
            var t = {
                  ...
                  zoom: this.model.collection.gbData.zm,
                  type: e,
                  s: this.model.collection.gbData.finalSelections.s_quad,
                  e: this.model.collection.gbData.finalSelections.e_quad,
                  ppg: this.model.get("pageNum")
                }
                , n = this.saveAnnotation(t);
            if (n.length > 0) {
              var r = this;
              _.each(n, function(e) {
                    r.model.get("annots").push(e),
                        r.postToPanel("save", e),
                        r.showIndiPageAnnote(e)
                  }
              )
            }
          }
        ...
        saveAnnotation: function(e, n) {
          ...
          var r = t.param(e)
              , i = "encrypted=" + this.pebr.enc(r) + "&remote_id=" +
                  this.model.collection.gbData.ssen;
          _.isUndefined(n) || (i += "&note=" + encodeURIComponent(n)),
              i += "&tm=1";
          var u = {};
          return t.ajax({
            dataType: "json",
            url: "remoteBookshelf.api",
            async: !1,
            type: "POST",
            data: i,
            success: function(n) {
        ...
        postToPanel: function(e, t) {
          if ("save" === e) {
            var n = t.chapInfo.chapterId
                , r = t.physicalPage - 1
                , i = {
                  nAnnot: {
                    hiliteId: _.isUndefined(t.hiliteId) ? 0 : t.hiliteId,
                    tint: t.tint,
                    pageLevelNote: t.pageLevelNote,
                    annotType: t.annotType,
                    annotID: t.annotID,
                    logicalPage: this.model.collection.gbData.tmpLpg[r],
                    physicalPage: t.physicalPage
                    ,
                    startQuad: t.startQuad,
        ...
        getHighLightStyle: function(e, t) {
          var n = "#FFBC0B";
          return t === "sStyle" ? e === "pink" ? n = "#e260df" : e === "blue" ? n = "#0092c7" : n = "#FFBC0B" : e === "pink" ? n = "#e260df" : e === "blue" && (n = "#0092c7"),
              n
        },
        ...
        cloakWordHighlight: function(e) {
          ...
          if (s != -1) {
            var o = this.model.get("annots")
                , u = this;
            _.each(o, function(e) {
                  if (s >= e.startQuad && s <= e.endQuad && e.annotType == "hilite")
                    return u.showDeleteHigh(e),
                        i = !0,
                        !1
                }
            );
            if (i)
              return ( !1) ;
            this.model.collection.gbData.selectedZone.active = !0,
                this.model.collection.gbData.selectedZone.s_quad = s,
                this.model.collection.gbData.selectedZone.e_quad = s,
                this.model.collection.gbData.selectedZone.active_page = this.model.get("pageNum"),
                this.model.collection.gbData.selectedZone.s_floats = !1,
                this.model.collection.gbData.selectedZone.e_floats = !1,
                this.model.collection.gbData.finalSelections.active = !0,
                this.model.collection.gbData.finalSelections.e_quad = s,
                this.model.collection.gbData.finalSelections.s_quad = s,
                this.model.collection.gbData.finalSelections.active_page = this.model.get("pageNum"),
                this.fillSelections()
          }
          if (this.model.collection.gbData.finalSelections.active) {
            ...
            this.$el.popover({
              ...
              placement: "top",
              html: !0,
              container: "#mainViewerImgCloakWrapper_" +
              a,
              content: function() {
            ...
            var f = this.model.get("allQuads")[this.model.collection.gbData.finalSelections.s_quad]
                , l = (f.mTlh + f.mTrh) / 2 - 88 + this.tmpImgLeftforFloat;
            t(".popover").css({
              left: l + "px",
              top: f.mTlv + this.tmpImgTopforFloat - 45 + "px"
            })
          }
        },
        showBorderHigh: function(e) {
          ...
          this.ctx.globalAlpha = 1,
              this.ctx.strokeStyle = this.getHighLightStyle(e.tint, "sStyle"),
              _.each(e.rects, function(e) {
        ...
        showDeleteHigh: function(e) {
          ...
          var n = e.rects[0]
              , r = (n.left * 2 + n.width) / 2 - 22 + this.tmpImgLeftforFloat
              , i = n.top - 45 + this.tmpImgTopforFloat
              , s = this.model.get("pageNum");
          this.$el.popover({
            trigger: "manual",
            placement: "top",
            html: !0,
            container: "#mainViewerImgCloakWrapper_" + s,
            content: function() {
              var n = "highLightDel_" + s + "_" + e.annotID
                  , r = t("<button>", {
                    id: n,
                    "class": "icon-trash"
                  });
        ...
        cloakMouseDown: function(e) {
          this.resetSelectedZone();
          if (!_.isUndefined(this.model.get("status")) && this.model.get("status") === "FAILURE")
            return this.model.collection.gbData.whatClicked = "",
                !1;
          ...
          if (!_.isUndefined("allQuads") && this.model.get("allQuads").length > 0) {
            ...
            if (this.tracking == 1) {
              var n = t(e.target).get(0)
                  , r = this.getMousePos(n, e)
                  , i = this.model.get("allQuads")
                  , s = this.getQuadAtPoint(i, r);
              s >= 0 ? (this.model.collection.gbData.selectedZone.s_quad = s,
                  this.model.collection.gbData.selectedZone.s_floats = !1) : (s = this.findPrevQuad(i, r),
                  s < 0 ? (this.model.collection.gbData.selectedZone.s_quad = 0,
                      this.model.collection.gbData.selectedZone.s_floats = !1) : (this.model.collection.gbData.selectedZone.s_floats = !0,
                      this.model.collection.gbData.selectedZone.s_quad = s))
            }
          }
        },
        cloakMouseDrag
          ...
          if (this.tracking == 1) {
            ...
            var r = this.getMousePos(n, e)
                , i = this.model.get("allQuads")
                , s = this.getQuadAtPoint(i, r);
            s < 0 ? (s = this.findPrevQuad(i, r),
                this.model.collection.gbData.selectedZone.e_floats = !0) : this.model.collection.gbData.selectedZone.e_floats = !1,
                this.cleanFillSelections(s)
          }
        },
        cloakMouseUp: function(e) {
          var n = this.model.collection.gbData.selectedZone.active_page;
          n != -1 && n !== this.model.get("pageNum") && s.trigger("clsPgSel", n, !1),
              DanaPutCursor(e.target.style, "default", 0),
              this.tracking = !1,
              this.setFinalQuadsForSelection();
          if (this.model.collection.gbData.finalSelections.active === !0) {
            if (this.model.collection.gbData.whatClicked === "toolHigh")
              return this.contextHighYellow(),
                  !1;
            var r = t(e.target).get(0)
                , i = this.getMousePos(r, e)
                , o = this.model.collection.gbData.finalSelections.active_page;
            this.$el.popover({
              trigger: "manual",
              placement: "top",
              html: !0,
              container: "#mainViewerImgCloakWrapper_" + o,
              content: function() {
                return t("#contextMenuPop").html()
              }
            }),
            ...
            var u = this.model.get("allQuads")[this.model.collection.gbData.finalSelections.s_quad]
                , a = (u.mTlh + u.mTrh) / 2 - 88 + this.tmpImgLeftforFloat;
            t(".popover").css({
              left: a + "px",
              top: u.mTlv + this.tmpImgTopforFloat - 45 + "px"
            })
          }
        },
        cleanFillSelections: function(e) {
          this.clearSelections(),
              this.model.collection.gbData.selectedZone.e_quad = e,
              this.fillSelections()
        },
        clearSelections: function() {
          var e = this.model.collection.gbData.selectedZone.active_page;
          if (e != -1 && e !== this.model.get("pageNum"))
            s.trigger("clsPgSel", e, !0),
                this.model.collection.gbData.selectedZone.active_page = this.model.get("pageNum");
          else {
            var t = this.$el.find(".mainViewerImgCloak");
            t.length > 0 && this.ctx.clearRect(0, 0, t.width(), t.height()),
                this.clearFinalSelections()
          }
        },
        setFinalQuadsForSelection: function() {
          if (this.model.collection.gbData.selectedZone.active === !0) {
            var e = this.findFinalQuads();
            e.s_quad !== -1 && e.e_quad !== -1 && (this.model.collection.gbData.finalSelections.active = !0,
                this.model.collection.gbData.finalSelections.s_quad = e.s_quad,
                this.model
                    .collection.gbData.finalSelections.e_quad = e.e_quad,
                this.model.collection.gbData.finalSelections.active_page = this.model.collection.gbData.selectedZone.active_page)
          }
        },
        ...
        clearFinalSelections: function() {
          this.$el.popover("destroy"),
              this.model.collection.gbData.finalSelections.active = !1,
              this.model.collection.gbData.finalSelections.s_quad = -1,
              this.model.collection.gbData.finalSelections.e_quad = -1,
              this.model.collection.gbData.finalSelections.active_page = -1
        },
        ...
        findFinalQuads: function() {
          var e = -1
              , t = this.model.collection.gbData.selectedZone.e_quad;
          this.model.collection.gbData.selectedZone.e_floats ? (e = this.model.collection
              .gbData.selectedZone.s_quad,
              t < e ? t++ : t > e ? this.model.collection.gbData.selectedZone.s_floats && e++ : this.model.collection.gbData.selectedZone.s_floats && (e = t = -1)) : (e = this.model.collection.gbData.selectedZone.s_quad,
          this.model.collection.gbData.selectedZone.s_floats && t > e && e++);
          if (e > t) {
            var n = e;
            e = t,
                t = n
        ...
        _fillSelections: function() {
          var e = this.model.collection.gbData.selectedZone.s_quad
              , t = this.model.collection.gbData.selectedZone.e_quad;
        ...
        resetSelectedZone: function() {
          this.$el.popover("destroy"),
              t("[id^='myNotePopId_']").remove(),
              this.ctx.fillStyle = "#c0e9fb",
              this.ctx.globalAlpha = .6,
              this.clearSelections(),
              this.model.collection.gbData.selectedZone.active = !1,
              this.model.collection.gbData.selectedZone.s_quad = -1,
              this.model.collection.gbData.selectedZone.e_quad = -1,
              this.tracking = !1,
              this.model.collection.gbData.selectedZone.s_floats = !1,
              this.model.collection.gbData.selectedZone.e_floats = !1,
              this.model.collection.gbData.finalSelections.active = !1,
...
define("collections/DocServerCollection", ["backbone", "jquery", "models/DocServer", "utils/ebreaderUtil", "utils/commonUtil", "vent", "i18next"], function(e, t, n, r, i, s, o) {
      return e.Collection.extend({
        ...
        prepareData: function() {
          var e = this.gbData.tmpFetchPageNum
              , n = parseInt(this.gbData.tmpzmMaxWidth * this.gbData.divzm)
              , r = parseInt(this.gbData.tmpzmMaxHeight * this.gbData.divzm);
          this.gbData.orgWd = n,
              this.gbData.orgHgt = r;
          var i = this.gbData.tmpOpt = 1;
          if (typeof this.get(e) == "undefined") {
            var s = this
                , u = DanaMethodAdd("add", s, {
                  at: e,
                  cid: e,
                  _id: e,
                  pageNum: e,
            ...
            u.fetch({
              ...
              success: function(n, r, i) {
                t("#mainViewerPagesContainerWrapper").css({
                  height: (s.gbData.orgHgt + s.gbData.widthTest) * s.gbData.tpg,
                  width: s.gbData.orgWd
                }),
                    t("#mainViewerPagesContainer").css({
                      height: s.gbData.orgHgt + 20,
                      width: s.gbData.orgWd
                    });
                var o = t("#mainViewer");
        ...
        prepareDataNewOrg: function() {
          var e = this.gbData.tmpFetchPageNum
              , n = parseInt(this.gbData.tmpzmMaxWidth * this.gbData.zm)
              , r = parseInt(this.gbData.tmpzmMaxHeight * this.gbData.zm);
          this.gbData.orgWd = n,
              this.gbData.orgHgt = r,
              t("#mainViewerPagesContainerWrapper").css({
                height: (this.gbData.orgHgt + this.gbData.widthTest) * this.gbData.tpg,
                width: this.gbData.orgWd
              }),
              t("#mainViewerPagesContainer").css({
                height: this.gbData.orgHgt + 20,
                width: this.gbData.orgWd
              });
          var i = this;
          i.fetch({
        ...
        deleteAnnot: function(e, n) {
          var r = "ppg=" + e + "&encID=" + this.gbData.encID + "&id=" + n + "&op=removeAnnot"
              , i = "remoteBookshelf.api?encrypted=" + this.pebr.enc(r) + "&remote_id=" + this.gbData.ssen + "&tm=1"
              , u = !0;
          return t.ajax({
            dataType: "json",
            url: i,
...
define("views/ReaderMainContentCollectionView", ["marionette", "jquery", "underscore", "templates", "utils/ebreaderUtil", "utils/commonUtil", "utils/notesUtil", "views/MainItemView", "views/MainLoadingItemView", "collections/DocServerCollection", "vent", "i18next"], function(e, t, n, r, i, s, o, u, a, f, l, c) {
      return e.CompositeView.extend({
        template: r.mainCompositeTemplate,
        itemViewContainer: "#mainViewerPagesContainer",
        id: "mainViewer",
        itemView: u,
        emptyView: a,
        skipBlockSize: !1,
        initialize: function(e) {
          if (e.gbData.hasAc === 1)
            ...
            return;
          l.on("jtp", this.jumpToPage, this),
              l.on("rspzl", this.reSizeZlEffect, this),
              l.on("rspwd", this.reSizeWdEffect, this),
              l.on("rspht", this.reSizeHtEffect, this),
              l.on("clsPgSel", this.clearSelections, this),
              l.on("resetPgSel"
                  , this.resetSelections, this),
              l.on("rSQHits", this.resetSearchQuads, this),
              l.on("cSQHits", this.clearSearchQuads, this),
              l.on("hSQHits", this.hideSearchQuads, this),
              l.on("sSQHits", this.showSearchQuads, this),
              l.on("cNotes", this.closeOpenNotes, this),
              l.on("tCPN", this.createPageNotes, this),
              l.on("tBM", this.toogleBookMark, this),
              l.on("tCH", this.createHighlight, this),
              l.on("pAntDel", this.panelDeleteAnnot, this),
              l.on("pAntSh", this.panelShowAnnot, this),
              this.getDebounce = n.debounce(function() {
                    this.findPos(!0)
                  }
                  , 10, !0),
              this.getReDebounce = n.debounce(function() {
                    t("#page-num-floater").hide(),
                        this.findPos(!1)
                  }
                  , 150),
              this.ToolTipScrollWidth = this.browserWidthOfScrollBar()
        },
        itemViewOptions: function(e) {
          return ( {
            orgWd: typeof this.collection != "undefined" ? this.collection.gbData.orgWd : 500,
            orgHgt: typeof this.collection != "undefined" ? this.collection.gbData.orgHgt : 500,
            zm: typeof this.collection != "undefined" ? this.collection.gbData.zm : 1,
            divzm: typeof this.collection != "undefined" ? this.collection.gbData.divzm : 1.2,
            widthTest: typeof this.collection != "undefined" ?
                this.collection.gbData.widthTest : 16,
            showSearhHits: typeof this.collection != "undefined" ? this.collection.gbData.showSearhHits : !0
          })
        },
        events: {
          scroll: "scrollDebounce"
        },
        tooltipPageShow: function(e) {
          this.obj.animate({
            top: e.pageY,
            left: t("#mainViewer").width() + t("#mainViewer").offset().left - (this.ToolTipScrollWidth + 40)
          }, {
            queue: !1,
            duration: 0,
            easing: "linear"
        ...
        browserWidthOfScrollBar: function() {
          var e, n;
          e = t('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo("body"),
              n = e.children();
        ...
        findPosToOffset: function(e) {
          ...
          while (e && e.offsetParent)
            i = e.offsetParent.scrollTop || 0,
                r = e.offsetParent.scrollLeft || 0,
                t += e.offsetLeft - r,
                n += e.offsetTop - i,
                e = e.offsetParent;
          return ( [t, n])
        ...
        jumpToPageOrg: function(e) {
          ...
          if (typeof this.collection.get(n).get("page") == "undefined") {
            ...
            this.collection.get(n).renderModel(),
                t("#mainViewer").scrollTop(t("#mainViewer").scrollTop() + 3 - t("#mainViewer").offset().top + t("#mainPageContainer_" + n).offset().top)
        },
        jumpToPage: function(e, n) {
          this.collection.gbData.tmpFetchPageNum = e || 1;
          var r = this.collection.gbData.tmpFetchPageNum;
          r <= 1 && t("#tool-pager-prev").prop("disabled", !0),
          r > 1 && t("#tool-pager-prev").removeProp("disabled"),
          this.collection.gbData.tmpLpg.length >= 2 && t("#tool-pager-next").removeProp("disabled"),
          r >= this.collection.gbData.tmpLpg.length && t("#tool-pager-next").prop("disabled", !0);
          if (typeof this.collection.get(r) == "undefined") {
            var i = this.collection.gbData.tmpOpt = 1

                , s = this
                , o = DanaMethodAdd("add", s.collection, {
                  at: r,
                  cid: r,
                  _id: r,
                  pageNum: r,
                  ht: this.collection.orgHgt,
                  wd: this.collection.orgWd,
                  tmpOpt: i
                });
            o.fetch({
              data: {
        ...
        scrollDebounce: function(e) {
          ...
          t.data(this, "scrollTimer", DanaFuncSetTimeout(setTimeout, function() {
                t("#page-num-floater").fadeOut(400),
                    n.pageFetchOnScroll()
              }
              , 250))
        },
        findPosORg: function(e) {
          ...
          c > this.collection.gbData.
              tpg && (c = this.collection.gbData.tpg),
              t("#current-page").val(c),
              t("#addPageNum").empty().html(c),
              t("#addPageNum").empty().html(c),
              t("#tool-current-page-loc").empty().html(c);
          var h = t("#page-num-floater");
          if (e) {
            var p = t(window).width()
                , d = t("#sideBarLayoutRegion").width()
                , v = t("#panelLayoutRegion").width()
                , m = n.width()
                , g = m / 2 || 0
                , y = d + v + g;
            h.css({
        ...
        findPosNewOrg: function(e) {
          var n = t("#mainViewer")
              ...
              , i = n.height()
              , s = r - i
              , o = t("#mainViewer div > div div").height()
              , u = n.children().length
              , a = o + this.collection.gbData.widthTest;
          a = a;
          var f = n.scrollTop()
              , l = 1 + f / a
              , c = l
              , h = Math.floor(l)
              , p = l - Math.floor(l);
          h >= this.collection.gbData.tpg && (h = this.collection.gbData.tpg),
              t("#current-page").val(h),
              t("#addPageNum").empty().html(h),
              t("#addPageNum").empty().html(h),
              t("#tool-current-page-loc").empty().html(h);
          var d = t("#page-num-floater");
          if (e) {
            var v = t(window).width()
                , m = t("#sideBarLayoutRegion").width()
                , g = t("#panelLayoutRegion").width()
                , y = n.width()
                , b = y / 2 || 0
                , w = m + g + b;
            d.css({
        ...
        findPos: function(e) {
          ...
          t("#addPageNum").empty().html(d),
              t("#tool-current-page-loc").empty().html(d);
          var v = t("#page-num-floater");
          if (e) {
            var m = t(window).width()
                , g = t("#sideBarLayoutRegion").width()
                , y = t("#panelLayoutRegion").width()
                , b = n.width()
                , w = b / 2 || 0
                , E = g + y + w;
            v.css({
        ...
        reSizeZlEffect: function(e) {
          this.collection.gbData.tmpFetchPageNum = e,
              this.collection.gbData.zm = this.collection.gbData.zm > .5 ? this.collection.gbData.zm : .5,
              this.collection.gbData.zm = this.collection.gbData.zm > 10 ? 10 : this.collection.gbData.zm,
              this.collection.gbData.divzm =
                  this.collection.gbData.zm + .1,
              this.collection.gbData.orgWd = parseInt(this.collection.gbData.tmpzmMaxWidth * this.collection.gbData.divzm),
              this.collection.gbData.orgHgt = parseInt(this.collection.gbData.tmpzmMaxHeight * this.collection.gbData.divzm),
              this.collection.reset(),
              this.collection.prepareData()
        },
        reSizeWdEffect: function(e) {
          this.collection.gbData.tmpFetchPageNum = e;
          var n = t("#mainViewer").width()
              , r = this;
          this.children.each(function(t) {
                if (t.model.get("pageNum") === e) {
                  var i = t.model.get("page")
                      , s = i.width / r.collection.gbData.zm
                      , o = i.height / r.collection.gbData.zm;
                  r.collection.gbData.tmpzmMaxWidth = s,
                  o > r.collection.gbData.tmpzmMaxHeight && (r.collection.gbData.tmpzmMaxHeight = o),
                      r.collection.gbData.zm = r.collection.gbData.zm * (n - r.collection.gbData.widthTest * 2) / i.width || 1,
                      r.collection.gbData.zm = r.collection.gbData.zm > .5 ? r.collection.gbData.zm : .5,
                      r.collection.gbData.zm = r.collection.gbData.zm > 10 ? 10 : r.collection.gbData.zm,
                      r.collection.gbData.divzm = r.collection.gbData.zm,
                      r.collection.gbData.zm = r.collection.gbData
                              .zm - .1
                }
              }
          ),
          ...
          this.children.each(function(t) {
                if (t.model.get("pageNum") === e) {
                  var i = t.model.get("page")
                      , s = i.width / r.collection.gbData.zm
                      , o = i.height / r.collection.gbData.zm;
                  s > r.collection.gbData.zmMaxWidth ? r.collection.gbData.tmpzmMaxWidth = s : r.collection.gbData.tmpzmMaxWidth = r.collection.gbData.zmMaxWidth,
                  o > r.collection.gbData.zmMaxHeight && (r.collection.gbData.tmpzmMaxHeight = o),
                      r.collection.gbData.zm = r.collection.gbData.zm * n / i.height || 1,
                      r.collection.gbData.zm = r.collection.gbData.zm > .5 ? r.collection.gbData.zm : .5,
                      r.collection.gbData.zm = r.collection.gbData.zm > 10 ? 10 : r.collection.gbData.zm,
                      r.collection.gbData.divzm = r.collection.gbData.zm,
                      r.collection.gbData.zm = r.collection.gbData.zm - .1
                }
              }
          ),
              this.collection.reset(),
        ...
        pageFetchOnScrollRef: function() {
          var e = 2
              , t = e
              , n = this
              , r = DanaMethodAdd("add", n.collection, {
                at: t,
                cid: t,
                _id: t,
                pageNum: t,
                ht
                    : this.collection.orgHgt,
                wd: this.collection.orgWd
              });
          r.fetch({
            data: {
        ...
        pageFetchOnScroll: function() {
          ...
          t("[id^='snipHit_']").length > 0 && (t("[id^='snipHit_']").removeClass("search-level-2-selected"),
              t("#snipHit_" + e).addClass("search-level-2-selected"));
          if (typeof this.collection.get(e) == "undefined") {
            var n = this.collection.gbData.tmpFetchPageNum = e
                , r = this.collection.gbData.tmpOpt = 1
                , i = this
                , s = DanaMethodAdd("add", i.collection, {
                  at: e,
                  cid: e,
                  _id: e,
                  pageNum: e,
            ...
            var o = this.collection.get(e)
                , u = o.get("tmpOpt");
            typeof u != "undefined" && u === 0 && typeof o.get("status") != "undefined" && o.get("status") !== "FAILURE" && (o.set({
              tmpOpt: 1
            }, {
              silent: !0
            }),
                this.tmpLogicalPage(e))
          }
          var a = this.collection.gbData.tmpFetchPageNum = e - 1;
          if (a > 0 && typeof this
                  .collection.get(a) == "undefined") {
            var r = this.collection.gbData.tmpOpt = 0
                , f = this
                , l = DanaMethodAdd("add", f.collection, {
                  at: a,
                  cid: a,
                  _id: a,
                  pageNum: a,
          ...
          if (c < this.collection.gbData.tpg && typeof this.collection.get(c) == "undefined") {
            var r = this.collection.gbData.tmpOpt = 0
                , h = this
                , p = DanaMethodAdd("add", h.collection, {
                  at: c,
                  cid: c,
                  _id: c,
                  pageNum: c,
        ...
        pageFetchOnScrollOrg: function() {
          ...
          if (typeof this.collection.get(e).get("page") == "undefined") {
            var n = this
                    .collection.gbData.tmpFetchPageNum = e
                , r = this
                , i = r.collection.get({
                  id: n
                });
        ...
        resetSelections: function(e, t) {
          e && (n.isUndefined(this.collection.gbData) || (this.collection.gbData.selectedZone = {
            active: !1,
            tracking: !1,
            s_quad: -1,
            e_quad: -1,
          ...
          t && (n.isUndefined(this.collection.gbData) || (this.collection.gbData.finalSelections = {
            active: !1,
            s_quad: -1,
            e_quad: -1,
            active_page: -1
        ...
        createPageNotes: function(e) {
          ...
          t && (this.clearSelections(this.collection.gbData.selectedZone.active_page, !0),
              this.resetSelections(!0, !0)),
              this.children.each(function(t) {
                    if (t.model.get("pageNum") === e)
                      return t.createPageLevelNote(),
                          !1
                  }
              )
        },
        ...
        createHighlight: function() {
          ...
          if (e) {
            var t = this.collection.gbData.finalSelections.active_page
                ;
            this.collection.gbData.whatClicked = "",
                this.children.each(function(e) {
                      if (e.model.get("pageNum") === t)
                        return e.contextHighYellow(),
                            !1
                    }
                )
          } else
        ...
        panelDeleteAnnot: function(e) {
          var t = e.annots.physicalPage
              , r = !1;
          this.children.each(function(i) {
                if (i.model.get("pageNum") === t && !n.isUndefined(i.model.get("annots")))
                  return i.panelChDeleteAnnot(e.annots),
                      r = !0,
                      !1
              }
          );
        ...
        panelShowAnnot: function(e) {
          ...
          this.closeOpenNotes(),
              ...
              this.children.each(function(i) {
                    if (i.model.get("pageNum") === t && !n.isUndefined(i.model.get("annots")))
                      return i.panelChShowAnnot(e.annots),
                          r = !0,
                          !1
                  }
              )
        ...
        tmpLogicalPage: function(e) {
          var n = this;
          t.ajax({
            url: "logPageAccess.api?rpgr=eb&docid=" + n.collection.gbData.docID + "&remote_id=" + n.collection.gbData.ssen + "&page=" + e + "&tm=1",
            success: function(e) {},
            error: function(
                e, n, r) {
              var i = t("#dialog-error-msg").show();
...
define("models/ReaderTxM", ["backbone", "jquery"], function(e, t) {
      return e.Model.extend({
        url: function() {
          var e = t("#current-page").val() || this.cpTmp.gbData.ppg
              , n = "page=(" + e + ")&zoom=" + this.cpTmp.gbData.zm + "&encID=" + this.cpTmp.gbData.encID + "&aMode=1&op=view";
...
define("views/ReaderTextItemView", ["jquery", "marionette", "templates", "i18next", "vent", "utils/ebreaderUtil", "utils/commonUtil", "models/ReaderTxM"], function(e, t, n, r, i, s, o, u) {
      return t.ItemView.extend({
        ...
        initialize: function(e) {
          ...
          this.model = new u(n),
              this.model.bind("sync", this
                  .render, this),
              this.model.fetch(),
              i.on("jtp", this.jumpToPage, this),
              i.on("pAntDel", this.pnlDeleteAnnot, this)
        },
        getTemplate: function() {
        ...
        events: {
          "click #txtGoToPrePg": "prevPage",
          "click #txtGoToNexPg": "nextPage",
          "click  [id^='mainViewerBookMark_']": "bookMarkAnnot",
          "click  [id^='mainViewerNote_']": "noteAnnot",
          "click #modalNCancel": "noteCancel",
          "click #modalNSave": "noteSaveAnnot"
        },
        onRender: function() {
        ...
        prevPage: function(t) {
          t.preventDefault();
          var n = e("#current-page").val()
              , r = parseInt(n) - 1;
          r = r >= 1 ? r : 1;
          var s = this.model.get("gbData").tmpLpg[r - 1] || r;
          typeof s != "undefined" && (e("#tool-current-page-loc").empty().html(s),
              this.jumpToPage(r)),
              i.trigger("gaTk", "pageview", "/NR_PagePrev"
        ...
        nextPage: function(t) {
          ...
          typeof s != "undefined" && (e("#tool-current-page-loc").empty().html(s),
              this.jumpToPage(r)),
              i.trigger("gaTk", "pageview", "/NR_PageNext", "Page flip to next page in NewReader Accessibility")
        },
        jumpToPage: function(t) {
          this.firstDt = !0;
          var n = t || 1;
          this.model.get("gbData").tmpFetchPageNum = n,
              e("#current-page").val(n),
              this.model.fetch()
        },
        bookMarkAnnot: function(t) {
          t.preventDefault();
          var n = e(t.currentTarget)
              , s = DanaMethodAttr("attr", n, "id").split("_")[1];
          if (s > 0) {
            this.deleteAnnot(e("#current-page").val(), s),
                n.parent().empty().html(r.t("rr_hasNoBookMarkText", {
                  ABKMNID: "mainViewerBookMark_0"
                }));
            var o = _.find(this.model.get("annots"), function(e) {
                ...
                , u = {
                  annotID: s,
                  chapterId: o.chapInfo.chapterId
                };
            this.postToPanel("del", u),
                e("#access-bookmark-message").hide()
          } else {
            var a = {
                  op: "annotate",
                  encID: this.model.get("gbData").encID,
                  zoom: this.model.get("gbData").zm,
                  type: "link",
                  ppg: e("#current-page").val(),
                  s: -1,
                  e: -1
                }
                , f = this.saveAnnotation(a, "BookMark:");
            if (f.length > 0) {
              var l = this;
              _.each(f, function(t) {
                    l.model.get("annots").push(t),
                        l.postToPanel("save", t),
                        n.parent().empty().html(r.t("rr_hasBookMarkText", {
                          ABKMID: "mainViewerBookMark_" + t.annotID
                        })),
                        e("#access-bookmark-message").show()
                  }
              )
            }
          }
          i.trigger("gaTk", "event", "Reader_Feature", "R1_BOOKMARK", "Bookmark from Reader Accessibility"),
              e.data(this, "testTimeoutFocus", DanaFuncSetTimeout(setTimeout, function() {
        ...
        noteAnnot: function(t) {
          t.preventDefault(),
              e("#notesTxtModal").modal("show"),
              i.trigger("gaTk", "event", "Reader_Feature", "R1_NOTE_PAGE", "Add Page Note from Reader Accessibility")
        },
        noteSaveAnnot: function(t) {
          var n = e("[id^='noteContent_']")
              , i = DanaMethodAttr("attr", n, "id").split("_")[1]
              , s = n.val().trim() || "";
          if (s.length > 0) {
            var o = {
              op: "annotate",
            ...
            if (!_.isUndefined(u)) {
              ...
              if ("0" === i)
                _.each(u, function(t) {
                      _.isUndefined(a.model.get("annots")) || (a.model.get("annots").push(t),
                          a.postToPanel("save", t),
                          DanaMethodAttr("attr", n, "id", "noteContent_" + t.annotID),
                          e("#access-note-status").empty().html(r.t("rr_hasNotesCreatedText", {
                            ANTID: "mainViewerNote_" + t.annotID
                          })))
                    }
                );
              else {
                ...
                ("annots");
                _.each(f, function(e) {
                      e.annotID === parseInt(u.annotID) && (e.label = s,
                          u.chapterId = e.chapInfo.chapterId)
                    }
                ),
        ...
        pnlDeleteAnnot: function(t) {
          var n = t.annots.physicalPage || 0
              , s = parseInt(e("#current-page").val());
          this.deleteAnnot(n, t.annots.annotID);
          var o = {
            annotID: t.annots.annotID,
            chapterId: t.chapterId
          };
          i.trigger("pnlAnt", o, "del");
          var u = e("[id^='noteContent_']");
          s === n && (t.annots.annotType === "sticky" && parseInt(t.annots.annotID) === parseInt(DanaMethodAttr("attr", u, "id").split("_")[1]) ? (e("#access-note-status").empty().html(r.t("rr_hasNoNotesCreatedText", {
            ANTNID: "mainViewerNote_0"
          })),
              DanaMethodAttr("attr", u.val(""), "id", "noteContent_0")) : t.annots.annotType === "link" && (e("#access-bookmark-status").empty().html(r.t("rr_hasNoBookMarkText", {
            ABKMNID: "mainViewerBookMark_0"
          })),
              e("#access-bookmark-message").hide()))
        },
        deleteAnnot: function(t, n) {
          var s = "ppg=" + t + "&encID=" + this.model.get("gbData"
                  ).encID + "&id=" + n + "&op=removeAnnot"
              , o = "remoteBookshelf.api?encrypted=" + this.pebr.enc(s) + "&remote_id=" + this.model.get("gbData").ssen + "&tm=1"
              , u = !0;
          return e.ajax({
            dataType: "json",
            url: o,
        ...
        saveAnnotation: function(t, n) {
          var s = e.param(t)
              , o = "encrypted=" + this.pebr.enc(s) + "&remote_id=" + this.model.get("gbData").ssen;
          _.isUndefined(n) || (o += "&note=" + encodeURIComponent(n)),
              o += "&tm=1";
          var u = {};
          return e.ajax({
            dataType: "json",
            ...
            var n = t.chapInfo.chapterId
                ...
                , s = {
                  nAnnot: {
                    ...
                    annotType: t.annotType,
                    annotID: t.annotID,
                    logicalPage: this.model.get("gbData").tmpLpg[r],
                    physicalPage: t.physicalPage,
                    startQuad: t.startQuad,
                    labelText: t.labelText,
                    endQuad: t.endQuad,
...
define("readerApp", ["marionette"
      ...
      function m() {
        var e = this
            ...
            , r = window[n]
            , s = n == "attachEvent" ? "onmessage" : "message";
        r(s, function(e) {
      ...
      return h.addInitializer(function(e) {
            ...
            isNaN(c) && (c = 1),
                p.ppg = c;
            var g = i.getParameterByName("docID")
                , y = i.getParameterByName("q");
            p.searchTerm = y,
                p.docID = g;
            var b = i.readCookie("ESESSIONID")
                , w = t("#mainViewer").get(0)
                , E = w.scrollWidth
                , S = t("<div><br/></div>").appendTo("body");
            p.widthTest = S.height(),
                S.remove(),
                p.showSearhHits = !0,
                p.whatClicked = "",
                p.selectedZone = {
                ...
                p.uAccsMdRR = t("#enableAccessiblity").val() === "no" ? 1 : 0,
                t.ajax({
                  url: "docAccess.api?rpgr=eb&docid=" + g + "&remote_id=" + b,
                  async: !1,
                  success: function(e) {
                    if (e.status === "SUCCESS")
                      p.hasAc = 1,
                          p.encID = e.encryptedDocID,
                          p.tmpFetchPageNum = c,
                          p.ssen = b,
                          p.tpg = e.tpg || 0,
                          p.zmMaxWidth = e.pg && e.pg.width ? e.pg.width : 0,
                          p.zmMaxHeight =
                              e.pg && e.pg.height ? e.pg.height : 0,
                          p.tmpLpg = e.lpg,
                          p.tmpzmMaxWidth = p.zmMaxWidth,
                          p.tmpzmMaxHeight = p.zmMaxHeight,
                          p.zm = e.pg && e.pg.width ? (E - p.widthTest * 2) / e.pg.width : 1,
                          p.zm = p.zm > .5 ? p.zm : .5,
                          p.zm = p.zm > 10 ? 10 : p.zm,
                          p.divzm = p.zm,
                          p.zm = p.divzm - .1,
                          p.orgWd = parseInt(p.tmpzmMaxWidth * p.divzm),
                          p.orgHgt = parseInt(p.tmpzmMaxHeight * p.divzm);
                    else {
                      p.hasAc = 0;
            ...
            p.uAccsMdRR > 0 && (t("#mainLayoutRegion").css({
              "background-color": "white"
            }),
                t("#access-containerWrapper").css({
                  width: O - _ - M,
                  height: D - 115,
                  "background-color": "white"
                })),
                t("#readerContentInner").height(D - 115),
                t("#panel").css({
                  height: D - 115
                }),
                t(window).resize(function() {
                      var e = t(window).width()
                          , n = t("#sideBar").outerWidth()
                          , r = t("#panelLayoutRegion").outerWidth();
                      r = r > 25 ? 400 : 1,
                          t("#mainViewer").width(e - r - n);
                      var i = t(window).height();
                      t("#mainViewer").height(i - 115),
                      p.uAccsMdRR > 0 && (t("#panelLayoutRegion").css({
                        width: "400px"
                      }),
                          t("#panel").css({
                            width: "400px"
                          ...
                          t("#readerContentInner").height(i - 115),
                          t("#panel").css({
                            height: i - 115
                          })
                    }
                ...
                m(),
                t("#signGlobalTool").on("click", function(e) {
                ...
                t(window).on("unload", function() {
                      var e = new Date;
                      t.ajax({
                        url: "detail.action?action=releaseDoc&docID=" + g + "&asJson=1&dt=" + e.getTime(),
                        async: !1
                      })
                    }
                )
...
(jQuery),
    +function(e) {
      function t() {
        var e = DanaMethodCreateElement("createElement", document, "bootstrap")
            , t = {
      ...
      e.fn.emulateTransitionEnd = function(t) {
        ...
        var i = function() {
            ...
            ;
        return DanaFuncSetTimeout(setTimeout, i, t),
            this
      }
          ,
          e(function() {
    ...
    +function(e) {
      ...
      n.VERSION = "3.3.1",
          ...
          n.prototype.close = function(t) {
            ...
            var r = e(this)
                , i = DanaMethodAttr("attr", r, "data-target");
            i || (i = DanaMethodAttr("attr", r, "href"),
                i = i && DanaMethodReplace("replace", i, /.*(?=#[^\s]*$)/, ""));
            var s = e(i);
            t && t.preventDefault(),
      ...
      t.VERSION = "3.3.1",
          ...
          t.prototype.setState = function(t) {
            ...
            s.resetText == null  && r.data("resetText", r[i]()),
                DanaFuncSetTimeout(setTimeout, e.proxy(function() {
                      r[i](s[t] == null  ? this.options[t] : s[t]),
                          t == "loadingText" ? (this.isLoading = !0,
                              DanaMethodAttr("attr", r.addClass(n), n, n)) : this.isLoading && (this.isLoading = !1,
    ...
    +function(e) {
      ...
      t.VERSION = "3.3.1",
          ...
          t.prototype.cycle = function(t) {
            ...
            this.options.interval && !this.paused && (this.interval = DanaFuncSetInterval(setInterval, e.proxy(this.next, this), this.options.interval)),
                this
          }
          ,
      ...
      var i = function(t) {
            ...
            var o = e.extend({}, s.data(), i.data())
                , u = DanaMethodAttr("attr", i, "data-slide-to");
            u && (o.interval = !1),
                n.call(s, o),
          ...
          ;
      e(document
      ).on("click.bs.carousel.data-api", "[data-slide]", i).on("click.bs.carousel.data-api", "[data-slide-to]", i),
    ...
    +function(e) {
      ...
      t.VERSION = "3.3.1",
          ...
          t.prototype.show = function() {
            ...
            DanaMethodAttr("attr", this.$element.removeClass("collapse").addClass("collapsing")[o](0), "aria-expanded", !0),
                DanaMethodAttr("attr", this.$trigger.removeClass("collapsed"), "aria-expanded", !0),
          ...
          t.prototype.hide = function() {
            ...
            this.$element[r](this.$element[r]())[0].offsetHeight,
                DanaMethodAttr("attr", this.$element.addClass("collapsing").removeClass("collapse in"), "aria-expanded", !1),
                DanaMethodAttr("attr", this.$trigger.addClass("collapsed"), "aria-expanded", !1),
                this.transitioning = 1;
            var i = function() {
                  this.transitioning = 0,
          ...
          t.prototype.addAriaAndCollapsedClass = function(e, t) {
            var n = e.hasClass("in");
            DanaMethodAttr("attr", e, "aria-expanded", n),
                DanaMethodAttr("attr", t.toggleClass("collapsed", !n), "aria-expanded", n)
          }
      ;
      var i = e.fn.collapse;
      e.fn.collapse = r,
    ...
    +function(e) {
        ...
        e(t).remove(),
            e(n).each(function() {
                  ...
                  if (r.isDefaultPrevented())
                    return;
                  DanaMethodAttr("attr", t, "aria-expanded", "false"),
      ...
      function s(t) {
        ...
        n || (n = DanaMethodAttr("attr", t
            , "href"),
            n = n && /#[A-Za-z]/.test(n) && DanaMethodReplace("replace", n, /.*(?=#[^\s]*$)/, ""));
        var r = n && e(n);
      ...
      r.VERSION = "3.3.1",
          r.prototype.toggle = function(t) {
            ...
            if (!o) {
              ...
              if (t.isDefaultPrevented())
                return;
              DanaMethodAttr("attr", n.trigger("focus"), "aria-expanded", "true"),
          ...
          r.prototype.keydown = function(t) {
            ...
            if (!o && t.which != 27 || o && t.which == 27)
              return t.which == 27 && i.find(n).trigger("focus"),
                  r.trigger("click");
    ...
    +function(e) {
      ...
      var t = function(t, n) {
            ...
            this.options.remote && DanaMethodLoad("load", this.$element.find(".modal-content"), this.options.remote, e.proxy(function() {
      ...
      t.VERSION = "3.3.1",
          ...
          t.prototype.show = function(n) {
            ...
            this.isShown = !0,
                ...
                this.$element.on("click.dismiss.bs.modal"
                    , '[data-dismiss="modal"]', e.proxy(this.hide, this)),
                this.backdrop(function() {
                      ...
                      i && r.$element[0].offsetWidth,
                          DanaMethodAttr("attr", r.$element.addClass("in"), "aria-hidden", !1),
                          r.enforceFocus();
          ...
          t.prototype.hide = function(n) {
            ...
            this.isShown = !1,
                ...
                DanaMethodAttr("attr", this.$element.removeClass("in"), "aria-hidden", !0).off("click.dismiss.bs.modal"),
                e.support.transition && this.$element.hasClass("fade") ? this.$element.one
      ...
      e.fn.modal = n,
          ...
          e(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
                var r = e(this)
                    , i = DanaMethodAttr("attr", r, "href")
                    , s = e(DanaMethodAttr("attr", r, "data-target") || i && DanaMethodReplace("replace", i, /.*(?=#[^\s]+$)/, ""))
    ...
    +function(e) {
      function n(n) {
        return this.each(function() {
              ...
              if (!i && n == "destroy")
                return;
              o ? (i || r.data("bs.tooltip", i = {}),
              i[o] || (i[o] = new t(this,s))) : i || r.data("bs.tooltip", i = new t(this,s)),
              typeof n == "string" && i[n]()
            }
        )
      }
      ...
      t.VERSION = "3.3.1",
          ...
          t.prototype.show = function() {
            ...
            if (this.hasContent() && this.enabled) {
              ...
              this.setContent(),
                  DanaMethodAttr("attr", s, "id", o),
                  DanaMethodAttr("attr", this.$element, "aria-describedby", o),
              ...
              var u = typeof this.options.placement == "function" ? this.options.placement.call(this, s[0], this.$element[0]) : this.options.placement
                  , a = /\s?auto?\s?/i
                  , f = a.test(u);
              f && (u = DanaMethodReplace("replace", u, a, "") || "top"),
                  s.detach().css({
                    top: 0,
                    left: 0,
                    display: "block"
          ...
          t.prototype.hide = function(n) {
            ...
            return i.removeClass("in"),
                e.support
                    .transition && this.$tip.hasClass("fade") ? i.one("bsTransitionEnd", o).emulateTransitionEnd(t.TRANSITION_DURATION) : o(),
          ...
          t.prototype.getTitle = function() {
            ...
            return e = DanaMethodAttr("attr", t, "data-original-title") || (typeof n.title == "function" ? n.title.call(t[0]) : n.title),
                e
          }
          ,
    ...
    +function(e) {
      function n(n) {
        return this.each(function() {
              ...
              if (!i && n == "destroy")
                return;
              o ? (i || r.data("bs.popover", i = {}),
              i[o] || (i[o] = new t(this,s))) : i || r.data("bs.popover", i = new t(this,s)),
              typeof n == "string" && i[n]()
            }
        )
      }
    ...
    +function(e) {
      function t(n, r) {
        ...
        this.$body = e("body"),
            ...
            DanaMethodRefresh("refresh", this),
            this.process()
      }
      function n(n) {
        return this.each(function() {
      ...
      t.VERSION = "3.3.1",
          ...
          t.prototype.refresh = function() {
            ...
            this.$body.find(this.selector).map(function() {
                  var r = e(this)
                      , i = r.data("target") || DanaMethodAttr("attr", r, "href")
                      , s = /^#./.test(i) && e(i);
      ...
      t.VERSION = "3.3.1",
          ...
          t.prototype.show = function() {
            var t = this
                ...
                , r = t.data("target");
            r || (r = DanaMethodAttr("attr", t, "href"),
                r = r && DanaMethodReplace("replace", r, /.*(?=#[^\s]*$)/, ""));
          ...
          t.prototype.activate = function(n, r, i) {
            function u() {
              DanaMethodAttr("attr", s.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]'), "aria-expanded", !1),
                  DanaMethodAttr("attr", n.addClass("active").find('[data-toggle="tab"]'), "aria-expanded", !0),
                  o ? (n[0].offsetWidth,
                      n.addClass("in")) : n.removeClass("fade"),
              n.parent(".dropdown-menu") && DanaMethodAttr("attr", n.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]'), "aria-expanded"
                  , !0),
              i && i()
            }
            var s = r.find("> .active")
          ...
          t.prototype.checkPosition = function() {
            ...
            if (this.affixed != u) {
              ...
              this.affixed = u,
                  ...
                  this.$element.removeClass(t.RESET).addClass(a).trigger(DanaMethodReplace("replace", a, "affix", "affixed") + ".bs.affix")
            }
    ...
    define("utils/gaUtil", ["jquery", "require"], function(e, t) {
          ...
          if (typeof e("#ga_key").val() != "undefined") {
            window.ga("create", e("#ga_key").val().trim(), {
              cookieExpires: 0
            });
            var i = DanaGetHostname(document.location)
                , s = DanaGetReferrer(document);
            window.ga("set", "dimension1", i),
                window.ga("set", "dimension2", s),
    ...
    require.config({
      waitSeconds: 0,
      baseUrl: "/clientresources/js/app",
      urlArgs: "bust=mayankJa",
      paths: {
      ...
      shim: {
        "../js/vendor/backbone.localStorage": ["backbone"
        ],
        jquery: {
          exports: "$"
        },
    ...
    require(["readerApp", "backbone", "routers/DesktopReaderRouter", "controllers/DesktopReaderController", "bootstrap", "i18next", "utils/gaUtil"], function(e, t, n, r, i, s, o) {
          s.init({
                ns: {
                  namespaces: ["reader"],
                  defaultNs: "reader"
                ...
                useLocalStorage: !0,
                resGetPath: "/locales/__ns_____lng__.mjson",
                lng: DanaMethodAttr("attr", $("html"), "lang"),
                detectLngFromHeaders: !1,
                fallbackLng: "en"
              }, function(t) {
                $(document).ready(function() {
                      DanaMethodStart("start", e),
                          e.desktopReaderRouter = new n({
                            controller: r
                          })
                    }
                )
